...
var jstz = function() {
  ...
  "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, b = function(a) {
    ...
    for (var f = {}, d = jstz.olson.dst_rules.zones, g = d.length, h = a[e], u = 0;u < g;u++) {
      var B = d[u], x;
      x = d[u];
      for (var A = 0, C = 0;C < b.length;C++) {
        if (x.rules[C] && b[C]) {
          if (b[C].s >= x.rules[C].s && b[C].e <= x.rules[C].e) {
            A = 0, A += Math.abs(b[C].s - x.rules[C].s), A += Math.abs(x.rules[C].e - b[C].e);
          } else {
            A = "N/A";
            break;
          }
    ...
    for (var E in f) {
      if (f.hasOwnProperty(E) && -1 != h.indexOf(E)) {
        return E;
      }
    }
    return e;
    ...
    var b = function() {
      for (var a = [], b = 0;b < jstz.olson.dst_rules.years.length;b++) {
        ...
        for (var f = (new Date(e)).getTimezoneOffset(), d = null, h = null;e < c - 864E5;) {
          var n = new Date(e), p = n.getTimezoneOffset();
          p !== f && (p < f && (d = n), p > f && (h = n), f = p);
          e += 864E5;
        }
        c = d && h ? {s:g(d).getTime(), e:g(h).getTime()} : !1;
        a.push(c);
      }
      return a;
    }();
  ...
  return {determine:function() {
    var b = f();
    b || (b = jstz.olson.timezones[d()], "undefined" !== typeof a[b] && (b = h(b)));
...
(function(a, b) {
  ...
  function d(a, b, c, e) {
    ...
    var d = m.substring(0, m.indexOf("Animation")).toLowerCase();
  ...
  function l() {
    ...
    h.prototype.lines = function(a, f) {
      function d() {
        return g(c("group", {coordsize:l + " " + l, coordorigin:-q + " " + -q}), {width:l, height:l});
      }
      function h(a, l, n) {
        b(m, b(g(d(), {rotation:360 / f.lines * a + "deg", left:~~l}), b(g(c("roundrect", {arcsize:f.corners}), {width:q, height:f.scale * f.width, left:f.scale * f.radius, top:-f.scale * f.width >> 1, filter:n}), c("fill", {color:e(f.color, a), opacity:f.opacity}), c("stroke", {opacity:0}))));
      }
      var q = f.scale * (f.length + f.width), l = 2 * f.scale * q, n = -(f.width + f.length) * f.scale * 2 + "px", m = g(d(), {position:"absolute", top:n, left:n});
      if (f.shadow) {
        for (n = 1;n <= f.lines;n++) {
  ...
  c(h.prototype, {spin:function(b) {
    ...
    c.lines(f, c.opts);
    if (!m) {
      var d = 0, h = (e.lines - 1) * (1 - e.direction) / 2, q, l = e.fps, n = l / e.speed, w = (1 - e.opacity) / (n * e.trail / 100), p = n / e.lines;
      (function z() {
        d++;
        for (var a = 0;a < e.lines;a++) {
          q = Math.max(1 - (d + (e.lines - a) * p) % n * w, e.opacity), c.opacity(f, a * e.direction + h, q, e);
        }
        c.timeout = c.el && setTimeout(z, ~~(1E3 / l));
      })();
    }
    return c;
  }, stop:function() {
    ...
    function h(b, c) {
      return g(a(), {position:"absolute", width:f.scale * (f.length + f.width) + "px", height:f.scale * f.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / f.lines * q + f.rotate) + "deg) translate(" + f.scale * f.radius + "px,0)", borderRadius:(f.corners * f.scale * f.width >> 1) + "px"});
    }
    for (var q = 0, l = (f.lines - 1) * (1 - f.direction) / 2, n;q < f.lines;q++) {
      n = g(a(), {position:"absolute", top:1 + ~(f.scale * f.width / 2) + "px", transform:f.hwaccel ? "translate3d(0,0,0)" : "", opacity:f.opacity, animation:m && d(f.opacity, f.trail, l + q * f.direction, f.lines) + " " + 1 / f.speed + "s linear infinite"}), f.shadow && b(n, g(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(n, h(e(f.color, q), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
  ...
  if ("undefined" !== typeof document) {
    ...
    var w = g(a("group"), {behavior:"url(#default#VML)"});
    !f(w, "transform") && w.adj ? l() : m = f(w, "animation");
  }
  return h;
});
...
var CTATBase = function(a, b) {
  ...
  this.ctatdebugInternal = function(a, b) {
    ...
    if (useDebuggingBasic) {
      e = d("Unknown", "undefined", e), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += e + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(e);
    } else {
...
var CTATCompBase = function(a, b, d, f, g, c) {
  ...
  var e = d || 0, h = f || 0, l = g || -2, n = c || -2, p = 50, m = 25, r = !1, q = !1, w = "", u = !1, B = !0, x = null, A = "", C = null;
  this.isTabIndexable = !0;
  var E = 0, D = null, y = this, G = null, t = "hidden", F = CTATGlobalFunctions.gensym.z_index(), H = CTATGlobalFunctions.gensym.div_id(), z = CTATGlobalFunctions.gensym.z_index(), I = CTATGlobalFunctions.gensym.div_id();
  ...
  this.makeDivWrapper = function(a) {
    ...
    x.id = this.getName();
    x.setAttribute("onkeypress", "return noenter(event)");
    x.setAttribute("data-ctat-component", this.getClassName());
    x.style.position = "absolute";
    x.style.left = e + "px";
    x.style.top = h + "px";
    x.style.zIndex = F;
    x.style.width = y.getWidth() + "px";
    x.style.height = y.getHeight() + "px";
    $(x).data("CTATComponent", this);
    a.appendChild(x);
  };
  ...
  this.setClassName = function(a) {
    L(a);
    x && x.setAttribute("data-ctat-component", this.getClassName());
  };
  ...
  this.createCanvas = function() {
    ...
    x.firstChild ? x.insertBefore(G, x.firstChild) : x.appendChild(G);
    return G;
  };
  this.redraw = function() {
    var a = x.style.display;
  ...
  this.getWidth = function() {
    if (0 >= l) {
      var a;
      D ? a = window.getComputedStyle(D) : x && (a = window.getComputedStyle(x));
      if (a) {
  ...
  this.assignEnabled = function(a) {
    B = a;
    x.setAttribute("data-ctat-enabled", B);
  };
  this.setEnabled = function(a) {
    y.ctatdebug("setEnabled (" + a + ")");
    y.assignEnabled(a);
    D ? D.disabled = !B : y.ctatdebug("Error: component pointer is null");
  };
  ...
  this.move = function(a, b) {
    e = a;
    h = b;
    x && (x.style.left = e + "px", x.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    x.style.visibility = !0 === a ? null : "hidden";
  };
  ...
  this.setWidth = function(a) {
    y.ctatdebug("setWidth (" + a + ")");
    l = a;
    x ? x.style.width = l + "px" : y.ctatdebug("Internal error: no div wrapper available to set width");
  };
  this.setHeight = function(a) {
    y.ctatdebug("setHeight (" + a + ")");
    n = a;
    x ? x.style.height = n + "px" : y.ctatdebug("Internal error: no div wrapper available to set height");
  };
  ...
  this.processTabOrder = function() {
    ...
    !0 === r ? y.ctatdebug("Component is an abstract component, bump") : D ? (y.ctatdebug("We have a component, actually assigning to html component ..."), null !== C && (D.tabIndex = C), D.onfocus = y.processOnFocus) : y.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
...
CTAT.Component.Base.Graphical = function(a, b, d, f, g, c, e) {
  ...
  var l = CTATGlobals.Visual.BackgroundColor, n = "white", p = 1, m = CTATGlobals.Visual.BorderColor, r = !1, q = "solid", w = 0, u = "1px", B = 0, x = CTATGlobals.Font.color, A = "black", C = CTATGlobals.Font.family, E = CTATGlobals.Font.size, D = !1, y = !1, G = !1;
  ...
  this.getBorderRoundness = function() {
    return this.component ? $(this.component).css("border-radius") : w;
  };
  this.setBorderRoundness = function(a) {
    a = parseInt(a);
    w = isNaN(a) ? 0 : a;
    this.component && this.getBorderRoundness() !== w && (this.component.style.borderRadius = w);
    return this;
  };
  ...
  this.getBorderWidth = function() {
    return this.component ? $(this.component).css("borderWidth") : u;
  };
  this.setBorderWidth = function(a) {
    u = parseInt(a);
    isNaN(u) && (u = 0);
    this.component && this.getBorderWidth() !== u && (this.component.style.borderWidth = u);
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== r && (r ? (this.setBorderStyle(q), this.setBorderWidth(u)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : y;
  };
  this.setItalicized = function(a) {
    y = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== y && (this.component.style.fontStyle = y ? "italic" : null);
    return this;
  };
  var t = this;
  a = function(a) {
...
var CTATSAI = function(a, b, d, f) {
  ...
  var g = new CTATStringUtil, c = "undefined", e = [], h = [], l = [], n = [], p = null, m = this, p = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
    ...
    for (var b, c = 0;c < a.length;c++) {
      ...
      if ("selection" == p.getElementName(e) || "Selection" == p.getElementName(e)) {
        for (var f = p.getElementChildren(e), d = !1, g = 0;g < f.length;g++) {
          b = f[g], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > g ? m.setSelectionArray(b) : m.appendToSelectionArray(b), d = !0, m.setSelection(b));
        }
        !1 === d && (b = p.getNodeTextValue(e), m.setSelectionArray(b), m.setSelection(b));
      }
      if ("action" == p.getElementName(e) || "Action" == p.getElementName(e)) {
        f = p.getElementChildren(e);
        d = !1;
        for (g = 0;g < f.length;g++) {
          b = f[g], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > g ? m.setActionArray(b) : m.appendToActionArray(b), d = !0, m.setAction(b));
        }
        !1 === d && (b = p.getNodeTextValue(e), m.setActionArray(b), m.setAction(b));
      }
      if ("inputArray" == p.getElementName(e) || "value" == p.getElementName(e) || "Input" == p.getElementName(e)) {
        ...
        for (var n = 0;n < b.length;n++) {
          var r = b[n];
          "value" == p.getElementName(r) && (h = p.getElementChildren(r), null !== h ? (m.ctatdebug("Parsing SAI input ..."), m.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = f.htmlDecode(p.getNodeTextValue(r)), m.ctatdebug("Setting new value to: " + h), d.setValue(h)) : (h = f.htmlDecode(p.getNodeTextValue(r)), m.ctatdebug("Setting new value to: " + h), d.setValue(h), d.setName(r.attributes.getNamedItem("name").value), d.setType(r.attributes.getNamedItem("type").value), d.setFormat(r.attributes.getNamedItem("format").value), 
          g++), 1 > n ? m.setInputArray(h) : m.appendToInputArray(h)) : (r = f.htmlDecode(p.getNodeTextValue(r)), m.ctatdebug("Setting new value to: " + r), d.setValue(r), 1 > n ? m.setInputArray(r) : m.appendToInputArray(r)));
        }
      }
  ...
  this.appendFromElement = function w(a, b, c, e, f) {
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b, c = 0;c < a.length;c++) {
      ...
      if ("inputArray" == p.getElementName(e) || "Input" == p.getElementName(e)) {
        b = e.childNodes;
        l = [];
        var f = new CTATHTMLManager, d = new CTATArgument, g = 0, h;
        l.push(d);
        for (var n = 0;n < b.length;n++) {
          if (h = b[n], "value" == p.getElementName(h)) {
            var r = p.getElementChildren(h);
            null !== r ? (m.ctatdebug("Parsing SAI input ..."), m.ctatdebug("Childnodes: " + r.length), 1 === r.length ? (h = f.htmlDecode(p.getNodeTextValue(h)), m.ctatdebug("Setting new value to: " + h), d.setValue(h)) : (h = f.htmlDecode(p.getNodeTextValue(h)), m.ctatdebug("Setting new value to: " + h), d.setValue(h), d.setName(p.getElementAttr("name")), d.setType(p.getElementAttr("type")), d.setFormat(p.getElementAttr("format")), g++)) : (h = f.htmlDecode(p.getNodeTextValue(h)), m.ctatdebug("Setting new value to: " + 
            h), d.setValue(h));
            1 > n ? m.setInputArray(h) : m.appendToInputArray(h);
          }
        }
      }
      if ("prompt" == p.getElementName(e) || "Prompt" == p.getElementName(e)) {
  ...
  var r = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(d) || null == d) && (m.setSelectionArray(a), m.setActionArray(b), m.setInputArray(d), r = !0, 0 < a.length && 0 < b.length)) {
    m.setSAI(a[0], b[0], null == d ? null : d[0], "String", f);
    return;
  }
  null !== a && "" !== a && m.setSelection(a);
  null !== a && (m.setSAI(a, b, d, "String", f), r || (m.setSelectionArray(Array.isArray(a) ? a : [a]), m.setActionArray(Array.isArray(b) ? b : [b]), m.setInputArray(Array.isArray(d) ? d : [d]), r = !0));
};
...
var CTATSkill = function() {
  ...
  var a = "", b = "", d = "", f = "", g = 0, c = "", e = !1, h = "", l = "", n = "", p = "", m = "";
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    return e += '" pKnown="' + n + '" category="' + d + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" history="' + m + '" />';
  };
...
var CTATSkillSet = function() {
        ...
        for (var d = 0;d < b.length;d++) {
          ...
          if ("Skill" == f.nodeName || "skill" == f.nodeName) {
            ...
            if (g = g ? g.value : "") {
              ...
              f.value : "";
              this.addSkill(g, c, .95, e, h, l, n, p, m, f);
            }
          }
        }
      } else {
  ...
  this.addSkill = function(a, d, f, g, c, e, h, l, n, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + d + " mastery = " + f + " aDescription = " + g + " adisplayName = " + c + " aCategory = " + e + " pguess= " + h + " plearn = " + l + " pslip = " + n + " history = " + p);
...
var transformArray = [], CTATJSON = function() {
  ...
  this.getElementChildren = function(a) {
    ...
    for (c in b) {
      var e = b[c];
      if ("string" == typeof e) {
        a = new CTATJSONObject, a.name = c, a.value = e, g.push(a);
      } else {
        if (null == e[0] || void 0 == e[0]) {
          a = new CTATJSONObject, a.name = c, a.value = e, g.push(a);
        } else {
          for (var h in e) {
            a = new CTATJSONObject, a.name = c, a.value = e[h], g.push(a);
          }
        }
      }
    }
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", c = !1, e = !1, h = new CTATSkillSet, l = "", n = "", p = "", m = "", r = "", q, w = null, u = !1;
      ...
      for (d = 0;d < a.length;d++) {
        if (g = a[d], "tool_message" == f.getElementName(g)) {
          for (g = f.getElementChildren(g), n = 0;n < g.length;n++) {
            u = g[n], "event_descriptor" == f.getElementName(u) && (w = new CTATSAI, w.fromXMLInternal(u));
          }
        }
      }
      e = !0;
        ...
        for (var G = f.getElementChildren(b), t = 0;t < G.length;t++) {
          ...
          if ("event_descriptor" == f.getElementName(F)) {
            for (var F = f.getElementChildren(F), H = 0;H < F.length;H++) {
              var z = F[H];
              "selection" == f.getElementName(z) && (a = f.getNodeTextValue(z), u.push(z));
              "action" == f.getElementName(z) && (d = f.getNodeTextValue(z), D.push(z));
              "input" == f.getElementName(z) && (g = f.getNodeTextValue(z), y.push(z));
        ...
        for (this.ctatdebug("!isLogMessage ..."), G = f.getElementChildren(b), t = 0;t < G.length;t++) {
          if (F = G[t], "properties" == f.getElementName(F)) {
            for (F = f.getElementChildren(F), H = 0;H < F.length;H++) {
              z = F[H], this.ctatdebug("Nodename: " + f.getElementName(z)), "URL" == f.getElementName(z) && (q = f.getNodeTextValue(z)), "Skills" == f.getElementName(z) && h.parseByValue(z), "SuccessMsg" == f.getElementName(z) && (p = a = f.getNodeTextValue(z)), "BuggyMsg" == f.getElementName(z) && (m = f.getNodeTextValue(z)), "Selection" == f.getElementName(z) && (a = f.getNodeTextValue(z), u.push(z)), "Action" == f.getElementName(z) && (d = f.getNodeTextValue(z), D.push(z)), "Input" == f.getElementName(z) && 
              (g = f.getNodeTextValue(z), y.push(z)), "prompt" == f.getElementName(z) && (n = f.getNodeTextValue(z)), "HighlightMsgText" == f.getElementName(z) && (r = f.getNodeTextValue(z));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + d + "," + g);
      "" !== a && null !== a ? (w = new CTATSAI(a, d, g, n), w.setArrayFromElements(u), w.setArrayFromElements(D), w.setArrayFromElements(y), e = !0) : (this.ctatdebug("No SAI found"), e = !1);
        ...
        for (var a = f.getElementChildren(b), e = 0;e < a.length;e++) {
          ...
          if ("properties" == f.getElementName(d)) {
            for (var d = f.getElementChildren(d), g = 0;g < d.length;g++) {
              var h = d[g];
              "transaction_id" == f.getElementName(h) && (n = f.getNodeTextValue(h));
            }
          }
        }
      }
...
CTAT.Component.Base.Tutorable = function(a, b, d, f, g, c, e) {
  ...
  var h = !0, l = !0, n = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, m = !0, r = this, q = !1;
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (w) {
      ...
      c !== q && (q = c, this.showHintHighlight(c, b));
    }
  };
  this.moveHintHighlight = function(a, b) {
    this.ctatdebug("moveHintHighlight (" + a + ")");
    CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus;
    CTATGlobals.Tab.Focus = r;
    r.component.focus ? CTATGlobals.Tab.Focus.getComponent().focus() : CTATGlobals.Tab.Focus.getDivWrap().focus();
    if (w) {
      var c = CTATGlobalFunctions.toBoolean(a);
      if (this.component) {
        var e = new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight, {detail:{isHighlighted:c, component:this}, bubbles:!0, cancelable:!0});
...
var CTATWSConnection = function(a) {
  ...
  var b = "", d = !1, f = this, g = null, c = [], e = !1, h = 0, l = 0, n = null, p = null;
  f.setSocketType("ws");
  this.setConsumed = function(a) {
    d = a;
...
var CTATGraphicsTools = function(a, b, d, f, g, c) {
  ...
  var e = b || 1, h = d || "#000000", l = f || "#EEEEEE", n = g || !1, p = "Arial", m = a || null;
  a = c || !1;
  var r = 0, q = this;
  if (null == m) {
  ...
  this.drawTextFormatted = function(a, b, c, e, f, d, g, h, l, q) {
    if (null != m) {
      a += r;
      b += r;
      e = "";
      ...
      e += "12pt " + p;
      try {
        m.fillStyle = d, m.font = e, m.fillText(c, a, b);
      } catch (n) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
...
var CTATShape = function(a, b, d, f, g, c) {
  ...
  var h = [], l = [], n = g, p = c, m = b, r = void 0, q = "black", w = "black", u = "Arial", B = 12, x = [], A = 1, C = 5, E = document.createElement("canvas");
  E.id = m;
  E.width = n;
  E.height = p;
  var D = new CTATCSS;
  ...
  var y = new CTATGraphicsTools(E.getContext("2d"));
  y.setGraphicBorderWidth(A);
  y.setLineColor(q);
  y.setFillColor(w);
  ...
  this.shapeMagicTrigFunctionX = function(a) {
    y.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    y.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    y.drawLine(h[0] + A, l[0] + A, h[1], l[1], q, A);
  };
  this.drawCircle = function() {
    y.drawCircle(h[0] + C, l[0] + C, C);
  };
  this.drawCircleFilled = function() {
    y.drawCircleFilled(h[0] + C, l[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, c, e) {
    y.drawRectangle(a[0] + A, b[0] + A, n - A, p - A);
  };
  this.drawRectangleFilled = function() {
    y.drawRectangleFilled(h[0], l[0], n, p);
  };
  this.drawRoundedRect = function() {
    y.drawRoundedRect(h[0] + A, l[0] + A, n - C - A, p - C - A, C);
  };
  this.drawRoundedRectFilled = function() {
    y.drawRoundedRectFilled(h[0] + A, l[0] + A, n - C - A, p - C - A, C);
  };
  this.drawText = function() {
    y.drawText(B / 2, B / 2, r);
  };
  this.drawTriangle = function() {
    y.drawTriangle(h[0] + A, l[0] + A, h[1], l[1], h[2], l[2]);
  };
  this.drawTriangleFilled = function() {
    y.drawTriangleFilled(h[0], l[0], h[1], l[1], h[2], l[2]);
  };
  this.save = function() {
    y.save();
  };
  ...
  this.erase = function() {
    ...
    for (var b = 0;b < x.length;b++) {
      E.addEventListener(x[b][0], x[b][1]);
    }
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), u.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == e && (e = !1, getSafeElementById(ctatcontainer).removeChild(q)) : 1 == warnScrim && (e = !0), u.scrimUp(a));
  }
  function d(a, b) {
    ...
    c.type = "button";
    c.value = b;
    null != a ? (u.ctatdebug("clickHandle!=null"), c.onclick = a) : (u.ctatdebug("clickHandle==null"), c.onclick = u.defaultClickHandler);
    c.id = b;
    c.setAttribute("class", "scrimButton");
    return c;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var f = "", g = !1, c = !1, e = !1, h = null, l = null, n = new CTATCanvasComponent("CTAT Scrim"), p = [], m = null, r = null, q = null, w = null, u = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (u.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), u.ctatdebug("Message: " + b), 1 == scrimIsUp ? (f = 1 == waitScrim ? b : f + (" \n " + b), n.removeComponent()) : (f = b, scrimIsUp = !0), u.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        u.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + f + "<br><br></div></div></div>"), !0 === e && (q = d(a, "close"), $(q).appendTo("#scrimpanel")), !0 === g && (m = d(h, "yes"), $(m).appendTo("#scrimpanel")), !0 === c && (r = d(l, "no"), $(r).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
          u.ctatdebug("Adding spinner ...");
          ...
          try {
            ...
            (w instanceof ReferenceError || w instanceof TypeError) && u.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', w, typeof w);
          }
        }
      }
    }
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), u.ctatdebug("waitScrimUp ()"), waitScrim = !0, u.scrimUp(CTATGlobals.languageManager.getString("LOADING")));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), u.ctatdebug("nextProblemScrimUp ()"), u.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), u.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = g = e = warnScrim = errorScrim = !1, u.scrimUp(a), w = d(b, "OK"), $(w).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, e) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), u.ctatdebug("confirmScrimUp (" + a + "," + b + "," + e + ")"), c = g = !0, l = e, h = b, u.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), 0 == authorTimeSet ? (u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), p.push("ERROR: " + a), errorScrim = !0) : 0 == inAuthorTime ? u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (errorScrim = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && u.scrimDownForced(), 0 == authorTimeSet ? (u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), p.push("WARNING: " + a), warnScrim = !0) : 0 == inAuthorTime ? u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (warnScrim = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    connectionScrim = !0;
    u.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"));
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == scrimIsUp ? u.ctatdebug("The scrim isn't up, returning") : 1 == errorScrim ? u.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == warnScrim ? u.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == connectionScrim ? u.ctatdebug("The scrim is up for a connection issue leave it up!") : u.scrimDownForced());
  };
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var d = authenticityToken = "", f = 0, g = [], c = a ? a : null, e = null == b ? !0 : b, h = !0, l = null, n = this, p = "http", m = "ERROR_CONN_TS", r = "";
  ...
  this.processReply = function(a) {
    n.ctatdebug("processReply (" + g.length + "," + a + ")");
    var b = 0, f;
    a = [];
    var d;
    for (d = 0;d < g.length;d++) {
      var h = g[d], p = h.getHTTPObject();
      n.ctatdebug("Testing connection entry " + d + ", readyState: " + p.readyState + ", consumed: " + h.getConsumed() + ", status: " + p.status);
      4 == p.readyState && 0 == h.getConsumed() ? (n.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), f = !1, 0 === p.status && (f = !0, n.ctatdebug("Received message (status 0): (" + p.responseText + "), status: " + p.status), e && CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(m))), 408 == p.status && (f = !0, n.ctatdebug("Received message (status 408): " + p.responseText), e && CTATScrim.scrim.scrimDown()), 502 == p.status && 
      (f = !0, n.ctatdebug("Received message (status 502): " + p.responseText), e && CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))), 200 == p.status ? (f = !0, n.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != l && l.processIncoming(p.responseText)) : n.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (f = !0, n.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, 
      p.responseText)), !1 === f && n.ctatdebug("Error: status not handled for: " + p.status), n.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : (0 === p.readyState && n.ctatdebug("Received message (status 0, request not initialized)"), 1 === p.readyState && n.ctatdebug("Received message (status 1, server connection established)"), 2 === p.readyState && n.ctatdebug("Received message (status 2, request received)"), 3 === p.readyState && n.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    n.cleanup();
    for (b = 0;b < a.length;b++) {
      n.ctatdebug("Processing incoming message: " + b), f = a[b], -1 != f.indexOf("status=success") ? n.ctatdebug("Info: logging success message received, not propagating to message handler") : (n.ctatdebug("Processing incoming message: " + f), c.processMessage(f));
    }
  };
  ...
  this.checkEntries = function() {
    n.ctatdebug("checkEntries (" + g.length + ")");
    var a = 0, b;
    for (b = 0;b < g.length;b++) {
      var c = g[b];
      if (!0 === c.getConsumed()) {
        return n.ctatdebug("Removing : " + c.getID()), g.splice(a, 1), !0;
      }
    ...
    if (null == c) {
      ...
      for (var w in d) {
        if (d.hasOwnProperty(w)) {
          switch(ctatdebug("Processing external FlashVar " + w + "(" + d[w] + ")"), w) {
            case "GENERATED":
              "on" == d[w] && (c.session_id = e.guid(), b = !0);
              break;
            case "BRD":
              c.question_file = d[w];
              break;
            case "BRMODE":
              c.BehaviorRecorderMode = d[w];
              break;
            case "PROBLEM":
              c.problem_name = d[w];
              break;
            case "DATASET":
              ...
              break;
            case "LEVEL1":
              c.dataset_level_name1 = d[w];
              break;
            case "TYPE1":
              c.dataset_level_type1 = d[w];
              break;
            case "LEVEL2":
              c.dataset_level_name2 = d[w];
              break;
            case "TYPE2":
              c.dataset_level_type2 = d[w];
              break;
            case "LEVEL3":
              c.dataset_level_name3 = d[w];
              break;
            case "TYPE3":
              c.dataset_level_type3 = d[w];
              break;
            case "LEVEL4":
              c.dataset_level_name4 = d[w];
              break;
            case "TYPE4":
              c.dataset_level_type4 = d[w];
              break;
            case "USER":
              c.user_guid = d[w];
              break;
            case "SESSION":
              !1 === b && (c.session_id = d[w]);
              break;
            case "SOURCE":
              c.source_id = d[w];
              break;
            case "LOGTYPE":
              ...
              break;
            case "PORT":
              c.remoteSocketPort = d[w];
              break;
            case "REMOTEURL":
              c.remoteSocketURL = d[w];
              break;
            case "DISKDIR":
              c.log_to_disk_directory = d[w];
              break;
            case "log_service_url":
              c.log_service_url = d[w];
              break;
            case "URL":
              c.log_service_url = d[w];
              break;
            case "LOGURL":
              ...
              break;
            case "CONNECTION":
              c.tutoring_service_communication = d[w];
              break;
            case "SUI":
              c.sui = d[w];
              break;
            ...
            case "SessionLog":
              ...
              break;
            case "KEYBOARDGROUP":
              "Disabled" == d[w] && (c.keyboard = "disabled");
              "Auto" == d[w] && (c.keyboard = "auto");
              "On" == d[w] && (c.keyboard = "on");
              break;
            default:
              c[w] = d[w];
          }
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, d, f, g, c) {
  ...
  b = b + ("<Actor>" + d + "</Actor>") + this.fmtSkillBarVector(f);
  b = b + "<skillBarDelimiter><![CDATA[`]]\x3e</skillBarDelimiter>" + ("<StepID>" + g + "</StepID>") + ("<transaction_id>" + c + "</transaction_id>");
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, d, f, g, c, e, h) {
  ...
  a = a + b + ("<Actor>" + d + "</Actor>") + this.fmtSkillBarVector(g);
...
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, d, f) {
  ...
  return d + ("<transaction_id>" + f + "</transaction_id>") + "</properties></message>";
};
CTATTutorMessageBuilder.prototype.createErrorMessage = function(a, b) {
  var d;
  d = "<message><verb>SendNoteProperty</verb><properties><MessageType>TutoringServiceError</MessageType><ErrorType>" + a + "</ErrorType><Details>" + (b ? b : "");
  return d += "</Details></properties></message>";
};
CTATTutorMessageBuilder.prototype.createSuccessMessage = function(a, b) {
  var d;
  d = "<message><verb>SendNoteProperty</verb><properties><MessageType>SuccessMessage</MessageType>" + ("<SuccessMsg><![CDATA[" + b + "]]\x3e</SuccessMsg>") + ("<transaction_id>" + a + "</transaction_id>") + "<end_of_transaction>true</end_of_transaction>";
  return d += "</properties></message>";
};
CTATTutorMessageBuilder.prototype.createBuggyMessage = function(a, b) {
  var d;
  d = "<message><verb>SendNoteProperty</verb><properties><MessageType>BuggyMessage</MessageType>" + ("<BuggyMsg><![CDATA[" + b + "]]\x3e</BuggyMsg>") + ("<transaction_id>" + a + "</transaction_id>") + "<end_of_transaction>true</end_of_transaction>";
  return d += "</properties></message>";
};
...
CTATTutorMessageBuilder.prototype.createStateGraphMessage = function(a, b, d, f, g, c, e) {
  a = "<message><verb>SendNoteProperty</verb><properties><MessageType>StateGraph</MessageType>" + ("<caseInsensitive>" + a + "</caseInsensitive>") + ("<unordered>" + b + "</unordered>") + ("<lockWidget>" + d + "</lockWidget>");
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, d, f) {
  a = "<message><verb>SendNoteProperty</verb><properties><MessageType>HighlightMsg</MessageType>" + ("<HighlightMsgText>" + d + "</HighlightMsgText>") + ("<Selection><value>" + a + "</value></Selection>") + ("<Action><value>" + b + "</value></Action>");
...
CTATLMS.init.SCORM = function() {
  ...
  CTATLMS.initLMSConnection = function() {
    if (1 == a) {
      ...
      console.log("Found a problem status of: " + b);
  ...
  CTATLMS.saveProblemState = function(a) {
    console.log("Saving problem state: " + a.problem_state);
    a = CTATLMS.setValue("cmi.suspend_data", a.problem_state);
    console.log("Set value result: " + a);
    return a;
  };
  CTATLMS.getProblemState = function(a) {
    var d = CTATLMS.getValue("cmi.suspend_data");
    console.log("Problem restore value: " + d);
    return a(d);
  };
...
var CTATLogMessageBuilder = function() {
  ...
  this.createUIEventToolMessage = function(f, g, c, e) {
    ...
    l = l + (f + "</event_descriptor>") + this.createCustomFields(b, d);
    l += "</tool_message>";
    a.ctatdebug("messageString = " + l);
    return l;
  };
  this.createTutorMessage = function(f, g, c, e, h, l, n, p) {
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, d = !0, f = !1, g = !1, c = [], e = "undefined", h = "undefined", l = "undefined", n = "undefined", p = "undefined", m = "undefined", r = "undefined", q = "undefined", w = "UnassignedDataset", u = "UnassignedLevelName", B = "UnassignedLevelType", q = (new CTATGuid).guid();
  ...
  x.setConnectionRefusedMessage("ERROR_CONN_LS");
  ...
  this.logTutorResponse = function(a, c, e, d, f, g, h, m, n) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var l = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(m, n);
    ...
    void 0 != g && null != g ? g = "<![CDATA[" + CTATGlobals.languageManager.filterString(g) + "]]\x3e" : (b.ctatdebug("No feedback provided, using empty string"), g = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(c, a, e, f, g, d, h, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    d = d + ("<CommShellVersion>" + a + "</CommShellVersion>") + "</properties></message>";
    return "" + d;
  };
        ...
        for (var p = f.getElementChildren(n), m = 0;m < p.length;m++) {
          ...
          if ("MessageType" == f.getElementName(r)) {
            ...
            if ("AssociatedRules" == r) {
              ...
              a.processAssociatedRules(h, w, q);
            ...
            if ("ShowHintsMessage" == r) {
              ...
              for (u = 0;u < p.length;u++) {
                if (B = p[u], "HintsMessage" == f.getElementName(B)) {
                  for (var B = f.getElementChildren(B), x = 0;x < B.length;x++) {
                    var A = B[x];
                    "value" == f.getElementName(A) && (w.push(f.getNodeTextValue(A)), q = !0);
                  }
                }
              }
              !0 === q ? a.processHintResponse(h, w) : b.ctatdebug("Error: incomplete hint message received");
    ...
    for (var c = "Unknown", d = "Unknown", g = null, p = 0;p < a.length;p++) {
      ...
      if ("serialized" == f.getElementName(m)) {
        ...
        for (var r = f.getElementChildren(m), q = 0;q < r.length;q++) {
          var w = r[q];
          -1 != f.getElementName(w).indexOf("CTAT") && (g = w);
        }
      }
  ...
  this.deserializeComponent = function(a, c, d) {
    ...
    if (1 == ignoreInterfaceDescriptions) {
      ...
      if (null === f.getElementAttr(d, "x")) {
        ...
        var g = f.getElementAttr(d, "x"), p = f.getElementAttr(d, "y"), m = f.getElementAttr(d, "width"), r = f.getElementAttr(d, "height"), q = f.getElementAttr(d, "tabIndex"), w = f.getElementAttr(d, "zIndex");
        null === q && (q = -1);
        null === w && (w = 0);
        ...
        for (g = 0;g < d.length;g++) {
          ...
          if ("Parameters" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component parameters ..."), m = f.getElementChildren(p)[0], m = f.getElementChildren(m), r = 0;r < m.length;r++) {
              ...
              if ("CTATComponentParameter" == f.getElementName(B)) {
                ...
                for (var w = q = void 0, B = f.getElementChildren(B), x = 0;x < B.length;x++) {
                  var A = B[x];
                  "name" == f.getElementName(A) && (this.ctatdebug("Found parameter name: " + f.getNodeTextValue(A)), q = f.getNodeTextValue(A));
                  "value" == f.getElementName(A) && (this.ctatdebug("Found parameter value: " + f.getNodeTextValue(A)), w = f.getNodeTextValue(A).trim());
                }
                this.ctatdebug("Parameter name: " + q + ", value: " + w);
                void 0 !== q && (u.params[q] = w, "group" == q && (u.groupName = w));
              }
            }
          }
          if ("Styles" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component styles ..."), p = f.getElementChildren(p)[0], p = f.getElementChildren(p), m = 0;m < p.length;m++) {
              if (w = p[m], "CTATStyleProperty" == f.getElementName(w)) {
                this.ctatdebug("Processing style property (CTATStyleProperty) ...");
                q = r = "";
                w = f.getElementChildren(w);
                for (B = 0;B < w.length;B++) {
                  x = w[B], "name" == f.getElementName(x) && (r = f.getNodeTextValue(x)), "value" == f.getElementName(x) && (q = f.getNodeTextValue(x).trim());
                }
...
var CTATNameTranslator = function() {
  ...
  this.translateFromCTAT = function(d, f) {
    ...
    if (-1 != g.indexOf(".r")) {
      ...
      0 >= c.length ? b.ctatdebug("Info: incoming name does not need translation") : (g = c[1], c = c[0].substr(1), b.ctatdebug("Original row (1st format): " + c + " original col: " + g), g = !0 === f ? colName(g, !1) + c : e[0] + "." + colName(g, !1) + c, b.ctatdebug("Translated: " + g));
    } else {
      if (0 === g.indexOf("r")) {
        var e = g.indexOf("c"), h = parseInt(g.substr(1, e - 1)), l = parseInt(g.substr(e + 1));
        c = h + 1;
        g = l;
        b.ctatdebug("Original row (2nd format) (columnindex: " + e + "): " + h + " -> " + c + ", original col: " + l + " -> " + g);
        g = colName(g, !1) + c;
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, d = null, f = null, g = {}, c = null, e = null, h = null, l = null, n = [], p = !1, f = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.processInterfaceAction = function(a) {
    ...
    null != commLoggingLibrary ? p ? (console.log("Logging ..."), commLoggingLibrary.logSemanticEvent(a.getTransactionID(), a.getSAI(), "ATTEMPT", "tutor-performed")) : console.log("Logging prohibited in current tutor state") : this.ctatdebug("Info: no logging library available!");
...
var CTATDragNDrop = function() {
  ...
  var a = function(a) {
    ...
    var e = $(this).parent().attr("name"), d = $(this).parent().attr("id");
    b.dataTransfer.setData("ctat/group", e);
    b.dataTransfer.setData("ctat/source", d);
    b.dataTransfer.setData("text", this.id);
    var f = a(this.id);
    CTATDragNDrop.dragging[f] = {id:this.id, group:e, source:d};
    b.dataTransfer.setData("ctat/id/" + f, f);
  }, d = function(a) {
    for (var b, d = 0;d < a.dataTransfer.types.length;d++) {
      if (b = /^ctat\/id\/(.+)$/.exec(a.dataTransfer.types[d])) {
...
CTAT.Component.Base.UnitDisplay = function(a, b, d, f, g, c, e) {
  ...
  this.clickHandler = function(a) {
    !0 === u.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), x(this, !a), u.setActionInput("SetPieces", u.updateValue()), u.processAction());
  };
  this.updateSAI = function() {
    u.setActionInput("SetPieces", u.updateValue());
  };
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = D(b), this.get_denominator() != a)) {
      ...
      u.setActionInput("SetPieces", h);
      u.processAction();
      return h;
    }
  };
  this.get_denominator = function() {
    return w.reduce(function(a, b, c, e) {
  ...
  this.change_number_pieces = function(a) {
    this.set_number_pieces(w.length + a);
  };
  ...
  this.change_numerator = function(a) {
    0 !== a && (0 < a ? w.every(function(b) {
      !1 === B(b) && (x(b, !0), a--);
      return 0 < a;
    }) : (w.reverse(), w.every(function(b) {
      !0 === B(b) && (x(b, !1), a++);
      return 0 > a;
    }), w.reverse()));
  };
  ...
  var y = f.bind(null, a), G = f.bind(null, b), t = f.bind(null, d), F = function(a) {
    var b = null;
    if (a instanceof CTAT.Component.Base.Tutorable) {
      a != this && (b = a.getName());
    } else {
      if (a instanceof CTATSAI) {
        a.getSelection() != u.getName() && (b = a.getSelection());
      } else {
        if (a instanceof String) {
          a != u.getName() && (b = a);
        } else {
          if (a instanceof Element) {
            a != u.getComponent() && (b = a.id);
          } else {
            return null;
          }
        }
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, d = document.createDocumentFragment(), f = 0;f < a.length;f++) {
        ...
        d.appendChild(q);
        var r = "" + String(g.numerator), g = "" + String(g.denominator), w = document.createElementNS(c, "tspan"), u = document.createElementNS(c, "tspan");
        ...
        w.setAttributeNS(null, "dy", "-1em");
        u.setAttributeNS(null, "x", q + "%");
        u.setAttributeNS(null, "y", "60%");
        r.length > g.length ? w.style.textDecoration = "underline" : u.style.textDecoration = "overline";
        b += m;
      }
...
var CTATGroupingComponent = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    if (1 == e) {
      ...
      a = c.getDivWrap().getAttribute("data-ctat-target-div"), null != a ? (l = a.trim(), c.ctatdebug("Controlling " + l + " target div")) : c.ctatdebug("Internal error: unable to obtain target div from component arguments");
    }
...
var CTATNumberLine = function(a, b, d, f, g) {
  ...
  this.setPointSize = function(a) {
    m = Number(a);
    u && (u.setAttributeNS(null, "r", m), $(this._point_group).find("circle").each(function() {
      $(this).attr("r", m);
    }));
  };
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            var n = document.createElementNS(e, "tspan"), l = document.createElementNS(e, "tspan");
            n.appendChild(document.createTextNode(b));
            ...
            n.setAttributeNS(null, "dy", "-1em");
            l.setAttributeNS(null, "text-anchor", "middle");
            l.setAttributeNS(null, "x", c.x);
            l.setAttributeNS(null, "y", c.y);
            b.length > h.length ? n.style.textDecoration = "underline" : l.style.textDecoration = "overline";
          }
        } else {
  ...
  var q = function() {
    if (null !== this.X_Axis && null !== this.X_Axis.svg_group) {
      ...
      0 < Math.abs(CTAT.Math.round(m)) && (m = new DOMPoint((q - g * a.top) / f, a.top), f = new DOMPoint((q - g * a.bottom) / f, a.bottom), a.contains(m) || a.contains(f)) && (d.distance(m) < d.distance(f) ? (b = f, c = m) : (b = m, c = f));
  ...
  }.bind(this), w = 0, u = null, B = new DOMPoint(-30, -30), x = !1, A = function(a) {
    B.x = a.clientX;
    B.y = a.clientY;
  }, C = function(a) {
    ...
    if (!0 === this.getEnabled() && 0 < p) {
      this.setHintHighlight(!1);
      var b;
      r ? (a = t(a.clientX, a.clientY), b = a.location, a = a.data) : (a = y(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    u = document.createElementNS(e, "circle");
    u.setAttributeNS(null, "r", m);
    u.classList.add("CTATNumberLine--cursor");
    u.setAttributeNS(null, "transform", "translate(-30,-30)");
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && 0 < p && (x = !0, u.style.visibility = null, w = requestAnimationFrame(F));
    });
    this.component.addEventListener("click", E);
    this.component.addEventListener("focus", this.processFocus);
  };
  var D = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"), y = function(a, b) {
    ...
    return this.getProjectedPoint(y(a, b));
    ...
    if (x && !0 === this.getEnabled()) {
      if (r) {
        var a = t(B.x, B.y);
        u.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        u.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(G(B.x, B.y), !0));
      }
    ...
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, e, n) {
        if (1 <= b.valueOf()) {
          ...
          n = f.add(CTAT.Geom.Point.polar(d, l));
          b.reduce();
          var q = f.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + l)), p = f.clone();
          if (0 < c && c < d) {
            ...
            n = CTAT.Geom.Point.circle_intersection(p, n, f, d).reduce(m.bind(this, n));
            q = q.add(l);
            q = CTAT.Geom.Point.circle_intersection(p, q, f, d).reduce(m.bind(this, q));
          }
          l = CTAT.Geom.Point.to2DString;
          p = "M " + l(p);
          m = new DOMPoint(d, d);
          p += " L " + l(n);
          p += " A " + l(m) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(q);
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), d = this.getThreshold(), f = 0;f < a.length;f++) {
            ...
            var w = document.createElement("div"), u = g.getLevel();
            u < d ? w.classList.add("CTATSkillWindow--bar--nonmastered") : w.classList.add("CTATSkillWindow--bar--mastery");
            w.style.width = u > d ? "100%" : 100 * u + "%";
            q.appendChild(w);
            r.appendChild(q);
            b.appendChild(r);
...
var CTATTable = function(a, b, d, f, g) {
  ...
  var n = function() {
    ...
    var c = document.createElement("div"), d = this.getName() + ".R" + a + "C" + b;
    c.id = d;
    c.classList.add("CTATTable--cell");
    c.classList.add("CTATTextArea");
    var e = new CTATTextArea;
    e.setName(d);
    e.setDivWrapper(c);
    e.processAttributes();
    e.init();
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = 0;a < h();a++) {
      ...
      for (var d = 0;d < l();d++) {
        var e = c.getName() + ".R" + a + "C" + d, f = CTATShellTools.findComponent(e);
        null === f || 0 === f.length || f[0].getName() !== e ? (e = p(a, d), b.appendChild(e)) : (f[0].getDivWrap().classList.add("CTATTable--cell"), b.appendChild(f[0].getDivWrap()));
      }
    }
  };
};
...
var CTATTextInput = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    var d = $(e);
    "autofocus defaultValue maxLength pattern placeholder readOnly size".split(" ").forEach(function(a) {
      var c = b.attr(a);
      c && d.attr(a, c);
    });
    c.setInitialized(!0);
...
CTATTutor.createStaticInterface = function(a, b, d) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var e, h, l, n;
    "shape" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), n = this.parser.getElementAttr(g, "height"), c = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating shape: " + c + " at: " + e + "," + h + "," + l + "," + n), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), n = new Image, n.setAttribute("style", "position: absolute; top: " + h + "px; left:" + e + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), n.setAttribute("id", c), n.setAttribute("src", l), f.appendChild(n));
    "statictext" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), n = this.parser.getElementAttr(g, "height"), c = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating static text: " + c + " at: " + e + "," + h + "," + l + "," + n), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), n = new Image, n.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    e + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), n.setAttribute("id", c), n.setAttribute("src", l), f.appendChild(n));
    "statictext" == this.parser.getElementName(g) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), n = this.parser.getElementAttr(g, "height"), e = new CTATMovieClip(c, e, h, l, n), h = e.wrapComponent(f), ctatdebug("Created movieclip: " + c + " at: " + e.x + "," + e.y + "," + e.width + "," + e.height), movieclips.push(e), g = this.parser.getElementChildren(g), 
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var l = b(this) ? Object(new this(h)) : Array(h), n = 0, p;n < h;) {
      p = g[n], l[n] = c ? "undefined" === typeof e ? c(p, n) : c.call(e, p, n) : p, n += 1;
    }
    l.length = h;
    return l;
  };
...
(function(a) {
  ...
  var f = /[^s]/, g = /[def]/, c = /^[^\x25]+/, e = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, l = /^([a-z_][a-z_\d]*)/i, n = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, m = /^[\+\-]/;
  b.format = function(a, c) {
    var e = 1, h = a.length, l, n = [], p, r, D, y, G = !0, t = "";
    for (p = 0;p < h;p++) {
      if (l = d(a[p]), "string" === l) {
        n[n.length] = a[p];
      } else {
        if ("array" === l) {
          ...
          if (!G || g.test(D[8]) && D[3]) {
            t = G ? "+" : "-", l = l.toString().replace(m, "");
          }
          r = D[4] ? "0" == D[4] ? "0" : D[4].charAt(1) : " ";
          y = D[6] - (t + l).length;
          y = D[6] ? Array(y + 1).join(r) : "";
          n[n.length] = D[5] ? t + l + y : 0 == r ? t + y + l : y + t + l;
        }
      }
    }
    return n.join("");
...
var CTATExampleTracerSkill = function(a, b, d, f, g, c, e) {
  ...
  var r = /^0*[xX]([0-9a-fA-F]+)$/.test(e) ? parseInt(e, 16) : /^(\-|\+)?[0-9]+$/.test(e) ? parseInt(e, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, q = 0, w = 0, u = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, B = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, x = null, A = null, C = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.getLabel = function() {
    return !x || 1 > x.length ? CTATExampleTracerSkill.getName(h) : x;
  };
  this.getDescription = function() {
    return !A || 1 > A.length ? h : A;
  };
  this.setVersion = function(a) {
    null !== a && "undefined" !== typeof a && 0 < a.length && (u = CTATExampleTracerSkill.versionToSkillBarDelimiter(a));
  };
...
(function() {
  ...
  a = function(a) {
    function d(a, b, f, g, n, p) {
      this.operator = a;
      this.left = b;
      this.right = f;
      this.parens = null != g ? g : 0;
      this.sign = null != n ? n : 1;
      this.exp = null != p ? p : 1;
    }
    b(d, a);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, d = [1, 6], f = [1, 7], g = [1, 10], c = [1, 11], e = [1, 12], h = [1, 13], l = [1, 21], n = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], m = [1, 23], r = [1, 24], q = [1, 26], w = [1, 27], u = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], B = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:l, 15:n}, b(p, [2, 11], {22:9, 19:25, 16:m, 18:r, 20:q, 21:w, 24:g, 25:c, 27:e, 28:h}), b(u, [2, 17]), {13:d, 15:f, 17:28, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:29, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(u, [2, 20]), b(u, [2, 23], {23:[1, 30]}), {13:d, 15:f, 17:31, 19:8, 22:9, 24:g, 25:c, 27:e, 
  ...
  24:g, 25:c, 27:e, 28:h}, {13:d, 14:39, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 14:40, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:41, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:42, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(u, [2, 14]), {13:d, 15:f, 17:43, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:44, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(u, [2, 18]), b(u, [2, 19]), {13:d, 15:f, 17:45, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(u, [2, 22]), {13:l, 
  15:n, 26:[1, 46]}, {5:[2, 2], 13:l, 15:n}, {5:[2, 3], 13:l, 15:n}, {5:[2, 4], 13:l, 15:n}, {5:[2, 5], 13:l, 15:n}, {5:[2, 6], 13:l, 15:n}, {5:[2, 7], 13:l, 15:n}, b(p, [2, 9], {22:9, 19:25, 16:m, 18:r, 20:q, 21:w, 24:g, 25:c, 27:e, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:m, 18:r, 20:q, 21:w, 24:g, 25:c, 27:e, 28:h}), b(u, [2, 12]), b(u, [2, 13]), b(u, [2, 15]), b(u, [2, 16]), b(u, [2, 21]), b(B, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, h = 0, n = 0, l = d.slice.call(arguments, 1), q = Object.create(this.lexer), m = {}, p;
    for (p in this.yy) {
    ...
    for (var w, u, B, K, O = {}, R, M;;) {
      ...
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        T = q.showPosition ? "Parse error on line " + (g + 1) + ":\n" + q.showPosition() + "\nExpecting " + M.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == w ? "end of input" : "'" + (this.terminals_[w] || w) + "'");
        this.parseError(T, {text:q.match, token:this.terminals_[w] || w, line:q.yylineno, loc:p, expected:M});
      }
      if (K[0] instanceof Array && 1 < K.length) {
        throw Error("Parse Error: multiple actions possible at state: " + B + ", token: " + w);
      }
      switch(K[0]) {
        case 1:
          b.push(w);
          ...
          b.push(K[1]);
          w = null;
          u ? (w = u, u = null) : (h = q.yyleng, f = q.yytext, g = q.yylineno, p = q.yylloc, 0 < n && n--);
          break;
        case 2:
          ...
          B = this.performAction.apply(O, [f, h, g, m, K[1], c, d].concat(l));
...
(function() {
  var a, b, d, f, g, c, e, h, l, n, p, m = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  f = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.matchWithoutPrecision = function(a, c) {
      var e, f;
      return (e = String(a).match(n)) && (f = String(c).match(n)) && (a = p(e) > p(f) ? (+a).toFixed(d(f)) : String(a)) && b(a, c, function(a, b) {
        return a === b;
      });
    };
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, c, l, n) {
      var p, m, r, q, w, u, B, x;
      try {
        w = "undefined" !== typeof window && null !== window ? window : global;
        p = function() {
          var a;
          a = [];
          for (r in w) {
        ...
        B = null != (u = a.match(b)) ? u : [];
        m = 0;
        for (q = B.length;m < q;m++) {
          r = B[m], 0 > g.call(d, r) && CTATFormulaFunctions.assign(r, void 0);
        }
        for (r in x = this.variableTable.getTable()) {
          w[r] = x[r];
        }
        ...
        }).apply(w, [c, l, n].concat(f.call(this.values)));
      } catch (A) {
        return console.log(A), null;
      } finally {
        for (r in w) {
          null != r && 0 > g.call(p, r) && (x[r] = w[r], delete w[r]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      for (r = q.length;g < r;a = ++g) {
        f = q[a], w.push(a % 2 ? this.evaluate(f, b, c, d) : f);
      }
      return w.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, f) {
    ...
    d.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + g + ", " + l + ", " + n + ", " + a + ")");
    try {
      f = b.evaluate(g, l, n, a);
    } catch (p) {
...
var CTATVectorMatcher = function(a, b, d, f) {
  function g(a, b, d, f, g) {
    ...
    var u = [];
    u[CTATMatcher.SELECTION] = a;
    u[CTATMatcher.ACTION] = b;
    u[CTATMatcher.INPUT] = d;
    for (var B = 0;3 > B;B++) {
      var x = l[B][0], A = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, d, f) : x.matchConcatenation(u[B]);
      n.ctatdebug("CTATVectorMatcher --\x3e in _match[" + B + "] after " + x + ".concat returns: " + A);
      if (g) {
        g.push(A);
      } else {
        if (!1 === A) {
  ...
  var n = this;
  this.match = function(a, b, c, d, e) {
    return !1 !== g(a, b, c, e) && n.matchActor(d) ? !0 : !1;
  };
...
var CTATExampleTracerLink = function(a, b, d) {
  ...
  var f = "undefined" === typeof a || null === a ? null : a, g = null, c = "undefined" === typeof b || null === b ? null : b, e = "undefined" === typeof d || null === d ? null : d, h = null, l = 1, n = 1, p = "CORRECT_ACTION", m = [], r = !1, q = null, w = "", u = null, B = null, x = this;
  ...
  this.addSkillName = function(a) {
    x.ctatdebug("ETLink[" + f + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === B || "undefined" === typeof B) {
        B = [];
      }
      -1 < B.indexOf(a) || (B.push(a), x.ctatdebug("ETLink.addSkillName() return with skillNames " + B));
    }
  };
  ...
  this.setIsPreferredLink = function(a) {
    x.ctatdebug("ETLink.setIsPreferredLink() was " + r + ", now " + a);
    r = a;
  };
  this.setVisualData = function(a) {
    u = a;
...
var CTATDefaultLinkGroup = function(a, b, d, f) {
  ...
  m.ctatdebug("CTATDefaultLinkGroup constructor group isReenterable: " + d);
  this.setOrdered = function(a) {
    m.ctatdebug("CTATDefaultLinkGroup --\x3e in setOrdered group name: " + g);
...
var CTATExampleTracerEvent = function(a, b, d) {
  ...
  var f = "", g = !1, c = CTATExampleTracerLink.NO_MODEL, e = !1, h = null, l = null, n = "student", p = null, m = null, r = "", q = null, w = null, u = null, B = null, x = null, A = [], C = !1, E = null, D = null, y = this;
  this.getActor = function() {
    return n;
  };
  this.setActor = function(a) {
  ...
  this.getTransactionID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + f);
    return f;
  };
  this.setTransactionID = function(a) {
  ...
  this.getResult = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + c);
    return c;
  };
  ...
  this.getWantReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + C);
    return C;
  };
  ...
  this.isOutOfOrder = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + q);
    return q;
  };
  ...
  this.setInterpolatedSAI = function(a) {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI(" + a + ")");
    a && (E = a);
  };
  this.getInterpolatedSAI = function() {
    return E ? E : y.getStudentSAI();
  };
  ...
  this.getReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + A);
    return A;
  };
  this.getReportableLink = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + p);
    return p;
  };
  this.getReportableVariableTable = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + B);
    return B;
  };
  this.getReportableInterpretation = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + m);
    return m;
  };
  this.getStepID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + r);
    return r;
  };
  ...
  this.getTutorInput = function() {
    return null !== u && "undefined" !== typeof u ? y.getEvaluatedInputArray() : null !== l && "undefined" !== typeof l ? l.getInputArray() : null;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function c(a, b, c) {
    ...
    t.ctatdebug("interps # : " + x.length);
    t.ctatdebug("interps: " + x);
    x.forEach(function(f) {
      t.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof m || null === m) {
        t.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), m = h(a.getStudentSAI(), a.getActor(), b, f.getVariableTable(), a), t.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      } else {
    ...
    var w = null;
    !0 === a.isSolverResult() ? (t.ctatdebug("In evaluate -- in if branch of isSolverResult"), w = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (t.ctatdebug("In evaluate -- in else branch of isSolverResult"), w = q.getLastMatchedLink().getType());
    return f(a, c, w, null, q, d);
  }
  ...
  function m(a) {
    ...
    0 === a.size ? t.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (t.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      x.push(a);
    }), y = null, t.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function r() {
  ...
  var x = null, A = null, C = null, E = a, D = null;
  ...
  this.resetTracer = function() {
    ...
    null === x || "undefined" === typeof x ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), x = []) : (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), x.length = 0);
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === y || "undefined" === typeof y) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), y = p(t.getInterpretationsInternal());
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === y || void 0 === y));
    return y;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = w(!1, [a])) ? a.getPrevNode() : E ? E.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, d) {
  ...
  var B = null, x = null, A = null, C = null, E = null, D = null, y = new Set, G = new Set, t = null, F = null, H = CTATMsgType.SHOW_ALL_FEEDBACK, z = this;
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), f = e.getElementChildren(a), g, h, l, m, n, r = a = -1, y = CTATMsgType.DEFAULT_ACTOR, G = !1, t = 0;t < f.length;t++) {
        ...
        for (d.setIsPreferredLink("false" != e.getElementAttr(f[t], "preferPathMark")), d.setMinTraversalsStr(e.getElementAttr(f[t], "minTraversals")), d.setMaxTraversalsStr(e.getElementAttr(f[t], "maxTraversals")), F = e.getElementChildren(f[t]), H = 0;H < F.length;H++) {
          ...
          if ("matchers" === e.getElementName(F[H])) {
            for (var z = e.getElementChildren(F[H]), I = 0;I < z.length;I++) {
              "Selection" === e.getElementName(z[I]) && (g = b(z[I], 0)), "Action" === e.getElementName(z[I]) && (h = b(z[I], 1)), "Input" === e.getElementName(z[I]) && (l = b(z[I], 2)), "Actor" === e.getElementName(z[I]) && (y = e.getNodeTextValue(z[I]), G = (G = e.getElementAttr(z[I], "linkTriggered")) && "false" != G.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === e.getElementName(F[H])) {
            ...
            for (var y = new CTATExactMatcher(CTATMatcher.ACTION, null), J = 0;J < h.length;J++) {
              ...
              "matcherParameter" === e.getElementName(h[J])) {
                ...
                "action" == N && y.setParameter(e.getNodeTextValue(h[J]));
    ...
    n = new CTATVectorMatcher(g, h, l, y);
  ...
  function d(a, b) {
    ...
    for (var l = function(a) {
      ...
      "group" === e.getElementName(m[p]) && (ctatdebug("encountered a subgroup"), d(m[p], b).forEach(l));
    }
    n.addGroup(f, g, c);
    n.setGroupReenterable(n.getGroupByName(f), h);
    return c;
  }
  ...
  this.parseGraph = function(b, f) {
    ...
    for (var D = null, y = 0;y < C.length;y++) {
      switch(e.getElementName(C[y])) {
        case "startNodeMessages":
          l = e.getElementChildren(C[y]);
          break;
        case "node":
          u++;
          var G;
          ...
          G = t;
          c.addNode(G);
          1 == u && (c.setStartNode(G), c.setStudentStartsHereNode(G));
    ...
    if (D) {
      u = e.getElementAttr(D, "ordered");
      if (null === u || "undefined" == typeof isordered) {
        u = !x;
      }
      ctatdebug("parseGraph() value of isOrdered = " + u);
      ctatdebug("parseGraph() value of isUnordered = " + x);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof u);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof x);
      B = D;
      C = u;
      ctatdebug("processGroup()");
      n = c.getGroupModel();
      u = n.createIdToLinkMap();
    ...
    u = f.getSkillBarVector(!1, !0);
    if (!u || 1 > u.length) {
      ctatdebug("No existing skills. Add skills from BRD."), f.addGraphSkills(r), u = f.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, x, m, f.isSourceFlash() ? c.exitOnIncorrectDone() : f.isFeedbackSuppressed(), A, E, u);
    c.redoLinkDepths();
    ...
    if (e && !(1 > e.length)) {
      ...
      for (var n = [], B = [], x = 0;x < e.length;++x) {
        ...
        if (A.msg) {
          ...
          if (!(C = f(A))) {
            var C = A, E = B, D = void 0, y = void 0;
            if (!(C && C.sai && (D = C.sai.getAction()) && (y = r.exec(D))) || 3 > y.length || 1 >= y[2]) {
              C = !1;
            } else {
              var G = E.length - 1, G = 0 > G ? null : E[G];
              C.msg = C.msg.replace(D, y[1]);
              G && G.timeout == y[2] ? G.msgTuples.push(C) : E.push({timeout:Number(y[2]), msgTuples:[C]});
              C = !0;
            }
          }
          C || n.push(A.msg);
      ...
      for (x = 0;x < B.length;++x) {
        A = B[x], m.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + A.timeout + ", .msgTuples.length " + A.msgTuples.length), setTimeout(g, A.timeout, c, A.msgTuples);
      }
...
var CTATProblemSummary = function(a, b, d) {
  ...
  var f = !0, g = Number.MAX_VALUE, c = b, e = d, h = 0, l = new Date, n = {}, p = 0, m = 0, r = 0, q = 0, w = 0, u = 0, B = 0, x = CTATMsgType.CompletionValue[0], A = this;
  ...
  this.toXML = function(b) {
    ...
    f && (c += ' Correct="' + p + '"', c += ' UniqueCorrect="' + A.getUniqueCorrect() + '"', c += ' UniqueCorrectUnassisted="' + u + '"', c += ' Hints="' + m + '"', c += ' UniqueHints="' + q + '"', c += ' HintsOnly="' + A.getHintsOnly() + '"', c += ' Errors="' + r + '"', c += ' UniqueErrors="' + A.getUniqueErrors() + '"', c += ' ErrorsOnly="' + A.getErrorsOnly() + '"', c += ' UniqueSteps="' + A.getUniqueSteps() + '"', c += ' RequiredSteps="' + A.getRequiredSteps() + '"');
    c += ' TimeElapsed="' + h + '"';
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++w, 1 > b.getNFirstHints() && u++), b.incrementNCorrect()) : (A.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), n[a] = b, w++, u++);
    p++;
...
var CTATSkills = function(a) {
  ...
  this.updateSkill = function(a, b, h) {
    var l = null, n = g.getSkill(b);
    null !== n && "undefined" !== typeof n && (n.setTransactionNumber(d), b = h + " " + b, f.has(b) || (f.add(b), n.updatePKnown(a), n.updateHistory(a), n.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && f["delete"](b), l = n);
    return l;
  };
  ...
  this.getSkillBarVector = function(a, f) {
    var g = [], l;
    for (l in b) {
      !0 === b.hasOwnProperty(l) && (!0 !== f && b[l].getTransactionNumber() !== d || g.push(b[l].getSkillBarString(a)));
    }
    return g;
  };
      ...
      if (d.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof d && (d = d.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + d.length + ", msgsArr[1].length " + (d[1] ? d[1].length : -1)), !(2 > d.length))) {
          ...
          for (var c = 0, e = !1, h = 1;h < d.length;++h) {
            var l = "<message>" + d[h], n = CTATMsgType.getMessageType(l);
            CTATMsgType.STATE_GRAPH == n ? e = !0 : CTATMsgType.START_STATE_END == n ? e = !1 : e ? c++ : CTATMsgType.INTERFACE_ACTION == n && h == d.length - 1 && CTATMsgType.isDoneMessage(l) && a.getOutputStatus().isComplete() || (a.getProblemStateSaver().appendToProblemState(l, null, !0), g.push(l));
            b.ctatdebug("problemStateArr[" + h + "] " + (e ? "omit " : "keep ") + n + " omitted " + c + " kept " + g.length);
          }
        }
...
var CTATExampleTracer = function() {
          ...
          case "skills":
            ...
            for (var e = A.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = A.getElementAttr(e[f], "label"), l = A.getElementAttr(e[f], "pSlip"), m = A.getElementAttr(e[f], "description"), n = A.getElementAttr(e[f], "pKnown"), p = A.getElementAttr(e[f], "category"), r = A.getElementAttr(e[f], "pLearn"), u = A.getElementAttr(e[f], "pGuess"), x = A.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(p, h, u, n, l, r, x);
                  h.setLabel(g);
                  h.setDescription(m);
                  d.push(h);
                }
  ...
  function c(a, b, c, d) {
    ...
    (E === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? C && C.getSelection() ? (e.splice(1, 0, C.getSelection()), d.splice(1, 0, "PreviousFocus")) : (e[1] = "", d[1] = "") : E === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && C && C.getSelection() && (e.splice(1, 0, C.getSelection()), d[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), q.startSkillTransaction(), a = [], d = u.doHint(e, d, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), e = d ? "" + d.getUniqueID() : 
  ...
  function n(a, b, c, d, e, f) {
    ...
    q.getOutputStatus(), e.getStudentSAI(), x.getFeedbackPolicy() == CTATMsgType.HIDE_BUT_ENFORCE) : e.getResult() != CTATExampleTracerLink.CORRECT_ACTION && e.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || H.appendToProblemState(f, q.getOutputStatus(), !1);
    e.setTransactionID(g);
    e = m(e, b, c, d);
  ...
  function m(a, b, c, d) {
    ...
    b = a.getStudentSAI();
    var f = a.getTutorSAI(), g = a.getTransactionID(), l = new CTATTutorMessageBuilder, m = "", n = [];
    null !== a.getReportableLink() && "undefined" !== typeof a.getReportableLink() ? n[0] = a.getReportableLink() : n[0] = null;
    n = n[0];
    if (a.isSolverResult()) {
      a.getResult();
    } else {
      if (a.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        m = n ? "" + n.getUniqueID() : "", a.setStepID(m), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && q.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, l.createCorrectActionMessage(g, f), a, f), null !== n && "undefined" !== typeof n && q.updateSkills(CTATExampleTracerSkill.CORRECT, n.getSkillNames(), n.getUniqueID()), m = a.getSuccessOrBuggyMsg(), q.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, l.createAssociatedRulesMessageForAction(a.getResult(), 
        f, p(c), b, q.getSkillBarVector(!0, c), n ? n.getUniqueID() : -1, g, m), a, f), q.ctatdebug("finishNewExampleTrace() successMsg " + m), m && q.messageTank.addToMessageTank("SuccessMessage", l.createSuccessMessage(g, m), a, null), C = null, d && (c = h(n ? n.getNextNode() : null, u.findCurrentState(!1, !1), q.lastMessage ? q.lastMessage.getSAI() : null, a)) && (a = c);
      } else {
        ...
        r.setHintRequest(!0);
        var t = u.traceForHint(r);
        q.ctatdebug("silent hint result: " + r + "; hintLink " + t);
        t || (t = u.getBestNextLink(!1, r), q.ctatdebug("getBestNextLink result: " + r + "; hintLink " + t));
        f = null;
        t && ((f = r.getTutorSAI()) && f.getSelection() && a.setTutorSAI(f), m = "" + t.getUniqueID(), a.setStepID(m));
        r = e(a, r, l);
        q.ctatdebug("createBuggyMessage() tutorAdvice: " + r.tutorAdvice + ";\n  msg " + r.msg);
        q.updateSkills(CTATExampleTracerSkill.INCORRECT, t ? t.getSkillNames() : [], m);
        q.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, l.createAssociatedRulesMessageForAction(a.getResult(), f && f.getSelection() ? f : b, p(c), b, q.getSkillBarVector(!0, c), m, g, r.tutorAdvice), a, null);
        r.msg && q.messageTank.addToMessageTank(r.msgType, r.msg, a);
        C = b;
        d && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == a.getResult() ? (c = h(n ? n.getNextNode() : null, u.findCurrentState(!1, !1), q.lastMessage ? q.lastMessage.getSAI() : null, a)) && (a = c) : a.isDoneStepFailed() && q.messageTank.flushDelayedFeedback();
      }
    }
    q.lastResult = a;
  ...
  var q = this, w = null, u, B, x, A = new CTATXML;
  new XMLSerializer;
  var C = null, E, D = !0, y = !1, G = null, t = null, F = null, H = new ProblemStateSaver(q);
    ...
    if (null != a) {
      ...
      for (var d = [], e = new XMLSerializer, f = null, g = 0;g < a.length;g++) {
        if ("message" == A.getElementName(a[g])) {
          ...
          CTATMsgType.START_STATE_END == m ? (f = d, x.getFeedbackPolicy() != CTATMsgType.SHOW_ALL_FEEDBACK && (m = new CTATSAI("hint", "SetVisible", "false"), m = (new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID", m), f.push(m)), f = l, d.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()), d.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))) : d.push(l);
        }
      }
      d.unshift(c);
      ...
      a: {
        a = [];
        c = x.getStartNode();
        d = x.getStudentStartsHereNode();
        if (null !== c && null !== d && c.getNodeID() != d.getNodeID()) {
          a = x.getBestSubpath(c, d);
        ...
        h(c, u.findCurrentState(!1, !1), null, d);
      }
      a = [];
      b && a.push(b);
  ...
  this.getProblemSummary = function(a) {
    ...
    a && G.setRequiredSteps(a.countStepsForScore(x));
    return G;
  };
  ...
  this.setFeedbackSuppressed = function(a) {
    y = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : !1;
    q.ctatdebug("setFeedbackSuppressed(" + a + "): " + y);
    G && G.setCountOnlyLastResults(y);
  };
