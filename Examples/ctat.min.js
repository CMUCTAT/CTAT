...
var jstz = function() {
  ...
  "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, b = function(a) {
    ...
    a = a.getTime() + b;
    for (var f = (new Date(g)).getTimezoneOffset(), e = null;g < a - c;) {
      var d = new Date(g);
      if (d.getTimezoneOffset() !== f) {
        e = d;
        break;
      }
      g += c;
    }
    return 864E5 === b ? l(e, 36E5, 6E4) : 36E5 === b ? l(e, 6E4, 1E3) : e;
  }, c = function(a, b, c, g) {
    if ("N/A" !== c) {
      return c;
    }
    ...
    for (var f = {}, e = jstz.olson.dst_rules.zones, d = e.length, h = a[g], w = 0;w < d;w++) {
      var x = e[w], t;
      t = e[w];
      for (var B = 0, C = 0;C < b.length;C++) {
        if (t.rules[C] && b[C]) {
          if (b[C].s >= t.rules[C].s && b[C].e <= t.rules[C].e) {
            B = 0, B += Math.abs(b[C].s - t.rules[C].s), B += Math.abs(t.rules[C].e - b[C].e);
          } else {
            B = "N/A";
            break;
          }
    ...
    for (var G in f) {
      if (f.hasOwnProperty(G) && -1 != h.indexOf(G)) {
        return G;
      }
    }
    return g;
    ...
    var b = function() {
      for (var a = [], b = 0;b < jstz.olson.dst_rules.years.length;b++) {
        ...
        for (var f = (new Date(g)).getTimezoneOffset(), e = null, h = null;g < c - 864E5;) {
          var l = new Date(g), p = l.getTimezoneOffset();
          p !== f && (p < f && (e = l), p > f && (h = l), f = p);
          g += 864E5;
        }
        c = e && h ? {s:d(e).getTime(), e:d(h).getTime()} : !1;
        a.push(c);
      }
      return a;
    }();
  ...
  return {determine:function() {
    var b = f();
    b || (b = jstz.olson.timezones[e()], "undefined" !== typeof a[b] && (b = h(b)));
...
(function(a, b) {
  ...
  function e(a, b, c, g) {
    var f = ["opacity", b, ~~(100 * a), c, g].join("-");
    c = .01 + c / g * 100;
    g = Math.max(1 - (1 - a) / b * (100 - c), a);
    var e = n.substring(0, n.indexOf("Animation")).toLowerCase();
    p[f] || (m.insertRule("@" + (e && "-" + e + "-" || "") + "keyframes " + f + "{0%{opacity:" + g + "}" + c + "%{opacity:" + a + "}" + (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + g + "}}", m.cssRules.length), p[f] = 1);
    return f;
  }
  function f(a, b) {
    var c = a.style, g, f;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, f) {
      function e() {
        return d(c("group", {coordsize:l + " " + l, coordorigin:-k + " " + -k}), {width:l, height:l});
      }
      function h(a, l, m) {
        b(p, b(d(e(), {rotation:360 / f.lines * a + "deg", left:~~l}), b(d(c("roundrect", {arcsize:f.corners}), {width:k, height:f.scale * f.width, left:f.scale * f.radius, top:-f.scale * f.width >> 1, filter:m}), c("fill", {color:g(f.color, a), opacity:f.opacity}), c("stroke", {opacity:0}))));
      }
      var k = f.scale * (f.length + f.width), l = 2 * f.scale * k, m = -(f.width + f.length) * f.scale * 2 + "px", p = d(e(), {position:"absolute", top:m, left:m});
      if (f.shadow) {
        for (m = 1;m <= f.lines;m++) {
  ...
  var l = ["webkit", "Moz", "ms", "O"], p = {}, n, m, u = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  c(h.prototype, {spin:function(b) {
    this.stop();
    var c = this, g = c.opts, f = c.el = a(null, {className:g.className});
    d(f, {position:g.position, width:0, zIndex:g.zIndex, left:g.left, top:g.top});
    b && b.insertBefore(f, b.firstChild || null);
    f.setAttribute("role", "progressbar");
    c.lines(f, c.opts);
    if (!n) {
      var e = 0, h = (g.lines - 1) * (1 - g.direction) / 2, k, l = g.fps, m = l / g.speed, p = (1 - g.opacity) / (m * g.trail / 100), u = m / g.lines;
      (function A() {
        e++;
        for (var a = 0;a < g.lines;a++) {
          k = Math.max(1 - (e + (g.lines - a) * u) % m * p, g.opacity), c.opacity(f, a * g.direction + h, k, g);
        }
        c.timeout = c.el && setTimeout(A, ~~(1E3 / l));
      })();
    }
    return c;
  }, stop:function() {
    ...
    function h(b, c) {
      return d(a(), {position:"absolute", width:f.scale * (f.length + f.width) + "px", height:f.scale * f.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / f.lines * k + f.rotate) + "deg) translate(" + f.scale * f.radius + "px,0)", borderRadius:(f.corners * f.scale * f.width >> 1) + "px"});
    }
    for (var k = 0, l = (f.lines - 1) * (1 - f.direction) / 2, m;k < f.lines;k++) {
      m = d(a(), {position:"absolute", top:1 + ~(f.scale * f.width / 2) + "px", transform:f.hwaccel ? "translate3d(0,0,0)" : "", opacity:f.opacity, animation:n && e(f.opacity, f.trail, l + k * f.direction, f.lines) + " " + 1 / f.speed + "s linear infinite"}), f.shadow && b(m, d(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(m, h(g(f.color, k), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
  ...
  if ("undefined" !== typeof document) {
    ...
    var r = d(a("group"), {behavior:"url(#default#VML)"});
    !f(r, "transform") && r.adj ? k() : n = f(r, "animation");
  }
  return h;
});
...
;var CTATConfig = {Options:{}, addProperty:function(a, b, e, f) {
  e = e || b[0];
  Object.defineProperty(CTATConfig, a, {enumerable:!0, configurable:!1, writable:!f, value:e.toLowerCase()});
  var d = {};
...
function introspect(a, b, e, f) {
  ...
  if ("object" === d) {
    if (0 < f) {
      e = [e, "  "].join("");
      for (var c in b) {
        d = this.introspect(c, b[c], e, f - 1), a = [a, "\n", d].join("");
      }
      return a;
    }
    return [a, " ..."].join("");
...
var CTATBase = function(a, b) {
  ...
  var f = a, d = b, c = this, g = !0;
  "undefined" != CTATBase.DebuggingFilter[f] && CTATBase.DebuggingFilter[f] && (g = !1);
  ...
  this.ctatdebugInternal = function(a, b) {
    var g = a, f = "No msg assigned yet";
    if (null === g || void 0 === g) {
      g = "No message!";
    }
    "" === g && (g = "Empty message!");
    if (useDebuggingBasic) {
      f = e("Unknown", "undefined", g), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += f + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(f);
    } else {
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), component_descriptions:{}, registerComponentDescription:function(a) {
...
}, feedback_components:[], registerFeedbackComponent:function(a, b, e, f, d) {
  CTATShellTools.feedback_components.push({component:a, next:b, prev:e, showHints:f, showFeedback:d});
  ...
  var e = CTATShellTools.component_descriptions, f = [], d = null, d = -1 < a.indexOf(".") ? $('[id="' + a + '"]') : $("#" + a);
  if (0 < d.length) {
    var c = [];
    d.each(function() {
...
var CTATSAI = function(a, b, e, f) {
  function d(a, b, c, g) {
    g = String(r.getElementName(b)).toLowerCase();
    if (g == a || "value" == g) {
      if (g = r.getElementChildren(b), !Array.isArray(g) || 1 > g.length) {
        c.push(r.getNodeTextValue(b));
      } else {
  ...
  var c = "undefined", g = "undefined", h = new CTATStringUtil, k = [], l = [], p = [], n = [], m = [], u = [], r, w = this;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      var g = a[c];
      if ("selection" == r.getElementName(g) || "Selection" == r.getElementName(g)) {
        for (var f = r.getElementChildren(g), e = !1, d = 0;d < f.length;d++) {
          b = f[d], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > d ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = r.getNodeTextValue(g), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(g) || "Action" == r.getElementName(g)) {
        f = r.getElementChildren(g);
        e = !1;
        for (d = 0;d < f.length;d++) {
          b = f[d], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > d ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = r.getNodeTextValue(g), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(g) || "value" == r.getElementName(g) || "Input" == r.getElementName(g)) {
        var b = r.getElementChildren(g), h = null;
        k = [];
        ...
        for (var l = 0;l < b.length;l++) {
          var m = b[l];
          "value" == r.getElementName(m) && (h = r.getElementChildren(m), null !== h ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), e.setValue(h)) : (h = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), e.setValue(h), e.setName(m.attributes.getNamedItem("name").value), e.setType(m.attributes.getNamedItem("type").value), 
          e.setFormat(m.attributes.getNamedItem("format").value), d++), 1 > l ? this.setInputArray(h) : this.appendToInputArray(h)) : (m = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), 1 > l ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
      if ("prompt" == r.getElementName(g) || "Prompt" == r.getElementName(g)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(r.getNodeTextValue(g));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, c = String(r.getElementName(a[0])).toLowerCase();
      switch(c) {
        case "selection":
          b = n = [];
          break;
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == r.getElementName(g) || "Input" == r.getElementName(g)) {
        b = g.childNodes;
        k = [];
        var f = new CTATHTMLManager, e = new CTATArgument, d = 0, h = null;
        k.push(e);
        for (var l = 0;l < b.length;l++) {
          if (h = b[l], "value" == r.getElementName(h)) {
            var m = r.getElementChildren(h);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (h = f.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), e.setValue(h)) : (h = f.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), e.setValue(h), e.setName(r.getElementAttr("name")), e.setType(r.getElementAttr("type")), e.setFormat(r.getElementAttr("format")), d++)) : (h = f.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + 
            h), e.setValue(h));
  ...
  var x = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(e) || null == e) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(e), x = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == e ? null : e[0], "String", f);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, e, "String", f), x || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(e) ? e : [e]), x = !0));
};
...
var CTATSkill = function() {
  ...
  var a = "", b = "", e = "", f = "", d = 0, c = "", g = !1, h = "", k = "", l = "", p = "", n = "";
  ...
  this.toSetPreferencesXMLString = function() {
    var g = '<skill label="' + b + '" pSlip="' + k + '" description="' + c;
    return g += '" pKnown="' + l + '" category="' + e + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" history="' + n + '" />';
  };
...
var CTATSkillSet = function() {
  ...
  this.parseByValue = function(b) {
    ...
    if (b) {
      b = b.childNodes;
      for (var e = new CTATXML, f = 0;f < b.length;f++) {
        var d = e.getNodeTextValue(b[f]).split("`"), c = d[0].split(" ");
  ...
  this.parseDOM = function(a) {
    ...
    for (var f = 0;f < a.length;f++) {
      var d = e.getNodeTextValue(a[f]).split("`"), c = d[0].split(" ");
      4 == d.length ? this.addSkill(c[0], d[1], d[2], d[3], d[3], c[1]) : this.addSkill(c[0], d[1], d[2], d[3], d[4], c[1]);
    }
  };
  ...
  this.addSkill = function(a, e, f, d, c, g, h, k, l, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + e + " mastery = " + f + " aDescription = " + d + " adisplayName = " + c + " aCategory = " + g + " pguess= " + h + " plearn = " + k + " pslip = " + l + " history = " + p);
    a = this.setSkillLevel(a, e, f);
  ...
  this.setSkillLevel = function(a, e, f) {
    this.ctatdebug("setSkillLevel (" + a + "," + e + "," + f + ")");
    f = this.getSkill(a);
    null === f ? (this.ctatdebug("Skill not found, creating new one ..."), f = new CTATSkill, f.setSkillName(a), f.setLevel(e), this.internalSkillSet.push(f)) : (this.ctatdebug("Skill found, adjusting ..."), f.setLevel(1), f.setLevel(e));
    f.setTouched(!0);
    return f;
  };
  this.getSkill = function(a) {
    ...
    for (var e = 0;e < this.internalSkillSet.length;e++) {
      var f = this.internalSkillSet[e];
      if (f.getSkillName() == a) {
        return this.ctatdebug("Returning: " + e), f;
      }
    }
    return null;
  };
  ...
  this.toLogString = function() {
    ...
    for (var a = "", e = 0;e < this.internalSkillSet.length;e++) {
      var f = this.internalSkillSet[e], a = a + ('<skill probability="' + f.getLevel() + '"><name>' + f.getSkillName() + "</name>");
...
var transformArray = [], CTATJSON = function() {
  ...
  this.getElementChildren = function(a) {
    ...
    for (c in a) {
      var g = a[c];
      if ("string" == typeof g) {
        b = new CTATJSONObject, b.name = c, b.value = g, d.push(b);
      } else {
        if (null == g[0] || void 0 == g[0]) {
          b = new CTATJSONObject, b.name = c, b.value = g, d.push(b);
        } else {
          for (var h in g) {
            b = new CTATJSONObject, b.name = c, b.value = g[h], d.push(b);
          }
        }
      }
    }
...
var CTATMessage = function(a) {
  ...
  var d = "ungraded", c = !1, g = !1, h = new CTATSkillSet, k = "", l = "", p = "", n = "", m = "", u = null, r = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      this.parseSAI();
      for (var a = f.getElementChildren(b), g = 0;g < a.length;g++) {
        var d = a[g];
        "properties" == f.getElementName(d) && (ctatdebug("Found a 'properties' element ... "), e = f.getElementChildren(d));
      }
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      for (d = 0;d < a.length;d++) {
        if (e = a[d], "tool_message" == f.getElementName(e)) {
          for (e = f.getElementChildren(e), l = 0;l < e.length;l++) {
            r = e[l], "event_descriptor" == f.getElementName(r) && (u = new CTATSAI, u.fromXMLInternal(r));
          }
        }
      }
      g = !0;
      ...
      if (c) {
        ...
        for (var z = f.getElementChildren(b), y = 0;y < z.length;y++) {
          var q = z[y];
          if ("event_descriptor" == f.getElementName(q)) {
            for (var q = f.getElementChildren(q), F = 0;F < q.length;F++) {
              var E = q[F];
              "selection" == f.getElementName(E) && (a = f.getNodeTextValue(E), r.push(E));
              "action" == f.getElementName(E) && (d = f.getNodeTextValue(E), G.push(E));
              "input" == f.getElementName(E) && (e = f.getNodeTextValue(E), D.push(E));
              "prompt" == f.getElementName(E) && (l = f.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), z = f.getElementChildren(b), y = 0;y < z.length;y++) {
          if (q = z[y], "properties" == f.getElementName(q)) {
            for (q = f.getElementChildren(q), F = 0;F < q.length;F++) {
              E = q[F], this.ctatdebug("Nodename: " + f.getElementName(E)), "Skills" == f.getElementName(E) && h.parseByValue(E), "SuccessMsg" == f.getElementName(E) && (p = a = f.getNodeTextValue(E)), "BuggyMsg" == f.getElementName(E) && (n = f.getNodeTextValue(E)), "Selection" == f.getElementName(E) && (a = f.getNodeTextValue(E), r.push(E)), "Action" == f.getElementName(E) && (d = f.getNodeTextValue(E), G.push(E)), "Input" == f.getElementName(E) && (e = f.getNodeTextValue(E), D.push(E)), "prompt" == 
              f.getElementName(E) && (l = f.getNodeTextValue(E)), "HighlightMsgText" == f.getElementName(E) && (m = f.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + d + "," + e);
      "" !== a && null !== a ? (u = new CTATSAI(a, d, e, l), u.setArrayFromElements(r), u.setArrayFromElements(G), u.setArrayFromElements(D), g = !0) : (this.ctatdebug("No SAI found"), g = !1);
      this.ctatdebug("parseSAI () done, hassai: " + g + ", (" + a + "," + d + "," + e + "," + l + ")");
    }
  };
      ...
      if (!c) {
        for (var a = f.getElementChildren(b), g = 0;g < a.length;g++) {
          ...
          if ("properties" == f.getElementName(d)) {
            for (var d = f.getElementChildren(d), e = 0;e < d.length;e++) {
              var h = d[e];
  ...
  this.parseMessageType = function() {
    ...
    for (var a = f.getElementChildren(b), c = 0;c < a.length;c++) {
      var g = a[c];
      if ("properties" == f.getElementName(g)) {
        for (var g = f.getElementChildren(g), d = 0;d < g.length;d++) {
          var e = g[d];
          "MessageType" == f.getElementName(e) && (k = f.getNodeTextValue(e));
        }
      }
    }
    ...
    if (!c) {
      if (null !== e) {
        for (var b = 0;b < e.length;b++) {
          var g = e[b];
          if (f.getElementName(g) == a) {
            return f.getNodeTextValue(g);
          }
        }
      } else {
        this.ctatdebug("Internal error: no messageProperties object available");
...
var CTATCompBase = function(a, b, e, f, d, c) {
  CTATBase.call(this, a, b);
  var g = e || 0, h = f || 0, k = d || -2, l = c || -2, p = 50, n = 25, m = !1, u = !1, r = "", w = !1, x = !0, t = null, B = "", C = -1;
  this.isTabIndexable = !0;
  var G = 0, D = null, z = null, y = this, q = null, F = "hidden", E = CTATGlobalFunctions.gensym.z_index(), A = CTATGlobalFunctions.gensym.div_id(), H = CTATGlobalFunctions.gensym.z_index(), J = CTATGlobalFunctions.gensym.div_id();
  ...
  this.createCanvas = function() {
    ...
    q.setAttribute("id", J);
    q.setAttribute("onkeypress", "return noenter(event)");
    q.setAttribute("width", k + canvasCalibrate + "px");
    q.setAttribute("height", l + canvasCalibrate + "px");
    q.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == F ? "visibility: hidden; " : "") + "z-index:" + H + ";");
    t.firstChild ? t.insertBefore(q, t.firstChild) : t.appendChild(q);
    return q;
  };
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      D ? a = window.getComputedStyle(D) : t && (a = window.getComputedStyle(t));
      if (a) {
  ...
  this.setEnabled = function(a) {
    ...
    y.assignEnabled(a);
    D ? D.disabled = !x : y.ctatdebug("Error: component pointer is null");
  };
  ...
  this.setInitialized = function(a) {
    ...
    w = a;
    !0 !== w || t ? y.ctatdebug("Not wrapping, initialized=" + w + ", divWrapper = " + t) : (y.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), console.log("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (y.ctatdebug("Attaching component to existing MovieClip ..."), console.log("Attaching component to existing MovieClip ...", a), y.wrapComponent(a.getDivWrapper())) : 
    (y.ctatdebug("Attaching component to main div ..."), console.log("Attaching component to main div ...", ctatcontainer, $("#" + ctatcontainer)), 0 < $("#" + ctatcontainer).length && y.wrapComponent(getSafeElementById(ctatcontainer))));
    y.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, c) {
    y.ctatdebug("addSafeEventListener (" + a + ")");
    y.ctatdebug("Adding event listener to: " + c);
    c ? c.addEventListener(a, b) : (D ? (y.ctatdebug("Adding eventlistener to component instead of target"), D.addEventListener(a, b)) : y.ctatdebug("Error: pointer to component is null, can't add event listener"), y.ctatdebug("addSafeEventListener () done"));
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    F = !0 === a ? "block" : "hidden";
    q && q.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + g + "px; top:" + h + "px; z-index:" + H + ";");
  ...
  this.processTabOrder = function() {
    ...
    !0 === m ? y.ctatdebug("Component is an abstract component, bump") : D ? (y.ctatdebug("We have a component, actually assigning to html component ..."), D.tabIndex = C, D.onfocus = y.processOnFocus) : y.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
...
var CTATCSS = function() {
  ...
  this.toCSSString = function() {
    for (var a = "", d = 0;d < f.length;d++) {
      for (var a = a + (f[d][0] + " { "), e = 1;e < f[d].length;e++) {
        a += f[d][e], a = 0 === e % 2 ? a + "; " : a + ": ";
      }
      a += " }; ";
    }
...
CTAT.Component = {};
CTAT.Component.Base = {};
CTAT.Component.Base.Style = function(a, b, e, f, d, c) {
  CTATCompBase.call(this, a, b, e, f, d, c);
  var g = new CTATCSS;
...
CTAT.Component.Base.Graphical = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Style.call(this, a, b, f, d, c, g);
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", p = 1, n = CTATGlobals.Visual.BorderColor, m = !1, u = "solid", r = 0, w = "1px", x = 0, t = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, G = CTATGlobals.Font.size, D = !1, z = !1, y = !1;
  ...
  this.getPadding = function() {
    return this.component ? parseInt($(this.component).css("padding-left")) : x;
  };
  this.setPadding = function(a) {
    x = parseInt(a);
    isNaN(x) && (x = 0);
    this.component && this.getPadding() !== x && (this.component.style.padding = x + "px");
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== m && (m ? (this.setBorderStyle(u), this.setBorderWidth(w)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : z;
  };
  this.setItalicized = function(a) {
    z = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== z && (this.component.style.fontStyle = z ? "italic" : null);
    return this;
  };
  var q = this;
  a = function(a) {
...
CTAT.Component.Base.SAIHandler = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Graphical.call(this, a, b, e, f, d, c, g);
...
CTAT.Component.Base.Tutorable = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.SAIHandler.call(this, a, b, e, f, d, c, g);
  var h = !0, k = !0, l = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, m = this, u = !1;
  ...
  this.getTutorComponent = function() {
    ...
    return h && k && l ? a.TUTOR : h && k && !l ? a.TUTOR_NO_FEEDBACK : !h && k ? a.DO_NOT_TUTOR : p;
  };
...
CTAT.Component.Base.Clickable = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Tutorable.call(this, a, b, e, f, d, c, g);
  var h = this;
...
var CTATRadioButton = function(a, b, e, f, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATRadioButton", "__undefined__", a, b, e, f, d);
  ...
  this.showCorrect = function(a) {
    u("CTAT--hint");
    u("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? m("CTAT--correct") : u("CTAT-correct");
  };
  this.removeCorrect = function() {
    u("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    u("CTAT--hint");
    u("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? m("CTAT--incorrect") : u("CTAT-incorrect");
  };
  this.removeInCorrect = u.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? m("CTAT--hint") : u("CTAT--hint");
  };
};
...
var CTATButtonBasedComponent = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Clickable.call(this, a, b, e, f, d, c, g);
...
var CTATImageButtonComponent = function(a, b, e, f, d, c, g) {
  CTATButtonBasedComponent.call(this, a, b, e, f, d, c, g);
  var h = "", k = "", l = "", p = "", n = !1, m = "Image to Component", u = this;
  ...
  this.assignActiveImage = function(a) {
    if (null !== u.getComponent() && (u.getComponent().src = a, u.getComponent().style.opacity = this.getTransparencyValue(), "Component to Image" == m)) {
      var b = new Image;
      b.src = a;
      u.setWidth(b.width);
  ...
  this.setEnabled = function(a) {
    ...
    u.assignEnabled(a);
    null === u.getComponent() ? u.ctatdebug("Error: pointer is null!") : (u.getComponent().disabled = !a, !1 === u.getEnabled() ? u.assignActiveImage(p) : u.assignActiveImage(h), u.ctatdebug("setEnabled () -> " + u.getEnabled()));
  };
...
var CTATImageButton = function(a, b, e, f, d) {
  CTATImageButtonComponent.call(this, "CTATImageButton", "__undefined__", a, b, e, f, d);
...
var CTATConfiguration = function() {
  ...
  var a = this, b = [], e = null, f = null, d = null, c = null;
  ...
  this.getSingleParameterValues = function(b) {
    ...
    for (var f = a.getRawFlashVars(), d = 0;d < b.length;++d) {
      f[b[d]] && c.push(b[d]);
    }
    return c;
  };
    ...
    if (null == c) {
      ...
      if ("undefined" != typeof CTATTarget && "XBlock" != CTATTarget && "OLI" != CTATTarget) {
        ...
        if (f) {
          for (var f = f.split("&"), e = 0;e < f.length;e++) {
            var n = f[e].split("=");
            ctatdebug("Setting flashvar " + n[0] + ", to: " + decodeURIComponent(n[1].replace(/\+/g, " ")));
            b[decodeURIComponent(n[0])] = decodeURIComponent(n[1].replace(/\+/g, " "));
          }
        }
      ...
      for (var m in d) {
        if (d.hasOwnProperty(m)) {
          switch(ctatdebug("Processing external FlashVar " + m + "(" + d[m] + ")"), m) {
            case "GENERATED":
              "on" == d[m] && (b = new CTATGuid, c.session_id = b.guid(), b = !0);
              break;
            case "BRD":
              c.question_file = d[m];
              break;
            case "BRMODE":
              c.BehaviorRecorderMode = d[m];
              break;
            case "PROBLEM":
              c.problem_name = d[m];
              break;
            case "DATASET":
              ...
              break;
            case "LEVEL1":
              c.dataset_level_name1 = d[m];
              break;
            case "TYPE1":
              c.dataset_level_type1 = d[m];
              break;
            case "LEVEL2":
              c.dataset_level_name2 = d[m];
              break;
            case "TYPE2":
              c.dataset_level_type2 = d[m];
              break;
            case "LEVEL3":
              c.dataset_level_name3 = d[m];
              break;
            case "TYPE3":
              c.dataset_level_type3 = d[m];
              break;
            case "LEVEL4":
              c.dataset_level_name4 = d[m];
              break;
            case "TYPE4":
              c.dataset_level_type4 = d[m];
              break;
            case "USER":
              c.user_guid = d[m];
              break;
            case "SESSION":
              !1 === b && (c.session_id = d[m]);
              break;
            case "SOURCE":
              c.source_id = d[m];
              break;
            case "LOGTYPE":
              ...
              break;
            case "PORT":
              c.remoteSocketPort = d[m];
              break;
            case "REMOTEURL":
              c.remoteSocketURL = d[m];
              break;
            case "DISKDIR":
              c.log_to_disk_directory = d[m];
              break;
            case "log_service_url":
              c.log_service_url = d[m];
              break;
            case "URL":
              c.log_service_url = d[m];
              break;
            case "LOGURL":
              ...
              break;
            case "CONNECTION":
              c.tutoring_service_communication = d[m];
              break;
            case "SUI":
              c.sui = d[m];
              break;
            ...
            case "SessionLog":
              ...
              break;
            case "KEYBOARDGROUP":
              "Disabled" == d[m] && (c.keyboard = "disabled");
              "Auto" == d[m] && (c.keyboard = "auto");
              "On" == d[m] && (c.keyboard = "on");
              break;
            default:
              c[m] = d[m];
          }
  ...
  this.preParse = function() {
    ...
    for (f = !0;1 == f;) {
      f = !1;
      var d = "custom_field_name" + (c + 1), e = "custom_field_value" + (c + 1);
      a.ctatdebug("Trying : " + a.raw[d] + "," + a.raw[e]);
      null != a.raw[d] && (a.ctatdebug("Adding: " + d + "," + a.raw[e]), b[a.raw[d]] = a.raw[e], f = !0, c++);
    }
  };
  this.getDatasetNames = function() {
    ...
    for (var b = 0, c = !0;1 == c;) {
      ...
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), e[b] = a.raw[f], c = !0, b++);
    }
    return e;
  };
  ...
  this.getConditionNames = function() {
    ...
    for (var f = 0, d = !0;1 == d;) {
      var d = !1, e = "study_condition_name" + (f + 1);
      null != a.raw[e] && (a.ctatdebug("Adding: " + e + "," + a.raw[e]), b[f + c] = a.raw[e], d = !0, f++);
    }
    return b;
  };
  this.getConditionTypes = function() {
    ...
    for (var c = 0, f = !0;1 == f;) {
      var f = !1, e = "study_condition_type" + (c + 1);
      null != a.raw[e] && (a.ctatdebug("Adding: " + e + "," + a.raw[e]), d[c + b] = a.raw[e], f = !0, c++);
    }
    return d;
  };
  this.getConditionDescriptions = function() {
    ...
    for (var f = 0, d = !0;1 == d;) {
      var d = !1, e = "study_condition_description" + (f + 1);
      null != a.raw[e] && (a.ctatdebug("Adding: " + e + "," + a.raw[e]), c[f + b] = a.raw[e], d = !0, f++);
    }
    return c;
  };
  this.get = function(b) {
  ...
  this.setTutorDimensions = function(b, c, f) {
    a.raw.width = c;
    a.raw.height = f;
  };
  this.setTutorValue = function(b, c, f) {
    a.raw[c] = f;
  };
...
var CTATJumble = function(a, b, e, f, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATJumble", "aJumble", a, b, e, f, d);
  var c = "", g = "center", h = 0, k = 10, l = !1, p = this;
  p.setActionInput("SetOrder", c);
  var n = null;
  this.init = function() {
    p.setInitialized(!0);
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var c = a.length, g = 0;g < c;g++) {
        ...
        f.addEventListener("dragstart", u, !1);
        f.addEventListener("dragenter", w, !1);
        f.addEventListener("dragover", r, !1);
        f.addEventListener("dragleave", x, !1);
        f.addEventListener("drop", t, !1);
  ...
  this.getOrder = function() {
    for (var a = n.children, b = [], g = 0;g < a.length;g++) {
      var f = a[g];
      f.draggable && (f.id ? b.push(f.id) : console.log("ERROR: The CTATJumble " + p.getName() + " has a child with no id attribute: " + f + "!!!"));
    }
    return c = b.join(";");
  };
  this.updateSAI = function() {
...
var CTATConnection = function(a) {
  ...
  var b = null, e = null, f = !1, d = this, c = "text/plain";
  ...
  this.createHTTPObject = function() {
    ...
    if (window.XMLHttpRequest) {
      d.ctatdebug("Creating regular XMLHttpRequest ..."), e = new XMLHttpRequest, e.overrideMimeType && e.overrideMimeType("text/html");
    } else {
      if (d.ctatdebug("Trying alternative HTTP object creation ..."), window.ActiveXObject) {
        d.ctatdebug("Detected window.ActiveXObject ...");
        try {
          d.ctatdebug("Creating Msxml2.XMLHTTP ..."), e = new ActiveXObject("Msxml2.XMLHTTP");
        } catch (a) {
          try {
            d.ctatdebug("Creating Microsoft.XMLHTTP ..."), e = new ActiveXObject("Microsoft.XMLHTTP");
          } catch (b) {
...
var CTATGraphicsTools = function(a, b, e, f, d, c) {
  CTATBase.call(this, "CTATGraphicsTools", "__undefined__");
  var g = b || 1, h = e || "#000000", k = f || "#EEEEEE", l = d || !1, p = "Arial", n = a || null;
  a = c || !1;
  var m = 0, u = this;
  if (null == n) {
  ...
  this.drawLine = function(a, b, c, g, f, d) {
  ...
  this.drawRectangle = function(a, b, c, f) {
    ...
    b += m;
    n.lineWidth = g;
    1 == l ? (n.fillStyle = k, n.fillRect(a, b, c, f)) : (n.strokeStyle = h, n.beginPath(), n.rect(a, b, c, f), n.stroke());
  };
  ...
  this.drawRoundedRect = function(a, b, c, f, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = g, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + c - d, b + f), n.quadraticCurveTo(a + c, b + f, a + c, b + f - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, c, f, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = g, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + c - d, b + f), n.quadraticCurveTo(a + c, b + f, a + c, b + f - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke(), n.fillStyle = k, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + 
  ...
  this.drawTextFormatted = function(a, b, c, g, f, d, e, k, h, l) {
    if (null != n) {
      a += m;
      b += m;
      g = "";
      ...
      g += "12pt " + p;
      try {
        n.fillStyle = d, n.font = g, n.fillText(c, a, b);
      } catch (u) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTriangle = function(a, b, c, f, d, e) {
  ...
  this.drawTriangleFilled = function(a, b, c, f, d, e) {
  ...
  this.clearCanvas = function(a, b, c, g) {
    "ctat" == CTATConfig.platform && n.clearRect(a, b, c, g);
  };
};
CTATGraphicsTools.prototype = Object.create(CTATBase.prototype);
CTATGraphicsTools.prototype.constructor = CTATGraphicsTools;
var CTATShape = function(a, b, e, f, d, c) {
  var g = this;
  if (void 0 == a || null == a) {
    return g.ctatdebug("--- Error: Must pass a valid ID. ---"), null;
  }
  var h = [], k = [], l = d, p = c, n = b, m = void 0, u = "black", r = "black", w = "Arial", x = 12, t = [], B = 1, C = 5, G = document.createElement("canvas");
  G.id = n;
  G.width = l;
  G.height = p;
  var D = new CTATCSS;
  D.addCSSAttribute("position", "absolute");
  D.addCSSAttribute("left", e + "px");
  ...
  G.setAttribute("style", D.toCSSString());
  getSafeElementById(a).appendChild(G);
  var z = new CTATGraphicsTools(G.getContext("2d"));
  z.setGraphicBorderWidth(B);
  z.setLineColor(u);
  z.setFillColor(r);
  ...
  this.setYPoints = function(a) {
    k = a;
    D.modifyCSSAttribute("top", k[0] + "px");
    G.setAttribute("style", D.toCSSString());
  };
  ...
  this.shapeMagicTrigFunctionX = function(a) {
    z.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    z.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    z.drawLine(h[0] + B, k[0] + B, h[1], k[1], u, B);
  };
  this.drawCircle = function() {
    z.drawCircle(h[0] + C, k[0] + C, C);
  };
  this.drawCircleFilled = function() {
    z.drawCircleFilled(h[0] + C, k[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, c, g) {
    z.drawRectangle(a[0] + B, b[0] + B, l - B, p - B);
  };
  this.drawRectangleFilled = function() {
    z.drawRectangleFilled(h[0], k[0], l, p);
  };
  this.drawRoundedRect = function() {
    z.drawRoundedRect(h[0] + B, k[0] + B, l - C - B, p - C - B, C);
  };
  this.drawRoundedRectFilled = function() {
    z.drawRoundedRectFilled(h[0] + B, k[0] + B, l - C - B, p - C - B, C);
  };
  this.drawText = function() {
    z.drawText(x / 2, x / 2, m);
  };
  this.drawTriangle = function() {
    z.drawTriangle(h[0] + B, k[0] + B, h[1], k[1], h[2], k[2]);
  };
  this.drawTriangleFilled = function() {
    z.drawTriangleFilled(h[0], k[0], h[1], k[1], h[2], k[2]);
  };
  this.save = function() {
    z.save();
  };
  ...
  this.erase = function() {
    ...
    for (var b = 0;b < t.length;b++) {
      G.addEventListener(t[b][0], t[b][1]);
    }
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == g && (g = !1, getSafeElementById(ctatcontainer).removeChild(u)) : 1 == warnScrim && (g = !0), w.scrimUp(a));
  }
  function e(a, b) {
  ...
  var f = "", d = !1, c = !1, g = !1, h = null, k = null, l = new CTATCanvasComponent("CTAT Scrim"), p = [], n = null, m = null, u = null, r = null, w = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (w.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), w.ctatdebug("Message: " + b), 1 == scrimIsUp ? (f = 1 == waitScrim ? b : f + (" \n " + b), l.removeComponent()) : (f = b, scrimIsUp = !0), w.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        w.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + f + "<br><br></div></div></div>"), !0 === g && (u = e(a, "close"), $(u).appendTo("#scrimpanel")), !0 === d && (n = e(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (m = e(k, "no"), $(m).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
          ...
          try {
            ...
            (r instanceof ReferenceError || r instanceof TypeError) && w.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', r, typeof r);
          }
        }
      }
    }
  ...
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = d = g = warnScrim = errorScrim = !1, w.scrimUp(a), r = e(b, "OK"), $(r).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, g) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("confirmScrimUp (" + a + "," + b + "," + g + ")"), c = d = !0, k = g, h = b, w.scrimUp(a));
  };
...
var CTATWSConnection = function(a) {
  ...
  var b = "", e = !1, f = this, d = null, c = [], g = !1, h = 0, k = 0, l = null, p = null;
  f.setSocketType("ws");
  this.setConsumed = function(a) {
    e = a;
    f.ctatdebug("consumed: " + e);
  };
  this.getConsumed = function() {
    f.ctatdebug("consumed: " + e);
    return e;
  ...
  this.send = function() {
    f.ctatdebug("send ()");
    f.init();
    !1 === g ? (f.ctatdebug("Connection not ready yet, storing ..."), c.push(b)) : (f.ctatdebug("Connection ready, sending data ..."), h = (new Date).getTime(), d.send(b));
  };
};
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var e = authenticityToken = "", f = 0, d = [], c = a ? a : null, g = null == b ? !0 : b, h = !0, k = null, l = this, p = "http";
  ...
  this.send_post_variables = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var g = l.createConnection(CTATConfiguration.getRawFlashVars(), a);
  ...
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var c = flashVars.getRawFlashVars(), g = a;
      "websocket" == l.getSocketType() ? (g = a.replace("http:", "ws:"), c = l.createConnection(c, g), c.setData(b), l.ctatdebug(b)) : (c = l.createConnection(c, g), c.setData(b));
  ...
  this.processReply = function(a) {
    ...
    for (var e = 0, e = 0;e < d.length;e++) {
      var h = d[e], p = h.getHTTPObject();
      l.ctatdebug("Testing connection entry " + e + ", readyState: " + p.readyState + ", testConnection.consumed: " + h.getConsumed());
      4 == p.readyState && 0 == h.getConsumed() ? (l.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), f = !1, 0 === p.status && (f = !0, l.ctatdebug("Received message (status 0): " + p.responseText)), 408 == p.status && (f = !0, l.ctatdebug("Received message (status 408): " + p.responseText), g && CTATScrim.scrim.scrimDown()), 502 == p.status && (f = !0, l.ctatdebug("Received message (status 502): " + p.responseText), g && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == p.status ? (f = !0, l.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != k && k.processIncoming(p.responseText)) : l.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (f = !0, l.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, p.responseText)), !1 === f && l.ctatdebug("Error: status not handled for: " + p.status), l.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : 
      (0 === p.readyState && l.ctatdebug("Received message (status 0, request not initialized)"), 1 === p.readyState && l.ctatdebug("Received message (status 1, server connection established)"), 2 === p.readyState && l.ctatdebug("Received message (status 2, request received)"), 3 === p.readyState && l.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    l.cleanup();
    for (b = 0;b < a.length;b++) {
      f = a[b], -1 != f.indexOf("status=success") ? l.ctatdebug("Info: logging success message received, not propagating to message handler") : (l.ctatdebug("Processing incoming message: " + f), c.processMessage(f));
    }
  };
  ...
  this.checkEntries = function() {
    ...
    for (var a = 0, b = 0, b = 0;b < d.length;b++) {
      ...
      l.ctatdebug("Check, readyState: " + g.readyState + ", consumed: " + c.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, c) {
    ...
    g.onreadystatechange = function() {
      l.ctatdebug("onready... GET for xmlFile xmlhttp.readyState " + g.readyState + ", .status " + g.status + ", parser " + b);
      if (4 == g.readyState && 200 == g.status) {
        var f = null;
        g.responseXML ? (l.ctatdebug("parsing brd xml using something else"), f = g.responseXML.documentElement) : (l.ctatdebug("parsing brd xml using node"), f = (b = new CTATXML).parseXML(g.responseText));
        null == f ? (f = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), l.ctatdebug("Error parsing xmlFile " + a + ": " + f), CTAT.ToolTutor.sendToInterface(f, !0)) : c.processXML(f);
      }
    };
    g.onerror = function() {
      var a = (new CTATTutorMessageBuilder).createErrorMessage("Load Problem Error", g.status + " " + g.statusText);
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    var b = CTATConfiguration.getRawFlashVars(), e;
    ...
    e = e + ("<log_to_remote_server>" + f + "</log_to_remote_server><log_to_disk>" + d + "</log_to_disk>") + ("<log_to_disk_directory>" + b.log_to_disk_directory + "</log_to_disk_directory>");
  ...
  this.createAssociatedRulesMessage = function(a, b, e, f, d, c) {
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    var e = flashVars.getDatasetNames();
    a.ctatdebug("Check: " + b.length + ", " + e.length);
    if (null != b && null != e) {
      ...
      for (var d = "<dataset>" + ("<name>" + c.dataset_name + "</name>"), k = 0;k < b.length;k++) {
        a.ctatdebug("Adding ..."), d += '<level type="' + b[k] + '">', d += "<name>" + e[k] + "</name>";
      }
      d += "<problem ";
    ...
    e = flashVars.getConditionDescriptions();
    if (0 < b.length) {
      for (k = 0;k < b.length;k++) {
        c += "<condition><name>" + b[k] + "</name>", c += "" == d[k] ? "" : "<type>" + d[k] + "</type>", c += "" == e[k] ? "" : "<desc>" + e[k] + "</desc>", c += "</condition>";
      }
    }
  ...
  this.createSemanticEventToolMessage = function(f, d, c, g, h) {
  ...
  this.createTutorMessage = function(f, d, c, g, h, k, l, p) {
    ...
    f = "<action_evaluation ";
    g.hasClassification() && null != g.getAttributeString() && (f += g.getAttributeString());
    f += ">" + g.getEvaluation() + "</action_evaluation>";
    m += f;
    "" != h && (m += "<tutor_advice>" + h + "</tutor_advice>");
    null != l && (a.ctatdebug("Adding skills to log message ..."), m += l.toLogString());
    m += this.createCustomFields(b, e);
    m += "</tutor_message>";
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, f) {
    ...
    var c = this.getA1Row(d[0]), g = this.getA1Col(d[0]), h = this.getA1Row(d[1]), k = this.getA1Col(d[1]);
  ...
  this.translateFromCTAT = function(e, f) {
    if (!0 === a) {
      return e;
    }
    var d = e.toLowerCase();
    ...
    var c = 0, g = 0, g = "";
    if (-1 != d.indexOf(".r")) {
      var h = d.split("."), c = h[1].split("r");
      0 >= c.length && (c = h[1].split("c"));
      if (0 >= c.length) {
        b.ctatdebug("Info: incoming name does not need translation");
      } else {
        return g = c[1], c = c[0].substr(1), b.ctatdebug("Original row (1st format): " + c + " original col: " + g), g = !0 === f ? colName(g, !1) + c : h[0] + "." + colName(g, !1) + c, b.ctatdebug("Translated: " + g), g;
      }
    } else {
      if (0 === d.indexOf("r")) {
        var h = d.indexOf("c"), k = parseInt(d.substr(1, h - 1)), d = parseInt(d.substr(h + 1)), c = k + 1, g = d;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + k + " -> " + c + ", original col: " + d + " -> " + g);
        g = colName(g, !1) + c;
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, e = !0, f = !1, d = !1, c = [], g = "undefined", h = "undefined", k = "undefined", l = "undefined", p = "undefined", n = "undefined", m = "undefined", u = "undefined", r = "UnassignedDataset", w = "UnassignedLevelName", x = "UnassignedLevelType", u = (new CTATGuid).guid();
  ...
  this.logSemanticEvent = function(a, c, g, d, f, e) {
    b.ctatdebug("logSemanticEvent ()");
    b.initCheck();
    var k = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(f, e);
    commLogMessageBuilder.addCustomField("tool_event_time", commLogMessageBuilder.formatTimeStamp(k) + " UTC");
    a = commLogMessageBuilder.createSemanticEventToolMessage(c, a, g, d, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, c, g, d, f, e, k, h, p) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var l = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(h, p);
    ...
    h = "";
    void 0 != e && null != e ? h = "<![CDATA[" + CTATGlobals.languageManager.filterString(e) + "]]\x3e" : (b.ctatdebug("No feedback provided, using empty string"), h = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(c, a, g, f, h, d, k, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATMessageHandler = function() {
  ...
  var a = null, b = this, e = [], f = null, d = 0, f = CTATConfig.parserType_is_XML() ? new CTATXML : new CTATJSON;
  ...
  this.processSingleMessage = function(c) {
    ...
    for (var k = 0;k < c.length;k++) {
      ...
      if ("properties" == f.getElementName(l)) {
        ...
        for (var p = f.getElementChildren(l), n = 0;n < p.length;n++) {
          var m = p[n];
          if ("MessageType" == f.getElementName(m)) {
            ...
            "StartProblem" == m && (b.ctatdebug("Setting inStartState to true"), inStartState = !0, this.processStartProblem(p), commShell.propagateShellEvent("StartProblem", h));
            "InterfaceIdentification" == m && (this.processInterfaceIdentification(p), commShell.propagateShellEvent("InterfaceIdentification", h));
            "InterfaceDescription" == m && (this.processInterfaceDescription(p), commShell.propagateShellEvent("InterfaceDescription", h));
            ...
            "CorrectAction" == m && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? e.push(h) : a.processCorrectAction(h), commShell.propagateShellEvent("CorrectAction", h));
            "InCorrectAction" == m && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? e.push(h) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(h)), commShell.propagateShellEvent("InCorrectAction", h));
            ...
            if ("AssociatedRules" == m) {
              ...
              for (var u = "", r = "", w = 0;w < p.length;w++) {
                var x = p[w];
                "TutorAdvice" == f.getElementName(x) && (u = f.getNodeTextValue(x));
                "Actor" == f.getElementName(x) && f.getNodeTextValue(x);
                "Indicator" == f.getElementName(x) && (r = f.getNodeTextValue(x));
                "StepID" == f.getElementName(x) && f.getNodeTextValue(x);
                "LogAsResult" == f.getElementName(x) && f.getNodeTextValue(x);
                "tool_selection" == f.getElementName(x) && f.getNodeTextValue(x);
                "Skills" == f.getElementName(x) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(x));
              }
              a.processAssociatedRules(h, r, u);
            ...
            "InterfaceAction" == m && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), e.push(h)) : a.processInterfaceAction(h), commShell.propagateShellEvent("InterfaceAction", h));
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (w = 0;w < p.length;w++) {
                if (x = p[w], "HintsMessage" == f.getElementName(x)) {
                  for (var x = f.getElementChildren(x), t = 0;t < x.length;t++) {
                    var B = x[t];
                    "value" == f.getElementName(B) && (r.push(f.getNodeTextValue(B)), u = !0);
                  }
                }
              }
              !0 === u ? a.processHintResponse(h, r) : b.ctatdebug("Error: incomplete hint message received");
            ...
            "VersionInfo" == m && (b.ctatdebug("Found: VersionInfo"), a.processVersionInfo(p), commShell.propagateShellEvent("ConfirmDone", h));
            "TutoringServiceAlert" == m && (b.ctatdebug("Found: TutoringServiceAlert"), a.processTutoringServiceAlert(p), commShell.propagateShellEvent("TutoringServiceAlert", h));
            "TutoringServiceError" == m && (b.ctatdebug("Found: TutoringServiceError"), a.processTutoringServiceError(p), commShell.propagateShellEvent("TutoringServiceError", h));
            ...
            "InterfaceReboot" == m && (m = "AUTHORING" == CTATTarget ? location.href : null, b.ctatdebug("Found: InterfaceReboot -- href " + m), m && 1 < ++d && location.replace(m));
          }
        }
      }
    }
    ...
    if (void 0 === c || null === c) {
      ...
      if (b.ctatdebug("Processing node: " + c.nodeName), null === f.getElementChildren(c)) {
        ...
        for (var d = 0;d < c.length;d++) {
          var e = c[d];
          b.ctatdebug("State graph attribute: " + f.getElementName(e));
          "caseInsensitive" == f.getElementName(e) && (caseInsensitive = "false" == f.getNodeTextValue(e) ? !1 : !0);
          "unordered" == f.getElementName(e) && (unordered = "false" == f.getNodeTextValue(e) ? !1 : !0);
          "lockWidget" == f.getElementName(e) && (lockWidget = "false" == f.getNodeTextValue(e) ? !1 : !0);
          "suppressStudentFeedback" == f.getElementName(e) && ("false" == f.getNodeTextValue(e) ? CTATGlobals.suppressStudentFeedback = !1 : CTATGlobals.suppressStudentFeedback = !0);
          "highlightRightSelection" == f.getElementName(e) && (highlightRightSelection = "false" == f.getNodeTextValue(e) ? !1 : !0);
          "confirmDone" == f.getElementName(e) && (b.ctatdebug("Confirm done: " + f.getNodeTextValue(e)), "true" == f.getNodeTextValue(e) ? CTATGlobals.confirmDone = !0 : CTATGlobals.confirmDone = !1);
          "Skills" == f.getElementName(e) && (null === skillSet && (skillSet = new CTATSkillSet), skillSet.parseByValue(e), a.updateSkillWindow());
        }
      }
    }
  };
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", d = "Unknown", e = null, p = 0;p < a.length;p++) {
      var n = a[p];
      ...
      if ("serialized" == f.getElementName(n)) {
        ...
        for (var m = f.getElementChildren(n), u = 0;u < m.length;u++) {
          var r = m[u];
          -1 != f.getElementName(r).indexOf("CTAT") && (e = r);
        }
      }
    ...
    null !== e ? this.deserializeComponent(c, d, e) : b.ctatdebug("Error: unable to find CTAT serialization point of attachement");
  ...
  this.deserializeComponent = function(a, c, d) {
    ...
    if (1 == ignoreInterfaceDescriptions) {
      ...
      if (null === f.getElementAttr(d, "x")) {
        ...
        var e = f.getElementAttr(d, "x"), p = f.getElementAttr(d, "y"), n = f.getElementAttr(d, "width"), m = f.getElementAttr(d, "height"), u = f.getElementAttr(d, "tabIndex"), r = f.getElementAttr(d, "zIndex");
        null === u && (u = -1);
        null === r && (r = 0);
        ...
        for (e = 0;e < d.length;e++) {
          ...
          if ("Parameters" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component parameters ..."), n = f.getElementChildren(p)[0], n = f.getElementChildren(n), m = 0;m < n.length;m++) {
              var x = n[m];
              if ("CTATComponentParameter" == f.getElementName(x)) {
                this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
                for (var r = u = void 0, x = f.getElementChildren(x), t = 0;t < x.length;t++) {
                  var B = x[t];
                  "name" == f.getElementName(B) && (this.ctatdebug("Found parameter name: " + f.getNodeTextValue(B)), u = f.getNodeTextValue(B));
                  "value" == f.getElementName(B) && (this.ctatdebug("Found parameter value: " + f.getNodeTextValue(B)), r = f.getNodeTextValue(B).trim());
                }
                this.ctatdebug("Parameter name: " + u + ", value: " + r);
                void 0 !== u && (w.params[u] = r, "group" == u && (w.groupName = r));
              }
            }
          }
          if ("Styles" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component styles ..."), p = f.getElementChildren(p)[0], p = f.getElementChildren(p), n = 0;n < p.length;n++) {
              if (r = p[n], "CTATStyleProperty" == f.getElementName(r)) {
                this.ctatdebug("Processing style property (CTATStyleProperty) ...");
                u = m = "";
                r = f.getElementChildren(r);
                for (x = 0;x < r.length;x++) {
                  t = r[x], "name" == f.getElementName(t) && (m = f.getNodeTextValue(t)), "value" == f.getElementName(t) && (u = f.getNodeTextValue(t).trim());
                }
                this.ctatdebug("Style (name: " + m + ", value: " + u + ")");
                "" !== m && (w.styles[m] = u);
              }
            }
          }
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, e, f, d, c) {
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, e, f, d, c, g, h) {
...
CTATTutorMessageBuilder.prototype.isDoneStep = function(a, b) {
  ...
  var d = "done" == f;
  this.ctatdebug("isDoneStep() indicatorObj " + e + ", selectionObj " + f + ", correct[0] " + b[0] + ", result " + d);
  return d;
};
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, e, f) {
  e = "<message><verb>SendNoteProperty</verb><properties><MessageType>ShowHintsMessage</MessageType><HintsMessage>";
  for (var d = 0;d < a.length;d++) {
    e += "<value><![CDATA[" + a[d] + "]]\x3e</value>";
  }
  e = e + "</HintsMessage>" + b.toXMLString();
  e += "<transaction_id>" + f + "</transaction_id>";
  return e += "</properties></message>";
};
...
CTATTutorMessageBuilder.prototype.createStateGraphMessage = function(a, b, e, f, d, c, g) {
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, e, f) {
...
CTATLMS.init.OLI = function() {
  ...
  var a = function() {
    return {activityContextGuid:CTATConfiguration.get("activity_context_guid"), activityGuid:CTATConfiguration.get("activity_guid"), userGuid:CTATConfiguration.get("user_guid"), authenticationToken:CTATConfiguration.get("auth_token"), resourceTypeID:CTATConfiguration.get("resource_type_id"), activityMode:CTATConfiguration.get("activity_mode")};
  };
  CTATLMS.saveProblemState = function(b) {
    var e = a();
    e.commandName = "writeFileRecord";
    e.attemptNumber = CTATConfiguration.get("current_attempt");
    e.fileName = CTAT.ToolTutor.tutor.getQuestionFile();
    e.mimeType = "text/xml";
    e.byteEncoding = "urlencoded";
    e.fileRecordData = encodeURIComponent(b.problem_state);
    $.post(CTATConfiguration.get("superactivity_url"), e, null, "application/x-www-form-urlencoded");
  };
  CTATLMS.getProblemState = function(b) {
    ...
    e.attemptNumber = CTATConfiguration.get("current_attempt");
    e.fileName = CTAT.ToolTutor.tutor.getQuestionFile();
    $.post(CTATConfiguration.get("superactivity_url"), e, null, "text").done(function(a) {
      b(a);
    });
  };
  CTATLMS.gradeStudent = function(b, e) {
    var f = !1, d = 0;
    0 >= e ? (d = 100, f = !0) : (d = Math.round(100 * b / e), f = b >= e);
    var c = a();
    c.commandName = "scoreAttempt";
    c.scoreId = "percentScore";
    c.scoreValue = d;
    $.post(CTATConfiguration.get("superactivity_url"), c, null, "application/x-www-form-urlencoded");
    c.scoreId = "completed";
    c.scoreValue = f;
    $.post(CTATConfiguration.get("superactivity_url"), c, null, "application/x-www-form-urlencoded");
  };
...
CTATLMS.init.TutorShop = function() {
  ...
  CTATLMS.getProblemState = function(a) {
    CTATConfiguration.get("restoreProblemUrl") ? $.get(CTATConfiguration.get("restoreProblemUrl"), "", null, "text").done(function(b) {
      ...
      a(null);
      b = (new CTATTutorMessageBuilder).createErrorMessage("Load ProblemState Error", e + " " + f);
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, e = null, f = null, d = {}, c = null, g = null, h = null, k = null, l = [], f = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.processCorrectAction = function(a) {
    ...
    if (d[g] && null != c) {
      ...
      var f = CTATShellTools.findComponent(g);
      if (null != f) {
        for (ctatdebug("Processing " + f.length + " components ..."), g = 0;g < f.length;g++) {
          ctatdebug("Check " + f[g].getName()), f[g] ? f[g].setCorrect && f[g].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
      } else {
    ...
    if (d[g] && null != c) {
      ...
      if (null != f) {
        for (g = 0;g < f.length;g++) {
          ctatdebug("Calling setIncorrect on component (" + f[g].getClassName() + ")..."), f[g].setIncorrect && f[g].setIncorrect(a);
        }
      } else {
        b.ctatdebug("Error: component is null for selection " + g);
      }
  ...
  this.processAssociatedRules = function(a, c, g) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      "Hint" == c || "HintWindow" == c ? (ctatdebug("Preparing log message to indicate a hint response", "commShell"), f.setCurrentHintNumber(hintIndex + 1), f.setTotalHintsAvailable(hints.length), f.setEvaluation("HINT"), d = "HINT_MSG", hints[hintIndex] && (g = hints[hintIndex])) : ("Correct" == a.getIndicator() ? f.setEvaluation("CORRECT") : f.setEvaluation("INCORRECT"), d = "RESULT");
      ctatdebug("Adding custom field names ...");
      c = [];
      var e = [];
      c.push("step_id");
      e.push(a.getProperty("StepID"));
      var k = a.getSkillsObject();
      b.updateSkillWindow(k);
      ctatdebug("Sending log message ...");
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, d, "", f, g, k, c, e) : this.ctatdebug("Info: no logging library available!");
  ...
  this.processTutoringServiceError = function(a) {
    ...
    for (var c = "", g = "", d = 0;d < a.length;d++) {
      var e = a[d];
      "ErrorType" == f.getElementName(e) && (c = f.getNodeTextValue(e));
      "Details" == f.getElementName(e) && (g = f.getNodeTextValue(e));
    }
    CTATScrim.scrim.scrimDown();
  ...
  this.processProblemSummaryResponse = function(a) {
    ...
    if (null != h) {
      var c = a.getXMLObject(), g = c.getElementsByTagName("ProblemSummary"), d = c.getElementsByTagName("cmi.core.lesson_status"), f = c.getElementsByTagName("cmi.core.score.raw");
...
var CTATProblem = function() {
  ...
  var a = "", b = "", e = "tutor", f = "", d = "", c = "notstarted";
  ...
  this.init = function(d) {
    ...
    if (null == d) {
      ...
      for (var c = 0;c < d.length;c++) {
        var g = d[c], f = b.getElementName(g);
        a.ctatdebug("Examining element: " + b.getElementName(g));
        if ("Problems" == f) {
          a.ctatdebug("Processing Problems ...");
          for (var g = b.getElementChildren(g), k = 0;k < g.length;k++) {
            var l = g[k];
            a.ctatdebug("Problem [" + k + "] desc: " + b.getElementAttr(l, "description") + ", interface: " + b.getElementAttr(l, "student_interface") + ", brd: " + b.getElementAttr(l, "problem_file"));
            var p = new CTATProblem;
            p.setName(b.getElementAttr(l, "name"));
            p.setLabel(b.getElementAttr(l, "label"));
            p.setDescription(b.getElementAttr(l, "description"));
            p.setTutorFlag(b.getElementAttr(l, "tutor_flag"));
            p.setProblemFile(b.getElementAttr(l, "problem_file"));
            p.setStudentInterface(b.getElementAttr(l, "student_interface"));
...
var CTATScrollPaneComponent = function(a, b, e, f, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATScrollPaneComponent", "__undefined__", a, b, e, f, d);
  var c = 0, g = this;
  g.isTabIndexable = !1;
      ...
      if ("TargetMovieClip" == a) {
        ...
        if (null !== c) {
          if (g.ctatdebug("Found target movieclip, temporarily removing ..."), null !== c.getDivWrapper().parentNode) {
            ...
            b++;
            var f = c.getDivWrapper().style.left, e = c.getDivWrapper().style.top;
            c.getDivWrapper().style.left = "0px";
            c.getDivWrapper().style.top = "0px";
            g.ctatdebug("Moving canvas from: " + f + "," + e + " to: 0,0");
...
var CTATHintButton = function(a, b, e, f, d) {
  CTAT.Component.Base.Clickable.call(this, "hint", "CTATHintButton", a, b, e, f, d);
  this.setName("hint");
...
var CTATButton = function(a, b, e, f, d) {
  CTATButtonBasedComponent.call(this, "CTATButton", "aButton", a, b, e, f, d);
  var c = this, g = null;
  this.init = function() {
...
var OLIDriver = function(a) {
  ...
  this.translateURL = function(a) {
    ...
    for (var c = flashVars.getRawFlashVars(), g = getIndicesOf("<img", a, !1), f = getIndicesOf("<a", a, !1), k = -1, l = k = -1, p = !1, n = "", k = "";!1 === p;) {
      p = !0;
      if (0 === g.length && 0 === f.length) {
        return e.ctatdebug("Nothing to do here, bump"), a;
      }
      g = getIndicesOf("<img", a, !1);
      for (f = 0;f < g.length;f++) {
        k = g[f], k = a.indexOf("src", k), -1 != k && (k += 5, l = a.indexOf('"', k), -1 != l && (n = a.substr(k, l - k), e.ctatdebug("We have a valid url (img) to replace between: " + k + "," + l + ", with content: " + n), -1 == n.indexOf("http:") ? (p = !1, n = c.web_content_url + b(currentOLIModule) + "/" + n, k = a.substr(0, k) + n + a.substr(l), e.ctatdebug("Replaced: " + k), a = k) : e.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      f = getIndicesOf("<a", a, !1);
      for (g = 0;g < f.length;g++) {
        k = f[g], k = a.indexOf("href", k), -1 != k && (k += 6, l = a.indexOf('"', k), -1 != l && (n = a.substr(k, l - k), e.ctatdebug("We have a valid url (href) to replace between: " + k + "," + l + ", with content: " + n), -1 == n.indexOf("http:") ? (p = !1, n = c.web_content_url + b(currentOLIModule) + "/" + n, k = a.substr(0, k) + n + a.substr(l), e.ctatdebug("Replaced: " + k), a = k) : e.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      g = getIndicesOf("<img", a, !1);
      f = getIndicesOf("<a", a, !1);
    }
  ...
  this.forwardToClientHandler = function(a) {
    e.ctatdebug("OLIDriver.forwardToClientHandler() handler is " + typeof f);
...
var currentOLIModule = "", OLIMessageHandler = function() {
  ...
  var a = null, b = "", e = new CTATXML, f = this, d = [];
  ...
  this.processError = function(c, g) {
    f.ctatdebug("OLIMessageHandler.processError(" + c + ", " + g + ")\n  from command " + b);
    if (a) {
      a.forwardToClientHandler(g);
    } else {
      switch(b) {
        case "startAttempt":
  ...
  this.processMessage = function(b) {
    ...
    if (null == g) {
      ...
      var d = e.getElementName(g);
      switch(d) {
        case "super_activity_client":
          f.parseClientConfig(g);
          break;
        case "super_activity_session":
          f.parseBeginSession(g);
          break;
        case "attempt_history":
          f.parseAttemptHistory(g);
          break;
        case "ctat":
          f.parseResourceFile(g, b);
          break;
        case "file_record":
          f.parseFileRecord(g);
          break;
        default:
          a ? a.forwardToClientHandler(b) : f.ctatdebug("Unknown xml recieved with root " + d);
      }
    }
  };
  this.parseClientConfig = function(b) {
    ...
    for (var d = null, k = 0;k < b.length;k++) {
      var l = b[k], p = e.getElementName(l);
      "resource_type" != p && "base" != p && ("authentication" == p && "review" != g.activity_mode ? g.user_guid = e.getElementAttr(l, "user_guid") : "logging" == p && (g.log_session_id = e.getElementAttr(l, "session_id"), g.source_id = e.getElementAttr(l, "source_id"), d = e.getElementChildren(l), d = e.getNodeTextValue(d[0])));
    }
    a.oliClientConfig(d);
  };
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == g) {
      ...
      var d = flashVars.getRawFlashVars(), k = b.getElementsByTagName("web_content")[0];
      d.web_content_url = e.getElementAttr(k, "href");
      g = e.getElementAttr(g, "guid");
      d.resource_file_id = g;
      if (k = b.getElementsByTagName("section")[0]) {
        d.class_name = e.getElementAttr(k, "admit_code"), d.class_description = e.getElementAttr(k, "title"), d.school_name = e.getElementAttr(k, "institution");
      }
      (k = b.getElementsByTagName("instructors")[0]) && (k = e.getElementChildren(k)) && (d.instructor = e.getElementAttr(k[0], "guid"));
      (k = b.getElementsByTagName("user")[0]) && "review" != d.activity_mode && (d.user_guid = e.getElementAttr(k, "guid"));
      if (k = b.getElementsByTagName("activity")[0]) {
        if (d.activity_guid = e.getElementAttr(k, "guid"), k = k.getElementsByTagName("item_info")[0]) {
      ...
      if (k = b.getElementsByTagName("file_record")[0]) {
        for (d.file_record_file_name = e.getElementAttr(k, "file_name"), k = e.getElementChildren(k), l = 0;l < k.length;l++) {
          var p = k[l];
          "record_context" == String(e.getElementName(p)).toLowerCase() && e.getElementAttr(p, "activity_guid") == d.activity_guid && (d.file_record_attempt = e.getElementAttr(p, "attempt")) && (d.problem_state_status = "incomplete");
        }
      }
  ...
  this.parseAttemptHistory = function(c) {
    ...
    "startAttempt" == b && a.oliBeganSession(c, g.resource_file_id);
  };
  this.setAttemptFromAttemptHistory = function(a, b) {
    f.ctatdebug("setAttemptFromAttemptHistory(" + a + ", " + b + ")");
    var d = flashVars.getRawFlashVars(), k = a ? a.getElementsByTagName("activity_attempt") : [], l = null;
    return 1 > k.length || !(l = k[k.length - 1]) ? (f.ctatdebug("can't find activity_attempt in attempt_history"), null != b ? d.current_attempt = b : "") : d.current_attempt = e.getElementAttr(l, "number");
  };
  this.parseResourceFile = function(a, b) {
    ...
    for (var h = e.getElementChildren(a), k = flashVars.getRawFlashVars(), l = 0;l < h.length;l++) {
      var p = h[l], n = e.getElementName(p);
      "interface" == n ? (p = e.getNodeTextValue(p), n = oliDriver.translateResourceFile(p), f.ctatdebug("Building BRD url from web_content_url: " + k.web_content_url + " and OLI-provided url: " + p + " = " + n), d.push(n)) : "title" == n && (k.problem_name = e.getNodeTextValue(p));
    }
    oliComm.BRDAvailable(d, b);
  };
  this.parseFileRecord = function(a) {
    f.ctatdebug("parseFileRecord()");
    var b = Number(e.getElementAttr(a, "date_created")), d = e.getElementAttr(a, "file_size");
    a = e.getElementAttr(a, "file_name");
    console.log("OLI writeFileRecord at", isNaN(b) ? null : new Date(b), "wrote", a, ", size", d);
  };
};
...
var CTATSequencer = function() {
  ...
  var a = this, b = new CTATPackage, e = new CTATXML, f = null, d = "sequential", c = null;
  ...
  this.handlePackageRetrieval = function(g) {
    a.ctatdebug("handlePackageRetrieval ()");
    b.init(g);
    null != c && c();
  };
  this.processXML = function(g) {
...
var CTATComboBox = function(a, b, e, f, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATComboBox", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null;
...
CTAT.Component.Base.SVG = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Clickable.call(this, a, b, e, f, d, c, g);
  var h = null;
  ...
  this.getBoundingBox = function() {
    var a = new DOMRect(0, 0, this.getWidth(), this.getHeight()), b = this.getComponent(), c = window.getComputedStyle(b), b = parseInt(c.getPropertyValue("padding-left")), g = parseInt(c.getPropertyValue("padding-right")), d = parseInt(c.getPropertyValue("padding-bottom")), f = parseInt(c.getPropertyValue("padding-right")), e = parseInt(c.getPropertyValue("border-left-width")), h = parseInt(c.getPropertyValue("border-right-width")), x = parseInt(c.getPropertyValue("border-bottom-width")), c = parseInt(c.getPropertyValue("border-right-width"));
    a.width -= b + f + e + c;
    a.height -= g + d + h + x;
    return a;
  };
...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {numerator:{get:function() {
  ...
  if (1 == this.denominator) {
    ...
    var e = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mfrac"), f = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mrow");
    f.appendChild(b);
    e.appendChild(f);
...
CTAT.Component.Base.UnitDisplay = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.SVG.call(this, a, b, e, f, d, c, g);
  var h = "1/2+1/4+(0*1/8)";
  this.setActionInput("SetPieces", h);
  var k = "#FF00FF", l = 1, p = "#FF00FF", n = .2, m = "black", u = 1;
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = D(b), this.get_denominator() != a)) {
      ...
      a = [];
      c.set_denominator(b);
      for (var g = new CTAT.Math.Fraction(1, b), d = Math.floor(c.numerator), f = b - d, e = 0;e < d;e++) {
        a.push(C(g, !0));
      }
      b = new CTAT.Math.Fraction(c.numerator - d, b);
      b.equals(0) || (a.push(C(b, !0)), a.push(C(g.subtract(b), !1)), f--);
      for (b = 0;b < f;b++) {
        a.push(C(g, !1));
      }
  ...
  this.get_denominator = function() {
    return r.reduce(function(a, b, c, g) {
  ...
  var q = {numerator:{items:[], callback:a.bind(this, this.change_numerator, this.set_numerator)}, denominator:{items:[], callback:a.bind(this, this.change_denominator, this.set_denominator)}, partition:{items:[], callback:a.bind(this, this.change_number_pieces, this.set_number_pieces)}, value:{items:[], callback:function(a) {
    ...
    for (c in q) {
      a = q[c], a.items.forEach(b.bind(this, a.callback));
    }
  };
...
try {
  ...
  if (console.log("WARNING: new DOMPoint():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("   Using shim!"), DOMPoint = function(b, e, f, d) {
      ...
      if (b instanceof DOMPoint) {
        ...
        this.x = b || 0, this.y = e || 0, this.z = f || 0, this.w = d || 1;
      }
    };
  }
}
...
CTAT.Geom.Point.equals = function(a, b) {
  var e = !0, f;
  for (f in a) {
    if (f in b ? "w" != f && (e &= a[f] / a.w == b[f] / b.w) : e = !1, !e) {
      break;
    }
  }
  return e;
...
CTAT.Geom.Point.scale = function(a, b) {
  ...
  var e = new DOMPoint(a), f;
  for (f in e) {
    "w" != f && (e[f] = CTAT.Math.round(a[f] * b));
  }
  return e;
};
...
CTAT.Geom.Point.circle_intersection = function(a, b, e, f) {
  b = b.add(a.scale(-1)).normalize();
  var d = CTAT.Geom.Point.dot(b, e.add(a.scale(-1))), c = a.add(b.scale(d));
  e = CTAT.Geom.Point.distance(e, c);
  return e < f ? (f = Math.sqrt(f * f - e * e), [a.add(b.scale(d - f)), a.add(b.scale(d + f))]) : e == f ? [c] : [];
};
...
var CTATPieChart = function(a, b, e, f, d) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATPieChart", "aPieChart", a, b, e, f, d);
  var c = 3, g = 3, h = this, k, l, p, n = null, m = CTATGlobals.NameSpace.svg;
  this.init = function() {
    this.initSVG();
    ...
    n = document.createElementNS(m, "feOffset");
    ...
    0 < g && this.baseGroup.setAttributeNS(null, "filter", p);
    this.drawPieces();
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      var a = window.getComputedStyle(this.getComponent()), a = parseFloat(a.getPropertyValue("stroke-width")), b = this.getBoundingBox(), d = Math.min(b.width / 2, b.height / 2) - (a + g + 4), f = new DOMPoint(b.width / 2, b.height / 2), a = this.parseValue(), e = document.createDocumentFragment();
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(m, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = f.x, g.cy.baseVal.value = f.y, g.r.baseVal.value = d, this.addPieceElem(g, b, b.selected), e.appendChild(g);
        } else {
          g = document.createElementNS(m, "path");
          ...
          b.reduce();
          var p = f.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + l)), u = f.clone();
          if (0 < c && c < d) {
            ...
            k = CTAT.Geom.Point.circle_intersection(u, k, f, d).reduce(n.bind(this, k));
            p = p.add(l);
            p = CTAT.Geom.Point.circle_intersection(u, p, f, d).reduce(n.bind(this, p));
          }
          l = CTAT.Geom.Point.to2DString;
          u = "M " + l(u);
          n = new DOMPoint(d, d);
          u += " L " + l(k);
          u += " A " + l(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(p);
  ...
  this.setDropShadowDistance = function(a) {
    g = parseInt(a);
    g = isNaN(g) ? 0 : g;
    n && (n.setAttributeNS(null, "dx", g), n.setAttributeNS(null, "dy", g), 0 >= g && this.baseGroup ? this.baseGroup.removeAttributeNS(null, "filter") : this.baseGroup.hasAttributeNS(null, "filter") || this.baseGroup.setAttributeNS(null, "filter", p));
  };
...
var CTATSubmitButton = function(a, b, e, f, d) {
  CTATButton.call(this, a, b, e, f, d);
...
var CTATGroupingComponent = function(a, b, e, f, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATGroupingComponent", "__undefined__", a, b, e, f, d);
  var c = this;
  c.isTabIndexable = !1;
  var g = null;
  this.init = function() {
...
var CTATSkillWindow = function(a, b, e, f, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATSkillWindow", "__undefined__", a, b, e, f, d);
    ...
    if (null === skillSet) {
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), g = 0;g < a.length;g++) {
            var d = a[g];
            c.ctatdebug("Drawing skill " + g + " " + d.getDisplayName() + " level: " + d.getLevel() + " ...");
            var f = document.createElement("div");
            f.classList.add("CTAT-skill-window--bar");
            var e = document.createElement("div"), r = d.getLevel();
            .95 > r ? e.classList.add("CTAT-skill-window--bar--nonmastered") : e.classList.add("CTAT-skill-window--bar--mastery");
            e.style.width = .95 < r ? "100%" : 100 * r + "%";
            f.appendChild(e);
            b.appendChild(f);
...
var CTATDoneButton = function(a, b, e, f, d) {
  CTAT.Component.Base.Clickable.call(this, "done", "CTATDoneButton", a, b, e, f, d);
  this.setName("done");
...
var CTATPlayButton = function() {
  ...
  var f = null, d = null, c = null, g = null, h = null;
  (function() {
  ...
  (function() {
    ...
    d = new CTATShape("PlayTutor", "play circle", h.width / 2 - k, h.height / 2 - k, 2 * k, 2 * k);
    d.addPoint(0, 0);
    d.setFillColor("green");
    d.setRadius(k);
    d.drawCircleFilled();
...
var CTATMobileTutorHandler = function(a, b) {
  ...
  this.processTextFocus = function(a, b, h, k, l) {
    ...
    "disabled" == f || "auto" == f && 0 == d || (e = "", this.manipulateKeyboard());
  };
...
function processTextFocus(a, b, e, f, d) {
  mobileAPI.processTextFocus(a, b, e, f, d);
}
function processFocusOut() {
  closeK();
}
;var CTATMovieClip = function(a, b, e, f, d) {
  ...
  this.wrapComponent = function(a) {
    ...
    p.setAttribute("style", "border: 0px; position: absolute; left:" + b + "px; top:" + e + "px; z-index:" + h + ";");
    a.appendChild(p);
    return p;
  };
...
var CTATTextBasedComponent = function(a, b, e, f, d, c, g) {
  CTAT.Component.Base.Tutorable.call(this, a, b, e, f, d, c, g);
  var h = this, k = "", l = !0, p = 255, n = !0;
...
var CTATTextArea = function(a, b, e, f, d) {
  CTATTextBasedComponent.call(this, "CTATTextArea", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(100);
...
var CTATTable = function(a, b, e, f, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATTable", "__undefined__", a, b, e, f, d);
  var c = this;
  c.isTabIndexable = !1;
  var g = null, h = !1;
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = g.createTBody(), f = b;f < k;f++) {
      for (var b = a.insertRow(), e = 0;2 > e;e++) {
        d = b.insertCell(), d.classList.add("CTAT-gen-component");
      }
    }
    for (a = 0;a < g.rows.length;a++) {
      for (b = g.rows[a], d = 0;d < b.cells.length;d++) {
        var l = b.cells[d], x = c.getName() + ".R" + a + "C" + d;
        CTATShellTools.findComponent(x).forEach(function(a) {
...
var CTATAudioButton = function(a, b, e, f, d) {
  CTATButtonBasedComponent.call(this, "CTATAudioButton", "audiobutton", a, b, e, f, d);
  var c = this;
...
var CTATVideo = function(a, b, e, f, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATVideo", "__undefined__", a, b, e, f, d);
...
var CTATNumericStepper = function(a, b, e, f, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATNumericStepper", "__undefined__", a, b, e, f, d);
...
var CTATHintWindow = function(a, b, e, f, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATHintWindow", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(240);
  this.setDefaultHeight(140);
  var c = this;
  c.isTabIndexable = !1;
  var g = null, h = null, k = null, l = null, p = CTATGlobals.languageManager.getString("NEXT"), n = CTATGlobals.languageManager.getString("PREVIOUS"), m = null;
  ...
  this.init = function() {
    ...
    l.appendChild(h);
    m ? (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), k.innerHTML = m) : r ? (k = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), k.classList.add("CTAT-hint-window--next"), k.setAttributeNS(null, "viewBox", "0 0 82 20"), a = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), a.style.fill = "none", a.style.strokeWidth = "3px", a.style.strokeLinecap = "round", a.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), a.setAttributeNS(null, 
    "pointer-events", "none"), k.appendChild(a), p && (a = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), a.setAttributeNS(null, "pointer-events", "none"), a.textContent = p, a.setAttributeNS(null, "text-anchor", "middle"), a.setAttributeNS(null, "x", "34px"), a.setAttributeNS(null, "dominant-baseline", "middle"), a.setAttributeNS(null, "y", "50%"), k.appendChild(a))) : (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), a = document.createElement("span"), 
    a.style.fontWeight = "bold", a.style.marginRight = "6px", a.textContent = "\u25b6", p && (a.style.cssFloat = "right", k.appendChild(document.createTextNode(p))), k.appendChild(a));
...
var CTATControllerButton = function(a, b, e, f, d) {
  CTATImageButton.call(this, a, b, e, f, d);
...
var CTATTextInput = function(a, b, e, f, d) {
  CTATTextBasedComponent.call(this, "CTATTextInput", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null, h = null;
  this.ctatdebug(this.getClassName() + " (" + this.getX() + "," + this.getY() + "," + this.getWidth() + "," + this.getHeight() + ")");
...
var CTATDragNDrop = function() {
  ...
  var a = function(a) {
    ...
    var g = a(this.id);
    CTATDragNDrop.dragging[g] = {id:this.id, group:d, source:c};
  ...
  this.init = function() {
    ...
    if (!$(a).attr("name")) {
      var d = CTATDragNDrop.default_groupname;
      this.getComponentGroup() && (d = this.getComponentGroup());
      $(a).attr("name", d);
    }
    this.setComponent(a);
...
try {
  ...
  if (console.log("WARNING: new DOMRect():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("    Using shim!"), DOMRect = function(b, e, f, d) {
      this.x = b || 0;
      this.y = e || 0;
      this.width = f || 0;
      this.height = d || 0;
...
CTAT.Geom.Rectangle.contains = function(a, b, e) {
  ...
  if (b instanceof DOMPoint) {
    ...
    if (e instanceof DOMPoint) {
      d = f(a, e.x / e.w, e.y / e.w);
    } else {
      if ("number" == typeof e) {
        return f(a, b.x - e, b.y - e) & f(a, b.x + e, b.y + e);
      }
    }
...
CTAT.Geom.Rectangle.setTo = function(a, b, e, f, d) {
  a.x = b;
  a.y = e;
  a.width = f;
  a.height = d;
...
var CTATNumberLine = function(a, b, e, f, d) {
  CTAT.Component.Base.SVG.call(this, "CTATNumberLine", "aNumberLine", a, b, e, f, d);
  var c = CTAT.Math.Fraction, g = CTATGlobals.NameSpace.svg;
  a = function(a, b, d, f, e) {
    this.numberline = a;
    this.step = new c(b);
    this.size = d;
    this.origin = new c(0);
    this.tick_class = f ? f : null;
    this.label_class = e ? e : null;
    this.g = null;
  ...
  this.setPointSize = function(a) {
    n = Number(a);
    w && (w.setAttributeNS(null, "r", n), $(this._point_group).find("circle").each(function() {
      $(this).attr("r", n);
    }));
  };
  ...
  this.genTickmark = function(a, b, c) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var f = document.createElementNS(g, "line"), e = this.X_Axis.getPosition(a), h = CTAT.Geom.Point.polar(c / 2, this.theta + Math.PI / 2).add(e);
      c = CTAT.Geom.Point.polar(-c / 2, this.theta + Math.PI / 2).add(e);
      ...
      d.appendChild(f);
      if ("" !== b) {
        e = document.createElementNS(g, "text");
        e.classList.add("CTAT-number-line--tickmark-label");
        e.setAttributeNS(null, "text-anchor", "middle");
        d.appendChild(e);
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            e.appendChild(document.createTextNode(String(a.numerator))), e.setAttributeNS(null, "x", c.x), e.setAttributeNS(null, "y", c.y);
          } else {
            b = "" + String(a.numerator);
            h = "" + String(a.denominator);
            e.style.fontSize = "0.6em";
            e.setAttributeNS(null, "text-align", "center");
            ...
            e.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(c, !0));
          }
        } else {
          e.appendChild(document.createTextNode(b.toString())), d.appendChild(tlabel), e.setAttributeNS(null, "x", c.x), e.setAttributeNS(null, "y", c.y);
        }
        f.label = e;
      }
    }
  ...
  var u = function() {
  ...
  }.bind(this), r = 0, w = null, x = new DOMPoint(-30, -30), t = !1, B = function(a) {
    x.x = a.clientX;
    x.y = a.clientY;
  }, C = function(a) {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      m ? (a = y(a.clientX, a.clientY), b = a.location, a = a.data) : (a = D(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  var D = function(a, b) {
    ...
    var d = d.matrixTransform(c), g = $(this.component), c = d.x + parseInt(g.css("borderLeftWidth")) + parseInt(g.css("paddingLeft")) + parseInt(g.css("marginLeft")), d = d.y + parseInt(g.css("borderTopWidth")) + parseInt(g.css("paddingTop")) + parseInt(g.css("marginTop"));
    return new DOMPoint(this.svgPoint.x - c, this.svgPoint.y - d);
  }.bind(this), z = function(a, b) {
    return this.getProjectedPoint(D(a, b));
  }.bind(this.X_Axis), y = function(a, b) {
    for (var c = z(a, b), d = null, g = Number.POSITIVE_INFINITY, f, e, h = 0;h < this._tickmarks.length;h++) {
      f = this._tickmarks[h], e = c.distance(f.location), e < g && (d = f, g = e);
    }
    return d;
  }, q = function() {
    if (t && !0 === this.getEnabled()) {
      if (m) {
        ...
        w.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(z(x.x, x.y), !0));
      }
...
function tableCreate() {
  ...
  for (var e = 0;3 > e;e++) {
    for (var f = b.insertRow(), d = 0;2 > d && (2 != e || 1 != d);d++) {
      var c = f.insertCell();
      c.appendChild(document.createTextNode(" "));
      1 == e && 1 == d && c.setAttribute("rowSpan", "2");
    }
  }
  a.appendChild(b);
  return b;
}
;var CTATFractionBar = function(a, b, e, f, d) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATFractionBar", "aFractionBar", a, b, e, f, d);
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, d = document.createDocumentFragment(), f = 0;f < a.length;f++) {
        var e = a[f], n = 100 * e, m = document.createElementNS(c, "rect");
        ...
        this.addPieceElem(m, e, e.selected);
        b += n;
        d.appendChild(m);
      }
      this.baseGroup.innerHTML = "";
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          var g = b.x + d / 2, d = b.width - d;
          1 > b.x ? d -= c / 2 : (g += c / 2, d = b.x + b.width >= u ? d - c / 2 : d - c);
          a.setAttributeNS(null, "x", g);
...
var CTATTextField = function(a, b, e, f, d) {
  CTATTextBasedComponent.call(this, "CTATTextBasedComponent", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null;
  this.setAction("UpdateTextArea");
...
var CTATCheckBox = function(a, b, e, f, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATCheckBox", "__undefined__", a, b, e, f, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  ...
  this.init = function() {
    ...
    c.addEventListener("click", p.bind(this));
...
CTATTutor.createStaticInterface = function(a, b, e) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var g, h, k, l;
    "shape" == this.parser.getElementName(d) && (g = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), k = this.parser.getElementAttr(d, "width"), l = this.parser.getElementAttr(d, "height"), c = this.parser.getElementAttr(d, "instance"), ctatdebug("Creating shape: " + c + " at: " + g + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(d), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + g + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), f.appendChild(l));
    "statictext" == this.parser.getElementName(d) && (g = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), k = this.parser.getElementAttr(d, "width"), l = this.parser.getElementAttr(d, "height"), c = this.parser.getElementAttr(d, "instance"), ctatdebug("Creating static text: " + c + " at: " + g + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(d), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    g + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), f.appendChild(l));
    "statictext" == this.parser.getElementName(d) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), g = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), k = this.parser.getElementAttr(d, "width"), l = this.parser.getElementAttr(d, "height"), g = new CTATMovieClip(c, g, h, k, l), h = g.wrapComponent(f), ctatdebug("Created movieclip: " + c + " at: " + g.x + "," + g.y + "," + g.width + "," + g.height), movieclips.push(g), d = this.parser.getElementChildren(d), 
    this.createStaticInterface(h, d, g));
  }
};
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (null == skillSet && (skillSet = new CTATSkillSet), window.onerror = function(a, e, f) {
    var d = new CTATHTMLManager;
    ctatdebug(d.htmlEncode(a) + " in " + e + ", line " + f);
  }, centerTutorContainer(), CTATTutor.initialize(), CTATGlobals.tutorRunning = !0, ctatdebug("runTutor () ... all set"));
};
CTATTutor.initTutor = function(a, b, e, f) {
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    var b = null;
    if (flashVars) {
      var b = flashVars.getRawFlashVars(), e = "550", f = "450", e = a.offsetWidth, f = a.offsetHeight;
      b && b.width && b.height && (ctatdebug("We have raw width and height variables in our flashvars: " + b.width + "," + b.height), e = b.width, f = b.height);
      b.centerTutor ? 1 == b.centerTutor && (ctatdebug("Moving tutor over by: " + ("-" + Number(e / 2) + "px 0 0 -" + Number(f / 2) + "px;")), a.style.position = "absolute", a.style.top = "0", a.style.left = "0", a.style.right = "0", a.style.bottom = "0", a.style.margin = "auto") : ctatdebug("The tutor is not configured to center the container, bump");
    } else {
...
function checkTutorCanvas() {
  ...
  var a = getSafeElementById(ctatcontainer), b = getSafeElementById("main-canvas"), e = flashVars.getRawFlashVars(), f = "550", d = "450";
  a && (ctatdebug("Recording the actual CSS width and height: " + a.offsetWidth + " , " + a.offsetHeight), f = a.offsetWidth, d = a.offsetHeight);
  e && e.width && e.height && (ctatdebug("We have tutor size flashvars, using those instead: " + e.width + " , " + e.height), f = e.width, d = e.height);
...
Math.imul || (Math.imul = function(a, b) {
  var e = a & 65535, f = b & 65535;
  return e * f + ((a >>> 16 & 65535) * f + e * (b >>> 16 & 65535) << 16 >>> 0) | 0;
});
...
Array.prototype.indexOf || (Array.prototype.indexOf = function(a, b) {
  ...
  for (e = Math.max(0 <= e ? e : d - Math.abs(e), 0);e < d;) {
    if (e in f && f[e] === a) {
      return e;
    }
    e++;
...
Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
  ...
  var b, e = Object(this), f = e.length >>> 0;
  if (0 === f) {
    return -1;
  }
  b = f - 1;
...
Array.prototype.every || (Array.prototype.every = function(a, b) {
  ...
  for (f = 0;f < c;) {
    var g;
    if (f in d && (g = d[f], !a.call(e, g, f, d))) {
      return !1;
    }
    f++;
  }
...
Array.prototype.some || (Array.prototype.some = function(a) {
  ...
  for (var f = 2 <= arguments.length ? arguments[1] : void 0, d = 0;d < e;d++) {
    if (d in b && a.call(f, b[d], d, b)) {
      return !0;
    }
  }
  return !1;
...
Array.prototype.filter || (Array.prototype.filter = function(a) {
  ...
  for (var f = [], d = 2 <= arguments.length ? arguments[1] : void 0, c = 0;c < e;c++) {
    if (c in b) {
      var g = b[c];
      a.call(d, g, c, b) && f.push(g);
    }
  }
  return f;
});
...
Array.prototype.map || (Array.prototype.map = function(a, b) {
  ...
  for (d = 0;d < g;) {
    var h;
    d in c && (h = c[d], h = a.call(e, h, d, c), f[d] = h);
    d++;
  }
  return f;
});
Array.prototype.reduce || (Array.prototype.reduce = function(a) {
  ...
  var b = Object(this), e = b.length >>> 0, f = 0, d;
...
Array.prototype.reduceRight || (Array.prototype.reduceRight = function(a) {
  ...
  var b = Object(this), e = (b.length >>> 0) - 1, f;
  if (2 <= arguments.length) {
    f = arguments[1];
  } else {
    for (;0 <= e && !e in b;) {
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var k = b(this) ? Object(new this(h)) : Array(h), l = 0, p;l < h;) {
      p = d[l], k[l] = c ? "undefined" === typeof g ? c(p, l) : c.call(g, p, l) : p, l += 1;
    }
    k.length = h;
    return k;
  };
...
Array.prototype.copyWithin || (Array.prototype.copyWithin = function(a, b, e) {
  ...
  e = void 0 === e ? d : e >> 0;
  d = Math.min((0 > e ? Math.max(d + e, 0) : Math.min(e, d)) - b, d - a);
  e = 1;
  b < a && a < b + d && (e = -1, b += d - 1, a += d - 1);
  for (;0 < d;) {
    b in f ? f[a] = f[b] : delete f[a], b += e, a += e, d--;
  }
  return f;
});
Array.prototype.fill || (Array.prototype.fill = function(a, b, e) {
  ...
  b = 0 > b ? Math.max(d + b, 0) : Math.min(b, d);
  e = void 0 === e ? d : e >> 0;
  for (d = 0 > e ? Math.max(d + e, 0) : Math.min(e, d);b < d;) {
    f[b] = a, b++;
  }
  return f;
});
Array.prototype.find || (Array.prototype.find = function(a, b) {
  ...
  for (var e = Object(this), f = e.length >>> 0, d, c = 0;c < f;c++) {
    if (c in e && (d = e[c], a.call(b, d, c, e))) {
      return d;
    }
  }
});
...
Array.prototype.includes || (Array.prototype.includes = function(a, b) {
  var e = Object(this), f = parseInt(e.length) || 0;
  if (0 === f) {
    return !1;
  }
  var d = parseInt(b) || 0;
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    return g;
  }(), b = String.fromCharCode, e = Math.floor, f = function() {
    var a = [], c, g, f = -1, k = arguments.length;
    if (!k) {
      return "";
    }
    for (var l = "";++f < k;) {
      g = Number(arguments[f]);
      if (!isFinite(g) || 0 > g || 1114111 < g || e(g) != g) {
...
String.prototype.codePointAt || function() {
  var a = function(a) {
    ...
    var e = String(this), f = e.length, d = a ? Number(a) : 0;
    d != d && (d = 0);
    if (!(0 > d || d >= f)) {
      return a = e.charCodeAt(d), 55296 <= a && 56319 >= a && f > d + 1 && (e = e.charCodeAt(d + 1), 56320 <= e && 57343 >= e) ? 1024 * (a - 55296) + e - 56320 + 65536 : a;
    }
  };
...
(function(a) {
  ...
  var f = /[^s]/, d = /[def]/, c = /^[^\x25]+/, g = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, k = /^([a-z_][a-z_\d]*)/i, l = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, n = /^[\+\-]/;
  b.format = function(a, c) {
    var g = 1, h = a.length, k = "", l = [], m, p, D, z, y = !0, q = "";
    for (m = 0;m < h;m++) {
      if (k = e(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          D = a[m];
          if (D[2]) {
            for (k = c[g], p = 0;p < D[2].length;p++) {
              if (!k.hasOwnProperty(D[2][p])) {
                throw Error(b("[sprintf] property '%s' does not exist", D[2][p]));
              }
              k = k[D[2][p]];
            }
          } else {
          ...
          "function" == e(k) && (k = k());
          if (f.test(D[8]) && "number" != e(k) && isNaN(k)) {
          ...
          switch(D[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              k = D[7] ? k.toExponential(D[7]) : k.toExponential();
              break;
            case "f":
              k = D[7] ? parseFloat(k).toFixed(D[7]) : parseFloat(k);
              break;
            case "o":
              k = k.toString(8);
              break;
            case "s":
              k = (k = String(k)) && D[7] ? k.substring(0, D[7]) : k;
              break;
            case "u":
              k >>>= 0;
              break;
          ...
          if (!y || d.test(D[8]) && D[3]) {
            q = y ? "+" : "-", k = k.toString().replace(n, "");
          }
          p = D[4] ? "0" == D[4] ? "0" : D[4].charAt(1) : " ";
          z = D[6] - (q + k).length;
          z = D[6] ? Array(z + 1).join(p) : "";
          l[l.length] = D[5] ? q + k + z : 0 == p ? q + z + k : z + q + k;
        }
      }
    }
    return l.join("");
        ...
        if (null !== (b = g.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var f = f | 1, e = [], m = b[2], n = [];
              if (null !== (n = k.exec(m))) {
                for (e[e.length] = n[1];"" !== (m = m.substring(n[0].length));) {
                  if (null !== (n = l.exec(m))) {
                    e[e.length] = n[1];
                  } else {
                    if (null !== (n = p.exec(m))) {
...
CTATMsgType.findProperty = function(a, b) {
  var e = a.toLowerCase(), f = "<" + b.toLowerCase() + ">", d = e.indexOf(f) + f.length, e = e.indexOf("</" + b.toLowerCase() + ">");
  if (d < f.length || 0 > e) {
    return null;
  }
  f = {};
...
CTATMsgType.makeValues = function(a) {
  ...
  if (a.constructor && "Array" == a.constructor.name) {
    ...
    for (var b = 0, e, f = "<value>" + (null == (e = a[b++]) ? "" : e.toString());b < a.length;) {
      f += "</value><value>" + (null == (e = a[b++]) ? "" : e.toString());
    }
    return f + "</value>";
  }
...
CTATMsgType.setProperty = function(a, b, e) {
  ...
  f ? (d = a.slice(0, f.start), d += CTATMsgType.makeValues(e), d += a.slice(f.end, a.length)) : (f = a.indexOf("</properties>"), d = a.slice(0, f), d += "<" + b + ">" + CTATMsgType.makeValues(e) + "</" + b + ">", d += a.slice(f, a.length));
  return d;
};
...
CTATMsgType.getSAIArraysFromElement = function(a, b) {
  for (var e = {selection:[], action:[], input:[]}, f = b.getElementChildren(a), d = 0;d < f.length;d++) {
    var c = f[d];
...
var ProblemStateSaver = function(a) {
  ...
  this.saveAsYouGo = function(g) {
    ...
    if (a && g) {
      ...
      CTATLMS.gradeStudent(parseInt(g.getCorrect()), parseInt(g.getRequiredSteps()));
    } else {
  ...
  this.setAuthenticityToken = function(a) {
    b.ctatdebug("ProblemStateSaver.setAuthenticityToken() old " + d + ", new " + a);
    a && (d = a);
  };
...
ProblemStateSaver.prototype.editForProblemState = function(a) {
  var b = a.split(ProblemStateSaver.XML_PROLOGUE), e = b[0], f;
  ...
  e = b[0];
  for (f = 1;f < b.length;++f) {
    e.endsWith("\n") && (e = e.slice(0, -1)), e.endsWith("\r") && (e = e.slice(0, -1)), e += "<" + b[f];
  }
...
ProblemStateSaver.prototype.forwardToInterface = function(a, b, e) {
  ...
  this.ctatdebug("PSS.forwardToInterface(" + f + ") problemState.length " + this.getProblemState().length + ", outputStatus " + e);
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(f) {
    ...
    f.mustRetrieveProblemState() ? (a.stopWorking(1), CTATLMS.getProblemState(b.process)) : console.log("Retrieval status indicates that we should not retrieve");
  };
    ...
    if ("string" != typeof f) {
      ...
      if (f.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof f && (f = f.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + f.length + ", msgsArr[1].length " + (f[1] ? f[1].length : -1)), !(2 > f.length))) {
          ...
          for (var c = 0, g = !1, e = 1;e < f.length;++e) {
            var k = "<message>" + f[e], l = CTATMsgType.getMessageType(k);
            CTATMsgType.STATE_GRAPH == l ? g = !0 : CTATMsgType.START_STATE_END == l ? g = !1 : g ? c++ : (a.getProblemStateSaver().appendToProblemState(k, null, !0), d.push(k));
            b.ctatdebug("problemStateArr[" + e + "] " + (g ? "omit " : "keep ") + l + " omitted " + c + " kept " + d.length);
          }
        }
...
var CTATProblemSummary = function(a, b, e) {
  ...
  var f = Number.MAX_VALUE, d = b, c = e, g = 0, h = new Date, k = {}, l = 0, p = 0, n = 0, m = 0, u = 0, r = 0, w = 0, x = CTATMsgType.CompletionValue[0], t = this;
  ...
  this.getUniqueErrors = function() {
    ...
    var a = 0, b;
    for (b in k) {
      k[b].getLastResult() == CTATStep.StepResult[1] && a++;
    }
    return a;
  };
  this.getUniqueCorrect = function() {
    ...
    var a = 0, b;
    for (b in k) {
      k[b].getLastResult() == CTATStep.StepResult[3] && a++;
    }
    return a;
  };
  ...
  this.getHintsOnly = function() {
    var a = 0, b;
    for (b in k) {
      CTATStep.StepResult[2] == k[b].getResult() && 1 > k[b].getNErrors() && ++a;
    }
    return a;
  };
  this.getErrorsOnly = function() {
    var a = 0, b;
    for (b in k) {
      CTATStep.StepResult[1] == k[b].getResult() && 1 > k[b].getNFirstHints() && ++a;
    }
    return a;
  };
  ...
  this.addHint = function(a) {
    ...
    var b = k[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNFirstHints() && ++m, b.incrementFirstHints()) : (b = new CTATStep(a, CTATStep.StepResult[2]), k[a] = b, m++);
    p++;
    b.setLastResult(CTATStep.StepResult[2]);
    t.ctatdebug("exiting addHint() hint count " + p + ", trial " + b);
  };
  this.addError = function(a) {
    t.ctatdebug("addError(" + a + ")");
    var b = k[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++w, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), k[a] = b, w++);
    n++;
    b.setLastResult(CTATStep.StepResult[1]);
    t.ctatdebug("exiting addError() error count " + n + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = k[a];
    t.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++u, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (t.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), k[a] = b, u++, r++);
    l++;
    b.setLastResult(CTATStep.StepResult[3]);
    t.ctatdebug("exiting addCorrect() correct count " + l + ", trial " + b);
  };
  this.setCompletionStatus = function(a, b) {
    t.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
    if (CTATMsgType.CompletionValue[1] != x || b) {
      x = a;
    }
  };
...
var CTATMatcher = function(a, b, e) {
  ...
  var f = new CTATSAI("", "", ""), d = e, c = CTATMsgType.DEFAULT_ACTOR, g = !1, h = this;
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.setParens = function(e, f) {
      var d;
      null == f && (f = !1);
      d = this.negated() ? "UMINUS" : this.inverted() ? "DIVIDE" : this.operator;
      d = a.operatorPrecedence(e, d);
      if (0 > d || 0 === d && f) {
        this.parens = 1;
      }
      return this;
    ...
    a.prototype.compare = function(e, f) {
...
(function() {
  ...
  a = function(a) {
    ...
    d.prototype.compare = function(a, b) {
      var f;
      return (f = d.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || this.terms.some(function(d, e) {
        return f = d.compare(a.terms[e], b);
  ...
  a = function(a) {
    ...
    d.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        ...
        })) ? d[1] += (null != (f = p[1]) ? f.evaluate() : void 0) || 1 : a.push([p[0], (null != (e = p[1]) ? e.evaluate() : void 0) || 1]);
      });
    ...
    d.prototype.compare = function(a, b) {
      var f, e;
      return (e = d.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (f = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, c) {
        return e = a.compare(f[c], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, e = [1, 6], f = [1, 7], d = [1, 10], c = [1, 11], g = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], m = [1, 24], u = [1, 26], r = [1, 27], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], x = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(p, [2, 11], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:g, 28:h}), b(w, [2, 17]), {13:e, 15:f, 17:28, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:e, 15:f, 17:29, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(w, [2, 20]), b(w, [2, 23], {23:[1, 30]}), {13:e, 15:f, 17:31, 19:8, 22:9, 24:d, 25:c, 27:g, 
  28:h}, {6:32, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(x, [2, 25]), b(x, [2, 26]), {1:[2, 1]}, {6:33, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:34, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:35, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:36, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:37, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:38, 13:e, 14:4, 15:f, 17:5, 19:8, 22:9, 
  24:d, 25:c, 27:g, 28:h}, {13:e, 14:39, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:e, 14:40, 15:f, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:e, 15:f, 17:41, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:e, 15:f, 17:42, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(w, [2, 14]), {13:e, 15:f, 17:43, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:e, 15:f, 17:44, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(w, [2, 18]), b(w, [2, 19]), {13:e, 15:f, 17:45, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(w, [2, 22]), {13:k, 
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(p, [2, 9], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:g, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:g, 28:h}), b(w, [2, 12]), b(w, [2, 13]), b(w, [2, 15]), b(w, [2, 16]), b(w, [2, 21]), b(x, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, h = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), p = {}, u;
    for (u in this.yy) {
      Object.prototype.hasOwnProperty.call(this.yy, u) && (p[u] = this.yy[u]);
    }
    m.setInput(a, p);
    p.lexer = m;
    p.parser = this;
    ...
    for (var r, w, x, K, N = {}, P, L;;) {
      ...
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        L = [];
        for (P in e[x]) {
          this.terminals_[P] && 2 < P && L.push("'" + this.terminals_[P] + "'");
        }
        Q = m.showPosition ? "Parse error on line " + (g + 1) + ":\n" + m.showPosition() + "\nExpecting " + L.join(", ") + ", got '" + (this.terminals_[r] || r) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == r ? "end of input" : "'" + (this.terminals_[r] || r) + "'");
        this.parseError(Q, {text:m.match, token:this.terminals_[r] || r, line:m.yylineno, loc:u, expected:L});
      }
      if (K[0] instanceof Array && 1 < K.length) {
        throw Error("Parse Error: multiple actions possible at state: " + x + ", token: " + r);
      }
      switch(K[0]) {
        case 1:
          b.push(r);
          ...
          b.push(K[1]);
          r = null;
          w ? (r = w, w = null) : (k = m.yyleng, f = m.yytext, g = m.yylineno, u = m.yylloc, 0 < h && h--);
          break;
        case 2:
          L = this.productions_[K[1]][1];
          N.$ = c[c.length - L];
          N._$ = {first_line:d[d.length - (L || 1)].first_line, last_line:d[d.length - 1].last_line, first_column:d[d.length - (L || 1)].first_column, last_column:d[d.length - 1].last_column};
          n && (N._$.range = [d[d.length - (L || 1)].range[0], d[d.length - 1].range[1]]);
          x = this.performAction.apply(N, [f, k, g, p, K[1], c, d].concat(l));
          if ("undefined" !== typeof x) {
            return x;
          }
          L && (b = b.slice(0, -2 * L), c = c.slice(0, -1 * L), d = d.slice(0, -1 * L));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.polyTermsEqual = function(e, f) {
      return this.parser.parse(e).simplify(a.partial).equals(this.parser.parse(f).simplify(a.partial));
    };
...
(function() {
  var a, b, e, f, d, c, g, h, k, l, p, n = [].slice;
  d = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  f = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.matchWithPrecision = function(a, c) {
      var d, e;
      return (d = String(a).match(l)) && (e = String(c).match(l)) && p(d) === p(e) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, c) {
      var d, f;
      return (d = String(a).match(l)) && (f = String(c).match(l)) && (a = p(d) > p(f) ? (+a).toFixed(e(f)) : String(a)) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    ...
    a.columnCell = function(a, b, c, d, e, f, g, k, h, l) {
      switch(h) {
        case "r1c1":
        ;
        case "r2c1":
...
var CTATVariableTableCount = 0, CTATVariableTable = function() {
  ...
  this.put = function(a, d) {
    e.ctatdebug("CTATVariableTable.put(" + a + ", " + d + ") typeof value " + typeof d);
    var c;
    if (a) {
      if (0 > a.indexOf(".")) {
        b[a] = d;
...
(function() {
  var a, b, e, f = [].slice, d = [].indexOf || function(a) {
  ...
  a = function() {
    function a(b) {
      ...
      this.keys = [];
      this.values = [];
      e = "EPSILON MAX_VALUE MIN_VALUE POSITIVE_INFINITY NEGATIVE_INFINITY isFinite isInteger isNaN parseFloat parseInt".split(" ");
      b = 0;
      for (d = e.length;b < d;b++) {
        c = e[b], this.keys.push(c), this.values.push(Number[c]);
      }
      e = "toExponential toFixed toLocaleString toPrecision toString valueOf".split(" ");
      b = 0;
      for (d = e.length;b < d;b++) {
        c = e[b], this.keys.push(c), this.values.push(function(a) {
          return function() {
            var b, c;
            c = arguments[0];
      ...
      e = "E LN10 LN2 LOG10E LOG2E PI SQRT1_2 SQRT2 abs acos acosh asin asinh atan atanh atan2 cbrt ceil clz32 cos cosh exp expm1 floor fround hypot imul log log10 log1p log2 max min pow random round sign sin sinh sqrt tan tanh trunc".split(" ");
      b = 0;
      for (d = e.length;b < d;b++) {
        c = e[b], this.keys.push(c), this.values.push(Math[c]);
      }
      e = ["fromCharCode", "fromCodePoint"];
      b = 0;
      for (d = e.length;b < d;b++) {
        c = e[b], this.keys.push(c), this.values.push(String[c]);
      }
      e = "charAt charCodeAt codePointAt concat contains endsWith indexOf lastIndexOf localeCompare match repeat replace search slice split startsWith substr substring toLocaleLowerCase toLocaleUpperCase toLowerCase toUpperCase trim valueOf".split(" ");
      d = 0;
      for (b = e.length;d < b;d++) {
        c = e[d], this.keys.push(c), this.values.push(function(a) {
          return function() {
            var b, c;
            c = arguments[0];
            b = 2 <= arguments.length ? f.call(arguments, 1) : [];
    ...
    a.prototype.evaluate = function(a, c, k, l) {
      ...
      try {
        ...
        x = null != (w = a.match(b)) ? w : [];
        n = 0;
        for (u = x.length;n < u;n++) {
          m = x[n], 0 > d.call(e, m) && CTATFormulaFunctions.assign(m, void 0);
        }
        for (m in t = this.variableTable.getTable()) {
          r[m] = t[m];
        }
        ...
        }).apply(r, [c, k, l].concat(f.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (m in r) {
          null != m && 0 > d.call(p, m) && (t[m] = r[m], delete r[m]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      r = [];
      a = f = 0;
      for (m = u.length;f < m;a = ++f) {
        e = u[a], r.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return r.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.setSingle = function(a) {
    null === a || "undefined" === typeof a ? e.ctatdebug('CTATSingleMatcher --\x3e bad argument "' + a + '" to setSingle()') : f = a;
  };
  this.toString = function() {
  ...
  this.evaluateReplacement = function(a, b, f) {
    ...
    e.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + d + ", " + k + ", " + l + ", " + a + ")");
    try {
      f = b.evaluate(d, k, l, a);
    } catch (p) {
      e.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + d + ") " + p.name + ": " + p.message), f = null;
    }
    e.ctatdebug("CTATSingleMatcher.evaluateReplacement() returns " + f + ", type " + typeof f);
    return f;
  };
};
...
CTATSingleMatcher.prototype.match = function(a, b, e, f) {
...
var CTATExpressionMatcher = function(a, b) {
  function e(a, b, d, e, g) {
    ...
    var u = CTATVariableTable.standardizeType(d);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof d + "; inputConv " + u + ", typeof " + typeof u);
    d = h.evaluate(a, b, u, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + u + ", " + g + ") returned " + d + ", type " + typeof d);
    g = null;
    switch(e) {
  ...
  var f = CTATExpressionMatcher.EQ_RELATION, d = b, c = null, g = !1, h = this;
...
var CTATVectorMatcher = function(a, b, e, f) {
  function d(a, b, d, e, f) {
    ...
    for (var x = 0;3 > x;x++) {
      var t = k[x][0], B = t instanceof CTATExpressionMatcher ? t.matchConcatenation(a, b, d, e) : t.matchConcatenation(w[x]);
      l.ctatdebug("CTATVectorMatcher --\x3e in _match[" + x + "] after " + t + ".concat returns: " + B);
      if (f) {
        f.push(B);
      } else {
        if (!1 === B) {
  ...
  this.match = function(a, b, c, e, f) {
    return !1 !== d(a, b, c, f) && l.matchActor(e) ? !0 : !1;
  };
...
var CTATExampleTracerLink = function(a, b, e) {
  ...
  var f = "undefined" === typeof a || null === a ? null : a, d = null, c = "undefined" === typeof b || null === b ? null : b, g = "undefined" === typeof e || null === e ? null : e, h = null, k = 1, l = 1, p = "CORRECT_ACTION", n = [], m = !1, u = null, r = "", w = null, x = null, t = this;
  ...
  this.interpolateHints = function(a) {
    ...
    n.forEach(function(a) {
      if (!(1 > String(a).trim().length)) {
        var d = t.getDefaultSAI().getSelection(), e = t.getDefaultSAI().getAction(), f = CTATVariableTable.standardizeType(t.getDefaultSAI().getInput());
        t.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate(" + a + ", " + d + ", " + e + ", " + f + ")");
  ...
  this.addSkillName = function(a) {
    t.ctatdebug("ETLink[" + f + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === x || "undefined" === typeof x) {
        x = [];
      }
      -1 < x.indexOf(a) || (x.push(a), t.ctatdebug("ETLink.addSkillName() return with skillNames " + x));
    }
  };
  ...
  this.setIsPreferredLink = function(a) {
    t.ctatdebug("ETLink.setIsPreferredLink() was " + m + ", now " + a);
    m = a;
  };
...
var CTATRegexMatcher = function(a, b) {
  CTATSingleMatcher.call(this, a, !0);
  var e = null, f = null, d = this;
  this.toString = function() {
    return e;
  };
  this.setSinglePattern = function(a) {
    "undefined" === typeof a || null === a ? console.log("CTATRegexMatcher: null or undefined pattern") : (e = a, f = d.getCaseInsensitive() ? new RegExp(a, "i") : new RegExp(a));
  };
  this.setSingle = function(a) {
...
var CTATExampleTracerNode = function(a, b) {
  ...
  var e = null, f = "", d = b ? b : new Set, c = new Set;
...
var CTATVersionComparator = function() {
  ...
  this.compare = function(a, b) {
    ...
    var e = 0, f = a.split("."), d = b.split("."), c;
    for (c = 0;c < Math.min(f.length, d.length);c++) {
      try {
        var g = parseInt(f[c]), h = parseInt(d[c]), e = g < h ? -1 : g > h ? 1 : 0;
        if (0 !== e) {
          return e;
        }
      } catch (k) {
        if (e = f[c].toString() < d[c].toString() ? -1 : f[c].toString() > d[c].toString() ? 1 : 0, 0 !== e) {
          return e;
        }
      }
    }
...
var CTATExampleTracerSkill = function(a, b, e, f, d, c, g) {
  CTATBase.call(this, "CTATExampleTracerSkill", b);
  var h = null == a || "" == a.trim() ? b : b + " " + a, k = f, l = /^0*[xX]([0-9a-fA-F]+)$/.test(g) ? parseInt(g, 16) : /^(\-|\+)?[0-9]+$/.test(g) ? parseInt(g, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, p = 0, n = 0, m = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, u = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, r = null, w = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.updatePKnown = function(a) {
    return k = CTATExampleTracerSkill.updatePKnownStatic(a, e, k, d, c);
  };
  ...
  this.getLabel = function() {
    return null === r || "undefined" === typeof r || 1 > r.length ? CTATExampleTracerSkill.getName(h) : r;
  };
      ...
      if (!(null === e || "undefined" === typeof e || 1 > e.length)) {
        for (var f = !1, g = 0;g < e.length;g++) {
          if (null !== e[g] && "undefined" !== typeof e[g]) {
            var k = e[g].toString();
            1 > k.length || e === a && ("hint".toString().toUpperCase() === k.toString().toUpperCase() || "help".toString().toUpperCase() === k.toString().toUpperCase()) || e === b && CTATMsgType.PREVIOUS_FOCUS.toString().toUpperCase() === k.toString().toUpperCase() || (c = c + (f ? "," : "[") + k, f = !0);
          }
        }
        !0 === f && (c += "]");
      }
...
var CTATWildcardMatcher = function(a, b) {
  function e(a) {
    ...
    f.ctatdebug("CTATWildcardMatcher.convertToFullRegex(" + a + ") after qm: " + b + "; after aster: " + e + "; after negate: " + h + ";");
    return h;
  }
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.compare = function(b, e) {
    ...
    var f = b.getNumberOfPreferredPrefixLinks(), d = e.getNumberOfPreferredPrefixLinks();
    if (f > d) {
      return -1;
    }
    if (f < d) {
    ...
    d = e.getNumberOfSuboptimalLinks();
    if (f < d) {
      return -1;
    }
    if (f > d) {
  ...
  this.breakByLowerLinkID = function(b, e) {
    ...
    var f = b.getSortedLinks(), d = e.getSortedLinks(), c = null, g = null, h = 0, k = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), k >= f.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : k >= d.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), c = f[k], g = d[k]), k++;
...
var CTATExampleTracerPath = function(a) {
  ...
  var e = null, f = null, d = null, c = null, g = null, h = null, k = this;
...
CTATRangeMatcher.prototype.match = function(a, b, e, f) {
  return this.matchSingle(a, b, e, f);
};
...
var CTATExampleTracerLinkComparator = function(a, b) {
  ...
  this.compare = function(e, f) {
    ...
    var d = e.getType(), c = f.getType(), d = CTATExampleTracerLink.compareLinkTypes(d, c);
    if (0 !== d) {
    ...
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getDepth(), l2.getDepth(): " + e.getDepth() + ", " + f.getDepth());
    if (e.getDepth() < f.getDepth()) {
      return -1;
    }
    if (e.getDepth() > f.getDepth()) {
      return 1;
    ...
    if (0 !== (d = CTATMatcherComparator.compare(e.getMatcher(), f.getMatcher()))) {
      return d;
    }
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getUniqueID(): " + e.getUniqueID());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): " + f.getUniqueID());
    return e.getUniqueID() < f.getUniqueID() ? -1 : 1;
  };
};
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  var b = [], e = {}, f = new CTATVariableTable, d = new Set;
  a.forEach(function(a) {
    d.add(a);
  });
...
var CTATExampleTracerInterpretationComparator = function() {
  ...
  this.compare = function(b, e) {
    ...
    var f = b.getType(), d = CTATExampleTracerLink.compareLinkTypes(f, e.getType());
    ...
    if (CTATExampleTracerLink.BUGGY_ACTION.toString().toUpperCase() === f.toString().toUpperCase() && (ctatdebug("CTATExampleTracerInterpretationComparator checking for buggy actions"), f = b.getLastMatchedLink(), d = e.getLastMatchedLink(), f = CTATMatcherComparator.compare(f.getMatcher(), d.getMatcher()), 0 !== f)) {
      return f;
    }
    var d = CTATExampleTracerPath.getBestPath(b.getPaths()), f = CTATExampleTracerPath.getBestPath(e.getPaths()), c = new Set;
    c.add(d);
    c.add(f);
...
var CTATExampleTracerEvent = function(a, b, e) {
  ...
  var f = "", d = !1, c = CTATExampleTracerLink.NO_MODEL, g = !1, h = null, k = null, l = "student", p = null, n = null, m = "", u = null, r = null, w = null, x = null, t = null, B = [], C = !1, G = null, D = null, z = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.getTransactionID = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + f);
    return f;
  };
  this.setTransactionID = function(a) {
  ...
  this.getResult = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + c);
    return c;
  };
  ...
  this.isOutOfOrder = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + u);
    return u;
  };
  ...
  this.setInterpolatedSAI = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI(" + a + ")");
    a && (G = a);
  };
  this.getInterpolatedSAI = function() {
    return G ? G : z.getStudentSAI();
  };
  ...
  this.getSuccessOrBuggyMsg = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + t);
    return t;
  };
  ...
  this.getReportableVariableTable = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + x);
    return x;
  };
  this.getReportableInterpretation = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + n);
    return n;
  };
  this.getStepID = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + m);
    return m;
  };
  ...
  this.getTutorInput = function() {
    return null !== w && "undefined" !== typeof w ? z.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function f(a, b, c, d, f, g) {
    ...
    if (b) {
      ...
      d != f.getLastMatchedLink() && (f.addLink(d), a.setResult(d.getActionType()));
      if (c.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || c.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        ...
        for (var k in B) {
          B.hasOwnProperty(k) && delete B[k];
        }
        g.forEach(function(a) {
          B[a.getLastMatchedLink().getUniqueID()] = a.getLastMatchedLink();
        });
      }
      c.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && C.splice(C.length - 1, 1);
    }
    a.isSolverResult() || (q.ctatdebug("In evaluate inside the solver result if condition + " + c), a.setResult(c));
    ...
    a.getHintRequest() || (b = d.getTutorSAI(a.getInterpolatedSAI(), f.getVariableTable()), q.ctatdebug("In evaluate -- TUTORSAI: " + b + ", studentSAI was " + a.getStudentSAI()), a.setTutorSAI(b));
    b = c == CTATExampleTracerLink.CORRECT_ACTION ? d.getSuccessMsg() : d.getBuggyMsg();
    a.setSuccessOrBuggyMsg(e(b, f.getVariableTable(), a.getStudentSAI()));
    a.getHintRequest() && (f = d.interpolateHints(f.getVariableTable()), a.setInterpolatedHints(f), q.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(f) && 0 < f.length ? a.setReportableHints(f) : a.setReportableHints(d.getHints()), q.ctatdebug("In evaluate --\x3e after setReportableHints"));
  ...
  function d(a, b, c, d) {
    q.ctatdebug("checkDoneStep() hintTrace " + b + ", sai " + a.getStudentSAI() + ", exitOnIncorrectDone " + G.exitOnIncorrectDone() + ", hideButRequireSteps " + G.hideButRequireSteps() + ", nInterps " + d.size);
    if (!a.getStudentSAI().isDone()) {
      return q.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "), null;
    }
    if (G.exitOnIncorrectDone()) {
      return a.setDoneStepFailed(!1), q.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return null "), null;
    }
    if (!b && G.hideButRequireSteps()) {
      ...
      for (var e;!(e = b.next()).done;) {
        if (G.pathToLinkIsSubset(e.value, y)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? f(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, q.getBestInterpretation(), q.getInterpretationsInternal()) : f(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, p(d), d);
        }
      }
    }
  ...
  function c(a, b, c) {
    ...
    D = a;
    var e = new Set, m = a.getPreloadedLinkMatches();
    q.ctatdebug("interps # : " + t.length);
    q.ctatdebug("interps: " + t);
    t.forEach(function(d) {
      q.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof m || null === m) {
        q.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), m = h(a.getStudentSAI(), a.getActor(), b, d.getVariableTable(), a), q.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      } else {
        for (var f = 0;f < m.length;++f) {
          g(a.getStudentSAI(), !0, m[f], m[f].getActor(), d.getVariableTable());
        }
      }
      q.ctatdebug("Link matches # : " + m.length);
      m.forEach(function(b) {
        q.ctatdebug("In evaluate -- entered the saiLinkMatches loop + " + b);
        if (!G.relaxTracingConstraints() && d.getTraversalCount(b) >= b.getMaxTraversals()) {
    ...
    q.ctatdebug("In evaluate -- number of interpretations " + e.size + " set");
    var n = d(a, b, c, e);
    if (null !== n) {
      return n;
    }
    ...
    var r = null;
    !0 === a.isSolverResult() ? (q.ctatdebug("In evaluate -- in if branch of isSolverResult"), r = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (q.ctatdebug("In evaluate -- in else branch of isSolverResult"), r = n.getLastMatchedLink().getType());
    return f(a, c, r, null, n, e);
  }
  function g(a, b, c, d, e) {
    ...
    q.ctatdebug("updateMatchedSelections(): link " + c.getUniqueID() + ", matched " + b + ", newResult " + f + ", matchedSelections[link] " + y[c.getUniqueID()]);
  }
  function h(a, b, c, d, e) {
    ...
    G.getLinks().forEach(function(h) {
      if (!1 === c) {
        ...
        !0 === k && f.push(h);
        G.hideButRequireSteps() && g(a, k, h, b, d);
      } else {
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === G.observesOrderingConstraints(h, a, f, e) || !1 === u(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  function n(a) {
    ...
    0 === a.size ? q.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (q.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      t.push(a);
    }), z = null, q.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function m() {
  ...
  function u(a, b, c) {
    ...
    c.forEach(function(c) {
      if (!1 === d) {
        q.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop");
      } else {
        if (c.getUniqueID() === b.getUniqueID()) {
          q.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition");
        } else {
          var e = a.getTraversalCount(c);
          !(G.relaxTracingConstraints() && 0 < e) && e < c.getMinTraversals() && (q.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"), d = !1);
        }
      }
    });
    if (!1 === d) {
  ...
  function r(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < q.nonEmptyHints(b, c.getVariableTable())) && G.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && u(c, b, d.getLinks()) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function w(a, b, c, d) {
    ...
    b.getSortedLinks().forEach(function(b) {
      ...
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + x(b));
      !0 === a.isTraversed(b, d) || !0 === x(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), f = !0) : (!0 === f && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), G.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
  ...
  var t = null, B = null, C = null, G = a, D = null;
  ...
  this.resetTracer = function() {
    ...
    null === t || "undefined" === typeof t ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), t = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), t.length = 0);
    ...
    z = a;
    if (null === B || "undefined" === typeof B) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), B = {};
    } else {
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === z || "undefined" === typeof z) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), z = p(q.getInterpretationsInternal());
    }
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === z || void 0 === z));
    return z;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = r(!1, [a])) ? a.getPrevNode() : G ? G.getStartNode() : null;
  };
};
...
var CTATDefaultLinkGroup = function(a, b, e, f) {
  CTATLinkGroup.call(this, "CTATDefaultLinkGroup", a);
  var d = a, c = b, g = e, h = new Set;
  null !== f && "undefined" !== typeof f && f.forEach(function(a) {
    h.add(a);
  });
  var k = new Set, l = null, p = null, n = this;
  ...
  this.setOrdered = function(a) {
    n.ctatdebug("CTATDefaultLinkGroup --\x3e in setOrdered group name: " + d);
...
InternalGroupIterator = function(a, b) {
  ...
  var e = this, f = b.length, d = [], c = 0;
  a.getSubgroups().forEach(function(a) {
    a && d.push(a);
  });
  b.push(e);
  e.ctatdebug("InternalGroupIterator() constructor group " + a + ", stack.length " + b.length + ", sgList.length " + d.length);
  this.toString = function() {
    return "{" + a + " at " + f + " with " + d.length + " subgroups}";
  };
  this.next = function() {
    return c >= d.length ? (b.pop(), e.ctatdebug("InternalGroupIterator at deepest next() returning " + a + " with stack.length " + b.length), {value:a, done:!1}) : (new InternalGroupIterator(d[c++], b)).next();
  };
};
...
var CTATDefaultGroupModel = function() {
  ...
  function e(a, b) {
    ...
    var c = null, d = !1, f = null;
    k.getGroupSubgroups(b).forEach(function(b) {
      !0 !== d && !0 === k.isLinkInGroup(b, a) && (c = e(a, b), f = null !== c && "undefined" !== typeof c ? c : b, d = !0);
    });
    return !0 === d ? f : null;
  }
  function f(a, b) {
...
var CTATExampleTracerGraph = function(a, b, e) {
  function f(a, b, d) {
    ...
    if (A.relaxTracingConstraints() || b.isDone() && A.exitOnIncorrectDone()) {
      return !0;
    }
    for (var e = c(b), f = 0;f < e.length;f++) {
      var k = e[f];
      if (!0 === F.isGroupOrdered(k)) {
        if (f !== e.length - 1) {
  ...
  function d(a, b, d) {
    ...
    if (0 !== a.length) {
      ...
      A.ctatdebug("CTATETGraph.isReentrableOK: exitedGroups.length after removing newLink's groups: " + h.length);
      h.forEach(function(a) {
        !0 === F.isGroupReenterable(a) && 0 <= h.indexOf(a) && h.splice(h.indexOf(a), 1);
      });
      A.ctatdebug("CTATETGraph --\x3e in isReentrableOK: exitedGroups after removing reenterables: " + h.length);
      A.ctatdebug("CTATETGraph --\x3e in isReentrableOK: traversedLinks: " + a + ", path: " + d);
      var l = !0;
      h.forEach(function(b) {
        !1 !== l && d.forEach(function(c) {
          !1 !== l && k(a, c) < c.getMinTraversals() && !0 === F.isLinkInGroup(b, c) && (l = !1);
        });
      });
      if (!1 === l) {
        return !1;
  ...
  function c(a) {
    A.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof F);
  ...
  function g(a, b, c, d) {
    ...
    F.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === F.isLinkInGroup(a, b) && 0 !== F.getGroupLinkCount(a)) {
        var k = h(a, d);
        null !== k && "undefined" !== typeof k && (k = k.getDepth(), k < b.getDepth() && k > e && (!1 === p(a) || !0 === n(a, c)) && (e = k, f = a), k > b.getDepth() && k < g && (!1 === p(a) || !0 === n(a, c)) && (g = k, l = a));
      }
    });
  ...
  function k(a, b) {
    ...
    A.ctatdebug("CTATETGraph.getTraversalCount(" + b + "): " + c);
    return c;
  }
  function l(a, b, c) {
    var d = !1, e = !0, f = !1;
  ...
  var x = null, t = null, B = null, C = null, G = null, D = null, z = new Set, y = new Set, q = null, F = null, E = CTATMsgType.SHOW_ALL_FEEDBACK, A = this;
  this.getFeedbackPolicy = function() {
    return E;
  };
  this.setFeedbackPolicy = function(a) {
    A.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + E);
    E = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
  this.hideButRequireSteps = function() {
    return E == CTATMsgType.HIDE_BUT_COMPLETE;
  };
  this.hideAllFeedback = function() {
    return E == CTATMsgType.HIDE_ALL_FEEDBACK;
  };
  this.relaxTracingConstraints = function() {
    return A.hideAllFeedback() || A.hideButRequireSteps();
  };
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === e && (b = A.getSmallestContainingGroup(b), !0 === F.isLinkInGroup(b, g) && !1 === F.isGroupOrdered(b) && !0 === l(b, c, d))) {
      return !1;
    }
  ...
  this.getNode = function(a) {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + C[a]);
    return C[a];
  };
  ...
  this.getStartNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + G);
    return G;
  };
  ...
  this.getStudentStartsHereNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + D);
    return D;
  };
  ...
  this.getExampleTracer = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + x);
    return x;
  };
  ...
  this.getVisualData = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + q);
    return q;
  };
  ...
  (function(a, b) {
    ...
    C = {};
    if (null === F || "undefined" === typeof F) {
      F = new CTATDefaultGroupModel, A.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    F.clear();
    ...
    x = new CTATExampleTracerTracer(A, e);
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), e = g.getElementChildren(a), f, h, k, l, m, n = a = -1, z = CTATMsgType.DEFAULT_ACTOR, y = !1, q = 0;q < e.length;q++) {
      "sourceID" === g.getElementName(e[q]) && (a = parseInt(g.getNodeTextValue(e[q])), d.setPrevNode(a));
      "destID" === g.getElementName(e[q]) && (n = parseInt(g.getNodeTextValue(e[q])), d.setNextNode(n));
      if ("rule" === g.getElementName(e[q])) {
        for (var F = g.getElementChildren(e[q]), E = 0;E < F.length;E++) {
          "text" === g.getElementName(F[E]) && d.addSkillName(g.getNodeTextValue(F[E]).toString());
        }
      }
      if ("actionLabel" === g.getElementName(e[q])) {
        for (d.setIsPreferredLink("false" != g.getElementAttr(e[q], "preferPathMark")), d.setMinTraversalsStr(g.getElementAttr(e[q], "minTraversals")), d.setMaxTraversalsStr(g.getElementAttr(e[q], "maxTraversals")), F = g.getElementChildren(e[q]), E = 0;E < F.length;E++) {
          "uniqueID" === g.getElementName(F[E]) && (m = g.getNodeTextValue(F[E]), d.setUniqueID(parseInt(g.getNodeTextValue(F[E]))));
          "message" === g.getElementName(F[E]) && (l = new CTATMessage(F[E]));
          "actionType" === g.getElementName(F[E]) && d.setActionType(g.getNodeTextValue(F[E]));
          "buggyMessage" === g.getElementName(F[E]) && d.setBuggyMsg(g.getNodeTextValue(F[E]));
          "successMessage" === g.getElementName(F[E]) && d.setSuccessMsg(g.getNodeTextValue(F[E]));
          "hintMessage" === g.getElementName(F[E]) && d.addHint(g.getNodeTextValue(F[E]));
          if ("matchers" === g.getElementName(F[E])) {
            for (var A = g.getElementChildren(F[E]), H = 0;H < A.length;H++) {
              "Selection" === g.getElementName(A[H]) && (f = b(A[H], 0)), "Action" === g.getElementName(A[H]) && (h = b(A[H], 1)), "Input" === g.getElementName(A[H]) && (k = b(A[H], 2)), "Actor" === g.getElementName(A[H]) && (z = g.getNodeTextValue(A[H]), y = (y = g.getElementAttr(A[H], "linkTriggered")) && "false" != y.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === g.getElementName(F[E])) {
            h = F[E];
            f = g.getElementAttr(h, "replacementFormula");
            h = g.getElementChildren(h);
            var H = A = z = k = void 0, J = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var z = new CTATExactMatcher(CTATMatcher.ACTION, null), I = 0;I < h.length;I++) {
              if ("matcherType" === g.getElementName(h[I]) && ("ExactMatcher" === g.getNodeTextValue(h[I]) && (H = CTATExactMatcher), "RegexMatcher" === g.getNodeTextValue(h[I]) && (H = CTATRegexMatcher), "AnyMatcher" === g.getNodeTextValue(h[I]) && (H = CTATAnyMatcher), "RangeMatcher" === g.getNodeTextValue(h[I]) && (H = CTATRangeMatcher), "WildcardMatcher" === g.getNodeTextValue(h[I]) && (H = CTATWildcardMatcher), "ExpressionMatcher" === g.getNodeTextValue(h[I]) && (H = CTATExpressionMatcher)), 
              "matcherParameter" === g.getElementName(h[I])) {
                var M = g.getElementAttr(h[I], "name");
                "selection" == M && k.setParameter(g.getNodeTextValue(h[I]));
                "action" == M && z.setParameter(g.getNodeTextValue(h[I]));
                "input" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(g.getNodeTextValue(h[I])));
                "actor" == M && (J = g.getNodeTextValue(h[I]));
                "minimum" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(g.getNodeTextValue(h[I]), "minimum"));
                "maximum" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(g.getNodeTextValue(h[I]), "maximum"));
              }
            }
    ...
    c.getStartNode() && n == c.getStartNode().getNodeID() && console.log("***WARNING*** edge " + m + " destination is graph startNode " + c.getStartNode());
    m = new CTATVectorMatcher(f, h, k, z);
    m.setDefaultSAI(l.getSAI());
    m.setCaseInsensitive(p);
    m.setLinkTriggered(y);
    d.setMatcher(m);
    ctatdebug("GraphParser.processEdge() " + a + "->" + n + ", edge " + d);
  ...
  function b(a, b) {
    ...
    for (var c = g.getElementChildren(a), d = [], e = 0;e < c.length;e++) {
      if ("matcher" === g.getElementName(c[e])) {
        for (var h = null, k = g.getElementAttr(c[e], "replacementFormula"), l = g.getElementChildren(c[e]), m = 0;m < l.length;m++) {
          if ("matcherType" === g.getElementName(l[m])) {
            switch(h = g.getNodeTextValue(l[m]), f.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + m + "] = " + h), h) {
              case "ExactMatcher":
          ...
          if ("matcherParameter" === g.getElementName(l[m])) {
            var n = g.getElementAttr(l[m], "name");
            "single" === n ? h.setParameter(g.getNodeTextValue(l[m])) : "minimum" === n ? h.setParameter(g.getNodeTextValue(l[m]), "minimum") : "maximum" === n ? h.setParameter(g.getNodeTextValue(l[m]), "maximum") : h.setParameter(l[m], n, g);
          }
        }
  ...
  function e(a, b) {
    ...
    var f = "true" === g.getElementAttr(a, "ordered"), h = "true" === g.getElementAttr(a, "reenterable");
    ...
    for (var k = function(a) {
      c.add(a);
    }, m = g.getElementChildren(a), n = 0;n < m.length;n++) {
      if ("link" === g.getElementName(m[n])) {
        var p = Number(g.getElementAttr(m[n], "id")), y = b[p];
        if (null !== y || void 0 !== y) {
          ctatdebug("Added link ID : " + p), c.add(y);
        }
      }
      "group" === g.getElementName(m[n]) && (ctatdebug("encountered a subgroup"), e(m[n], b).forEach(k));
    }
    l.addGroup(d, f, c);
    l.setGroupReenterable(l.getGroupByName(d), h);
    return c;
  }
  CTATBase.call(this, "CTATGraphParser", "__undefined__");
  var f = this, d, c, g = new CTATXML, h = null, k = [];
  new XMLSerializer;
  var l, p = !0, n = !0, m = [];
  ...
  this.parseGraph = function(b, f) {
    ctatdebug("parseBRD()");
    var w = 0, x = g.getElementAttr(b, "startStateNodeName"), t = "true" === g.getElementAttr(b, "unordered");
    p = "false" != String(g.getElementAttr(b, "caseInsensitive")).toLowerCase();
    n = g.getElementAttr(b, "lockWidget");
    var B = new CTATVariableTable;
    c = new CTATExampleTracerGraph(t, !1, B);
    var C = g.getElementChildren(b), B = g.getElementAttr(b, "suppressStudentFeedback");
    if (null === B || void 0 === B) {
      B = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    c.setFeedbackPolicy(B);
    f.setFeedbackSuppressed(B);
    B = g.getElementAttr(b, "highlightRightSelection");
    f.setHighlightRightSelection("false" != B);
    var G = g.getElementAttr(b, "confirmDone");
    "true" !== G && "false" !== G && (G = c.getFeedbackPolicy() === CTATMsgType.HIDE_ALL_FEEDBACK ? "true" : "false");
    f.setHintPolicy(g.getElementAttr(b, "hintPolicy"));
    f.setOutOfOrderMessage(g.getElementAttr(b, "outOfOrderMessage"));
    for (var D = null, z = 0;z < C.length;z++) {
      switch(g.getElementName(C[z])) {
        case "startNodeMessages":
          k = g.getElementChildren(C[z]);
          break;
        case "node":
          w++;
          var y;
          ...
          var q = g.getElementChildren(y), F = -1;
          y = "";
          for (var E = 0;E < q.length;E++) {
            switch(g.getElementName(q[E])) {
              case "uniqueID":
                F = parseInt(g.getNodeTextValue(q[E]));
                break;
              case "text":
                y = g.getNodeTextValue(q[E]);
            }
          }
          q = new CTATExampleTracerNode(F, new Set);
          "" !== y && q.setNodeName(y);
          y = q;
          c.addNode(y);
          1 == w && (c.setStartNode(y), c.setStudentStartsHereNode(y));
          y.getNodeName() == x && c.setStudentStartsHereNode(y);
          break;
        case "edge":
          c.addLink(a(C[z]));
          break;
        ...
        case "productionRule":
          ...
          y = void 0;
          for (var E = "unknown", q = void 0, F = null, A = g.getElementChildren(A), H = 0;H < A.length;H++) {
            var J = g.getElementName(A[H]);
            "ruleName" === J && (y = g.getNodeTextValue(A[H]), ctatdebug("ruleName=" + y));
            "productionSet" === J && (E = g.getNodeTextValue(A[H]), ctatdebug("productionSet=" + E));
            "label" === J && (q = g.getNodeTextValue(A[H]), ctatdebug("label=" + E));
            "description" === J && (F = g.getNodeTextValue(A[H]), ctatdebug("description=" + E));
          }
          E = new CTATExampleTracerSkill(E, y, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN, CTATExampleTracerSkill.DEFAULT_HISTORY);
          null != q ? E.setLabel(q) : E.setLabel(y);
          null != F ? E.setDescription(F) : E.setDescription(y);
          m.push(E);
      }
    }
    if (D) {
      w = g.getElementAttr(D, "ordered");
      ...
      l = c.getGroupModel();
      w = l.createIdToLinkMap();
      l.setGroupOrdered(l.getTopLevelGroup(), C);
      ...
      x = g.getElementChildren(x);
      for (C = 0;C < x.length;C++) {
        switch(g.getElementName(x[C])) {
          case "group":
            e(x[C], w);
            break;
          case "outOfOrderMessage":
            l.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(x[C]));
        }
      }
    }
    w = f.getSkillBarVector();
    if (!w || 1 > w.length) {
      ctatdebug("No existing skills. Add skills from BRD."), f.addGraphSkills(m), w = f.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, t, n, f.isFeedbackSuppressed(), B, G, w);
    c.redoLinkDepths();
    d = c.getExampleTracer();
    d.resetTracer();
    c.forDebugging();
    ctatdebug("Graph loaded.");
    return {gr:c, tracer:d, ssm:k, sgMsg:h};
  };
};
...
SCORMProblemSummary.getSessionTime = function(a) {
  ...
  a = b % 1E3;
  var b = (b - a) / 1E3, e = b / 60, f = e / 60, b = b % 60;
  9999 < f && (f = 9999, e = b = 99, a = 990);
  return sprintf("%04d:%02d:%02d.%02d", f, e, b, a / 10);
};
SCORMProblemSummary.getProblemSummaryElements = function(a) {
  var b = sprintf("<%s>%s</%s>", SCORMProblemSummary.LESSON_STATUS, SCORMProblemSummary.getLessonStatus(a), SCORMProblemSummary.LESSON_STATUS), e = sprintf("<%s>%d</%s>", SCORMProblemSummary.RAW_SCORE, SCORMProblemSummary.getRawScore(a), SCORMProblemSummary.RAW_SCORE), f = sprintf("<%s>%s</%s>", SCORMProblemSummary.EXIT, SCORMProblemSummary.getExitReason(a), SCORMProblemSummary.EXIT);
...
var CTATMessageTank = function(a, b) {
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (g && !(1 > g.length)) {
      e(a);
      n.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + g.length + ", transaction_id " + p);
      for (var l = [], x = [], t = 0;t < g.length;++t) {
        var B = g[t];
        if (B.msg) {
          var C = B.msgType, G = B.evt;
          n.ctatdebug("entering processInterfaceVariables() msgType " + C + ", evt " + G);
          C && (n.ctatdebug("entering processInterfaceVariables() et " + c + ", tracer " + (c ? c.getTracer() : null)), C = C.toLowerCase(), 0 !== C.indexOf("correct") && 0 !== C.indexOf("interfaceaction") || c.getTracer().addInterfaceVariablesFromEvent(G));
          if (!(C = f(B))) {
            var C = B, G = x, D = void 0, z = void 0;
            if (!(C && C.sai && (D = C.sai.getAction()) && (z = m.exec(D))) || 3 > z.length || 1 >= z[2]) {
              C = !1;
            } else {
              var y = G.length - 1, y = 0 > y ? null : G[y];
              C.msg = C.msg.replace(D, z[1]);
              y && y.timeout == z[2] ? y.msgTuples.push(C) : G.push({timeout:Number(z[2]), msgTuples:[C]});
              C = !0;
            }
          }
          C || l.push(B.msg);
      ...
      n.ctatdebug("flushMessageTank(): msgBundle.length " + l.length + ", delayedMsgsBundle.length " + x.length);
      for (t = 0;t < x.length;++t) {
        B = x[t], n.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + B.timeout + ", .msgTuples.length " + B.msgTuples.length), setTimeout(d, B.timeout, c, B.msgTuples);
      }
...
var CTATSkills = function(a) {
  ...
  this.updateSkill = function(a, b, h) {
    var k = null, l = d.getSkill(b);
    null !== l && "undefined" !== typeof l && (l.setTransactionNumber(e), b = h + " " + b, f.has(b) || (f.add(b), l.updatePKnown(a), l.updateHistory(a), l.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && f["delete"](b), k = l);
    return k;
  };
...
var CTATExampleTracer = function() {
  function a(a, c) {
    c ? J |= 1 << a : (J &= -65537 >> 16 - a, b());
  }
  function b() {
    m.ctatdebug("workTheQueue() working " + J + ", workQueue.length " + H.length + ", restoreQueue.length " + A.length);
    if (0 == J) {
      for (;0 != (J = 0 < H.length | (0 < A.length) << 1);) {
        var a = null, b = !1;
        0 < A.length ? (a = A.shift(), b = !0) : a = H.shift();
        if (!e(a, b)) {
          m.ctatdebug("workTheQueue() suspending workQueue.length " + H.length + ", restoreQueue.length " + A.length);
          m.stopWorking(b ? 1 : 0);
          break;
        }
        m.ctatdebug("workTheQueue() bottom workQueue.length " + H.length + ", restoreQueue.length " + A.length);
      }
    }
  }
  function e(a, b) {
    m.lastMessageAsString = a;
    var e = m.lastMessageAsXML = (new CTATXML).parseXML(a), g = m.lastMessage = new CTATMessage(e), h = g.getMessageType();
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && m.sendBundle([a]), d(a, g, t, e), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && m.sendBundle([a]), c(a, g, t, e), !0;
  ...
  function f(a, b, c, d) {
    m.ctatdebug("handleSetPreferences ()");
    I = !1;
    y = b.getProperty("problem_name");
    m.ctatdebug("SetPreferences.problem_name = " + y);
      ...
      if (d = c.getElementName(a[b]), m.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            for (var e = t.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = t.getElementAttr(e[f], "label"), k = t.getElementAttr(e[f], "pSlip"), l = t.getElementAttr(e[f], "description"), n = t.getElementAttr(e[f], "pKnown"), p = t.getElementAttr(e[f], "category"), r = t.getElementAttr(e[f], "pLearn"), w = t.getElementAttr(e[f], "pGuess"), x = t.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(p, h, w, n, k, r, x);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
          ...
          case "problem_state_status":
            ...
            F || (F = new ProblemStateRestorer(m));
            m.ctatdebug("SetPreferences problemStateRestorer " + F);
            break;
          ...
          case "restore_problem_url":
            ...
            break;
          case "session_id":
            M = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            q.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    m.ctatdebug("outputStatus " + E + ", problemStateRestorer " + F);
    a = u;
    m.ctatdebug("retrieveBRD (" + a.indexOf("data:file/brd;base64,") + ")");
    0 == a.indexOf("data:file/brd;base64,") && (m.ctatdebug("Found Base 64 encoded data in question file, decoding and processing ..."), c = a.substring(21), b = window.atob(c), b = (c = new CTATXML).parseXML(b), m.processXML(b));
    m.ctatdebug("Using network retrieval to obtain BRD ...");
    R.retrieveXMLFile(a, c, m);
    F && F.retrieveMessages(E);
  }
  function d(a, b, c, d) {
    b = b.getTransactionID();
    m.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    q.appendToProblemState(a, m.getOutputStatus(), !1);
    if (!I) {
      return !1;
    }
  ...
  function c(a, b, c, d) {
    ...
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (m.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), l(null, b.getSAI(), "student", !0, c, a)) : (m.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + C + ", errorSAI " + B), C === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : C !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (C === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? B && B.getSelection() ? (d.splice(1, 0, B.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : C === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && B && B.getSelection() && (d.splice(1, 0, B.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), m.startSkillTransaction(), a = [], d = r.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), e = d ? "" + d.getUniqueID() : 
    "", b.setStepID(e), m.updateSkills(CTATExampleTracerSkill.HINT, d ? d.getSkillNames() : [], e), m.ctatdebug("Before building hint message: tutorSAI " + b.getTutorSAI() + ", hints " + a + ", edge # " + e), d = (new CTATTutorMessageBuilder).createHintMessage(a, b.getTutorSAI(), e, c), m.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE, d, b, null), c = (new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a, b.getTutorSAI(), p(CTATMsgType.DEFAULT_STUDENT_ACTOR), m.getSkillBarVector(!0), 
    e, c), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, c, b, null), c = m.getProblemSummary(b.getReportableInterpretation()), m.messageTank.flushMessageTank(c, !0), m.ctatdebug("handleInterfaceAction() sent hint result " + b), B = null);
    return !0;
  }
  function g(a, b, c) {
  ...
  function l(a, b, c, d, e, f) {
    m.ctatdebug("doNewExampleTrace (link " + a + ", sai " + b + ", actor " + c + ", doTutorPerformedSteps " + d + ", transactionID " + e + ", origMsgTxt " + f);
    ...
    a ? (m.ctatdebug("result.getTutorSelection() " + k.getTutorSelection()), m.ctatdebug("result.getTutorAction() " + k.getTutorAction()), m.ctatdebug("result.getTutorInput() " + k.getTutorInput()), m.ctatdebug("typeof(messageTank) " + typeof messageTank), e = k.getTutorSelection(), f = k.getTutorAction(), l = k.getTutorInput(), (e = m.messageTank.enqueueToolActionToStudent(e, f, l, CTATTutorMessageBuilder.TUTOR_PERFORMED)) && m.messageTank.setTransaction_id(e)) : k.getResult() != CTATExampleTracerLink.CORRECT_ACTION && 
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || q.appendToProblemState(f, m.getOutputStatus(), !1);
    k.setTransactionID(e);
    m.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + d + ")");
    f = k.getStudentSAI();
    var l = k.getTutorSAI(), n = k.getTransactionID(), t = new CTATTutorMessageBuilder, u = "", w = [];
    null !== k.getReportableLink() && "undefined" !== typeof k.getReportableLink() ? w[0] = k.getReportableLink() : w[0] = null;
    var w = w[0], x = null;
    if (k.isSolverResult()) {
      k.getResult();
    } else {
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        u = w ? "" + w.getUniqueID() : "", k.setStepID(u), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, t.createCorrectActionMessage(n, l), k, l), null !== w && "undefined" !== typeof w && m.updateSkills(CTATExampleTracerSkill.CORRECT, w.getSkillNames(), w.getUniqueID()), u = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, t.createAssociatedRulesMessageForAction(k.getResult(), 
        l, p(c), f, m.getSkillBarVector(!0, c), w.getUniqueID(), n, u), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + u), u && m.messageTank.addToMessageTank("SuccessMessage", t.createSuccessMessage(n, u), k, null), B = null, d && (x = h(w ? w.getNextNode() : null, r.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x);
      } else {
        m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, t.createInCorrectActionMessage(n, k.getInterpolatedSAI()), k, null);
        m.ctatdebug("about to do silent traceForHint(" + f + "), selectionArray " + f.getSelectionArray());
        var y = m.lastSilentHintResult = new CTATExampleTracerEvent(m, f, c);
        y.setHintRequest(!0);
        x = r.traceForHint(y);
        m.ctatdebug("silent hint result: " + y + "; hintLink " + x);
        x || (x = r.getBestNextLink(!1, y), m.ctatdebug("getBestNextLink result: " + y + "; hintLink " + x));
        l = null;
        x && ((l = y.getTutorSAI()) && l.getSelection() && k.setTutorSAI(l), u = "" + x.getUniqueID(), k.setStepID(u));
        y = g(k, y, t);
        m.ctatdebug("createBuggyMessage() tutorAdvice: " + y.tutorAdvice + ";\n  msg " + y.msg);
        m.updateSkills(CTATExampleTracerSkill.INCORRECT, x ? x.getSkillNames() : [], u);
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, t.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : f, p(c), f, m.getSkillBarVector(!0, c), u, n, y.tutorAdvice), k, null);
        y.msg && m.messageTank.addToMessageTank(y.msgType, y.msg, k);
        B = f;
        d && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() ? (x = h(w ? w.getNextNode() : null, r.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x) : k.isDoneStepFailed() && m.messageTank.flushDelayedFeedback();
      }
    }
    m.lastResult = k;
    ...
    m.ctatdebug("finishNewExampleTrace() sent result " + k.getResult() + ", studentSAI " + f);
    m.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + d + ", " + e + ") returns " + k);
    return k;
  }
  function p(a) {
  ...
  var m = this, u = null, r, w, x, t = new CTATXML;
  new XMLSerializer;
  var B = null, C, G = !0, D = !1, z = null, y = null, q = new ProblemStateSaver(m);
  q.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var F = null, E = new CTATProblemStateStatus, A = [], H = [], J = 0, I = !1, M = "", O = null;
  m.ctatdebug("CTATExampleTracer constructor outputStatus=" + E);
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      ...
      a = c.ssm;
      var d = c.sgMsg;
      m.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + E);
      for (var c = [], e = new XMLSerializer, f = null, g = 0;g < a.length;g++) {
        if ("message" == t.getElementName(a[g])) {
          ...
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || m.setVariablesFromSAI(a[g], t);
          CTATMsgType.START_STATE_END == l && (f = c, x.getFeedbackPolicy() != CTATMsgType.SHOW_ALL_FEEDBACK && (l = new CTATSAI("hint", "SetVisible", "false"), l = (new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID", l), f.push(l)), f = k, c.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()));
          c.push(k);
        }
      }
      d = c.unshift(d);
      f && (e = new CTATTutorMessageBuilder, c.splice(d, 0, e.createLockWidgetMsg(b.getLockWidget())));
      m.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + E);
      m.sendBundle(c);
      b = [];
      a = x.getStartNode();
      c = x.getStudentStartsHereNode();
      null !== a && null !== c && a.getNodeID() != c.getNodeID() && (b = x.getBestSubpath(a, c), m.ctatdebug("advanceToStudentStartsHere() path " + b), b = b.getSortedLinks(), b = m.traceLinks(b), m.ctatdebug("advanceToStudentStartsHere() results " + b));
      c = a = null;
      ...
      h(a, r.findCurrentState(!1, !1), null, c);
      E.isIncomplete() || (b = [], b.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END, null)), m.sendBundle([b]));
      I = !0;
    }
    m.startWorking(0);
  };
  ...
  this.sendBundle = function(a) {
    m.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + E);
    for (var b = 0, c = 0;c < a.length;c++) {
      m.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      q.forwardToInterface(d, c >= a.length - 1, E) && ++b;
    }
    return 0 < b;
  };
  ...
  this.getProblemSummary = function(a) {
    m.ctatdebug("Entering getProblemSummary() problemSummary " + z);
    if (null === z || "undefined" === typeof z) {
      var b = m.getProblemName();
      z = null === b || "undefined" === typeof b || 1 > b.length ? new CTATProblemSummary("NoProblemDefined", null, m.isFeedbackSuppressed()) : new CTATProblemSummary(b, null, m.isFeedbackSuppressed());
    }
    a && z.setRequiredSteps(a.countStepsForScore(x));
    return z;
  };
  ...
  this.setFeedbackSuppressed = function(a) {
    D = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : !1;
    m.ctatdebug("setFeedbackSuppressed(" + a + "): " + D);
    z && z.setCountOnlyLastResults(D);
  };
  ...
  this.getFeedbackPolicy = function() {
    return x ? x.getFeedbackPolicy() : CTATMsgType.SHOW_ALL_FEEDBACK;
  };
