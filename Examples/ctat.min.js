...
var jstz = function() {
  ...
  "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, b = function(a) {
    ...
    return 864E5 === b ? l(f, 36E5, 6E4) : 36E5 === b ? l(f, 6E4, 1E3) : f;
  }, c = function(a, b, c, g) {
    if ("N/A" !== c) {
      return c;
    }
    ...
    for (var e = {}, f = jstz.olson.dst_rules.zones, d = f.length, h = a[g], w = 0;w < d;w++) {
      ...
      for (var B = 0, C = 0;C < b.length;C++) {
        if (r.rules[C] && b[C]) {
          if (b[C].s >= r.rules[C].s && b[C].e <= r.rules[C].e) {
            B = 0, B += Math.abs(b[C].s - r.rules[C].s), B += Math.abs(r.rules[C].e - b[C].e);
          } else {
            B = "N/A";
            break;
          }
    ...
    for (var G in e) {
      if (e.hasOwnProperty(G) && -1 != h.indexOf(G)) {
        return G;
      }
    }
    return g;
...
(function(a, b) {
  ...
  function f(a, b, c, g) {
    ...
    var f = n.substring(0, n.indexOf("Animation")).toLowerCase();
    p[e] || (m.insertRule("@" + (f && "-" + f + "-" || "") + "keyframes " + e + "{0%{opacity:" + g + "}" + c + "%{opacity:" + a + "}" + (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + g + "}}", m.cssRules.length), p[e] = 1);
    return e;
  }
  function e(a, b) {
    var c = a.style, g, e;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, e) {
      ...
      function h(a, l, m) {
        b(p, b(d(f(), {rotation:360 / e.lines * a + "deg", left:~~l}), b(d(c("roundrect", {arcsize:e.corners}), {width:k, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:m}), c("fill", {color:g(e.color, a), opacity:e.opacity}), c("stroke", {opacity:0}))));
      }
      var k = e.scale * (e.length + e.width), l = 2 * e.scale * k, m = -(e.width + e.length) * e.scale * 2 + "px", p = d(f(), {position:"absolute", top:m, left:m});
      if (e.shadow) {
        for (m = 1;m <= e.lines;m++) {
  ...
  var l = ["webkit", "Moz", "ms", "O"], p = {}, n, m, t = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  c(h.prototype, {spin:function(b) {
    ...
    c.lines(e, c.opts);
    if (!n) {
      var f = 0, h = (g.lines - 1) * (1 - g.direction) / 2, k, l = g.fps, m = l / g.speed, p = (1 - g.opacity) / (m * g.trail / 100), t = m / g.lines;
      (function A() {
        f++;
        for (var a = 0;a < g.lines;a++) {
          k = Math.max(1 - (f + (g.lines - a) * t) % m * p, g.opacity), c.opacity(e, a * g.direction + h, k, g);
        }
    ...
    function h(b, c) {
      return d(a(), {position:"absolute", width:e.scale * (e.length + e.width) + "px", height:e.scale * e.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / e.lines * k + e.rotate) + "deg) translate(" + e.scale * e.radius + "px,0)", borderRadius:(e.corners * e.scale * e.width >> 1) + "px"});
    }
    for (var k = 0, l = (e.lines - 1) * (1 - e.direction) / 2, m;k < e.lines;k++) {
      m = d(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:n && f(e.opacity, e.trail, l + k * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(m, d(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(m, h(g(e.color, k), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
...
var CTATBase = function(a, b) {
  ...
  this.ctatdebugInternal = function(a, b) {
    var g = a, e = "No msg assigned yet";
    if (null === g || void 0 === g) {
      g = "No message!";
    }
    "" === g && (g = "Empty message!");
    if (useDebuggingBasic) {
      e = f("Unknown", "undefined", g), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += e + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(e);
    } else {
...
var CTATSAI = function(a, b, f, e) {
  ...
  var c = "undefined", g = "undefined", h = new CTATStringUtil, k = [], l = [], p = [], n = [], m = [], t = [], u, w = this;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == u.getElementName(g) || "value" == u.getElementName(g) || "Input" == u.getElementName(g)) {
        var b = u.getElementChildren(g), h = null;
        k = [];
        ...
        for (var l = 0;l < b.length;l++) {
          var m = b[l];
          "value" == u.getElementName(m) && (h = u.getElementChildren(m), null !== h ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = e.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = e.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(m.attributes.getNamedItem("name").value), f.setType(m.attributes.getNamedItem("type").value), 
          f.setFormat(m.attributes.getNamedItem("format").value), d++), 1 > l ? this.setInputArray(h) : this.appendToInputArray(h)) : (m = e.htmlDecode(u.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), f.setValue(m), 1 > l ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == u.getElementName(g) || "Input" == u.getElementName(g)) {
        b = g.childNodes;
        k = [];
        var e = new CTATHTMLManager, f = new CTATArgument, d = 0, h = null;
        k.push(f);
        for (var l = 0;l < b.length;l++) {
          if (h = b[l], "value" == u.getElementName(h)) {
            var m = u.getElementChildren(h);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (h = e.htmlDecode(u.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = e.htmlDecode(u.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(u.getElementAttr("name")), f.setType(u.getElementAttr("type")), f.setFormat(u.getElementAttr("format")), d++)) : (h = e.htmlDecode(u.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + 
            h), f.setValue(h));
  ...
  var x = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(f) || null == f) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(f), x = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == f ? null : f[0], "String", e);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, f, "String", e), x || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(f) ? f : [f]), x = !0));
};
...
var CTATSkill = function() {
  ...
  var a = "", b = "", f = "", e = "", d = 0, c = "", g = !1, h = "", k = "", l = "", p = "", n = "";
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    return g += '" pKnown="' + l + '" category="' + f + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" history="' + n + '" />';
  };
...
var CTATSkillSet = function() {
      ...
      if (b = b.childNodes) {
        for (var f = 0;f < b.length;f++) {
          ...
          if ("Skill" == e.nodeName || "skill" == e.nodeName) {
            ...
            if (d = d ? d.value : "") {
              var c = e.attributes.getNamedItem("pKnown"), c = c ? c.value : "", g = e.attributes.getNamedItem("description"), g = g ? g.value : "", h = e.attributes.getNamedItem("label"), h = h ? h.value : "", k = e.attributes.getNamedItem("category"), k = k ? k.value : "", l = e.attributes.getNamedItem("pGuess"), l = l ? l.value : "", p = e.attributes.getNamedItem("pLearn"), p = p ? p.value : "", n = e.attributes.getNamedItem("pSlip"), n = n ? n.value : "", e = (e = e.attributes.getNamedItem("history")) ? 
              e.value : "";
              this.addSkill(d, c, .95, g, h, k, l, p, n, e);
            }
          }
        }
      } else {
  ...
  this.addSkill = function(a, f, e, d, c, g, h, k, l, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + f + " mastery = " + e + " aDescription = " + d + " adisplayName = " + c + " aCategory = " + g + " pguess= " + h + " plearn = " + k + " pslip = " + l + " history = " + p);
...
var CTATMessage = function(a) {
  ...
  var d = "ungraded", c = !1, g = !1, h = new CTATSkillSet, k = "", l = "", p = "", n = "", m = "", t = null, u = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      "tool_message" == e.getElementName(b) ? (this.ctatdebug("Detected tool message"), k = "tool_message") : "message" != e.getElementName(b) ? (this.ctatdebug("Detected log message"), c = !0, k = e.getElementName(b)) : (this.ctatdebug("Detected regular message"), c = !1, this.parseMessageType());
    ...
    if ("tool_message" == k) {
      ...
      for (d = 0;d < a.length;d++) {
        if (f = a[d], "tool_message" == e.getElementName(f)) {
          for (f = e.getElementChildren(f), l = 0;l < f.length;l++) {
            u = f[l], "event_descriptor" == e.getElementName(u) && (t = new CTATSAI, t.fromXMLInternal(u));
          }
        }
      }
      g = !0;
      ...
      if (c) {
        ...
        for (var z = e.getElementChildren(b), y = 0;y < z.length;y++) {
          var q = z[y];
          if ("event_descriptor" == e.getElementName(q)) {
            for (var q = e.getElementChildren(q), F = 0;F < q.length;F++) {
              var E = q[F];
              "selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), u.push(E));
              "action" == e.getElementName(E) && (d = e.getNodeTextValue(E), G.push(E));
              "input" == e.getElementName(E) && (f = e.getNodeTextValue(E), D.push(E));
              "prompt" == e.getElementName(E) && (l = e.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), z = e.getElementChildren(b), y = 0;y < z.length;y++) {
          if (q = z[y], "properties" == e.getElementName(q)) {
            for (q = e.getElementChildren(q), F = 0;F < q.length;F++) {
              E = q[F], this.ctatdebug("Nodename: " + e.getElementName(E)), "Skills" == e.getElementName(E) && h.parseByValue(E), "SuccessMsg" == e.getElementName(E) && (p = a = e.getNodeTextValue(E)), "BuggyMsg" == e.getElementName(E) && (n = e.getNodeTextValue(E)), "Selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), u.push(E)), "Action" == e.getElementName(E) && (d = e.getNodeTextValue(E), G.push(E)), "Input" == e.getElementName(E) && (f = e.getNodeTextValue(E), D.push(E)), "prompt" == 
              e.getElementName(E) && (l = e.getNodeTextValue(E)), "HighlightMsgText" == e.getElementName(E) && (m = e.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + d + "," + f);
      "" !== a && null !== a ? (t = new CTATSAI(a, d, f, l), t.setArrayFromElements(u), t.setArrayFromElements(G), t.setArrayFromElements(D), g = !0) : (this.ctatdebug("No SAI found"), g = !1);
      this.ctatdebug("parseSAI () done, hassai: " + g + ", (" + a + "," + d + "," + f + "," + l + ")");
    }
  };
    ...
    for (var a = e.getElementChildren(b), c = 0;c < a.length;c++) {
      ...
      if ("properties" == e.getElementName(g)) {
        for (var g = e.getElementChildren(g), d = 0;d < g.length;d++) {
          var f = g[d];
          "MessageType" == e.getElementName(f) && (k = e.getNodeTextValue(f));
        }
      }
    }
  ...
  this.getSAI = function() {
    return g ? t : new CTATSAI;
  };
  this.getSelection = function() {
    return g ? t.getSelection() : "";
  };
  this.getAction = function() {
    return g ? t.getAction() : "";
  };
  this.getInput = function() {
    return g ? t.getInput() : "";
  };
  this.getSelectionArray = function() {
    return g ? t.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return g ? t.getActionArray() : [];
  };
  this.getInputArray = function() {
    return g ? t.getInputArray() : [];
  };
...
var CTATCompBase = function(a, b, f, e, d, c) {
  ...
  var g = f || 0, h = e || 0, k = d || -2, l = c || -2, p = 50, n = 25, m = !1, t = !1, u = "", w = !1, x = !0, r = null, B = "", C = null;
  ...
  this.makeDivWrapper = function(a) {
    ...
    r.setAttribute("data-ctat-component", this.getClassName());
    r.style.position = "absolute";
    r.style.left = g + "px";
    r.style.top = h + "px";
    r.style.zIndex = E;
    r.style.width = y.getWidth() + "px";
    r.style.height = y.getHeight() + "px";
    $(r).data("CTATComponent", this);
    a.appendChild(r);
  };
  ...
  this.setClassName = function(a) {
    I(a);
    r && r.setAttribute("data-ctat-component", this.getClassName());
  };
  ...
  this.createCanvas = function() {
    ...
    r.firstChild ? r.insertBefore(q, r.firstChild) : r.appendChild(q);
    return q;
  };
  this.redraw = function() {
    var a = r.style.display;
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      D ? a = window.getComputedStyle(D) : r && (a = window.getComputedStyle(r));
      if (a) {
  ...
  this.move = function(a, b) {
    g = a;
    h = b;
    r && (r.style.left = g + "px", r.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    r.style.visibility = !0 === a ? null : "hidden";
  };
  ...
  this.processTabOrder = function() {
    ...
    !0 === m ? y.ctatdebug("Component is an abstract component, bump") : D ? (y.ctatdebug("We have a component, actually assigning to html component ..."), null !== C && (D.tabIndex = C), D.onfocus = y.processOnFocus) : y.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
...
var CTATCSS = function() {
  ...
  this.addCSSAttribute = function(c, e) {
    b[a] = c;
    b[a + 1] = e;
    a += 2;
  };
  ...
  this.toCSSString = function() {
    for (var a = "", d = 0;d < e.length;d++) {
      for (var a = a + (e[d][0] + " { "), f = 1;f < e[d].length;f++) {
        a += e[d][f], a = 0 === f % 2 ? a + "; " : a + ": ";
      }
      a += " }; ";
    }
...
CTAT.Component.Base.Graphical = function(a, b, f, e, d, c, g) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", p = 1, n = CTATGlobals.Visual.BorderColor, m = !1, t = "solid", u = 0, w = "1px", x = 0, r = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, G = CTATGlobals.Font.size, D = !1, z = !1, y = !1;
  ...
  this.getBorderStyle = function() {
    return this.component ? $(this.component).css("border-style") : t;
  };
  this.setBorderStyle = function(a) {
    t = a;
    this.component && this.getBorderStyle() !== t && (this.component.style.borderStyle = t);
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== m && (m ? (this.setBorderStyle(t), this.setBorderWidth(w)) : this.setBorderStyle("none"));
    return this;
  };
...
CTAT.Component.Base.Tutorable = function(a, b, f, e, d, c, g) {
  ...
  var h = !0, k = !0, l = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, m = this, t = !1;
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (u) {
      ...
      c !== t && (t = c, this.showHintHighlight(c, b));
    }
  };
...
var CTATRadioButton = function(a, b, f, e, d) {
  ...
  this.showCorrect = function(a) {
    t("CTAT--hint");
    t("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? m("CTAT--correct") : t("CTAT-correct");
  };
  this.removeCorrect = function() {
    t("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    t("CTAT--hint");
    t("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? m("CTAT--incorrect") : t("CTAT-incorrect");
  };
  this.removeInCorrect = t.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? m("CTAT--hint") : t("CTAT--hint");
  };
};
...
var CTATImageButtonComponent = function(a, b, f, e, d, c, g) {
  CTATButtonBasedComponent.call(this, a, b, f, e, d, c, g);
  var h = "", k = "", l = "", p = "", n = !1, m = "Image to Component", t = this;
  ...
  this.assignImages = function(a, b, c, g) {
    t.ctatdebug("assignImages ()");
    h = a;
    k = b;
    l = c;
    p = g;
    null !== t.getComponent() && t.assignActiveImage(h);
  };
  this.assignImageURL = function(a) {
    this.assignImages(a, a, a, a);
  };
  this.assignActiveImage = function(a) {
    if (null !== t.getComponent() && (t.getComponent().src = a, t.getComponent().style.opacity = this.getTransparencyValue(), "Component to Image" == m)) {
      var b = new Image;
      b.src = a;
      t.setWidth(b.width);
  ...
  this.setEnabled = function(a) {
    t.ctatdebug("setEnabled (" + a + ")");
    t.assignEnabled(a);
    null === t.getComponent() ? t.ctatdebug("Error: pointer is null!") : (t.getComponent().disabled = !a, !1 === t.getEnabled() ? t.assignActiveImage(p) : t.assignActiveImage(h), t.ctatdebug("setEnabled () -> " + t.getEnabled()));
  };
  this.processMouseOver = function(a) {
    !0 !== n && (n = !0, !0 === t.getEnabled() ? t.assignActiveImage(l) : t.ctatdebug("Error component is disabled"), n = !1);
  };
  this.processMouseOut = function(a) {
    !0 !== n && (n = !0, !0 === t.getEnabled() && t.assignActiveImage(h), n = !1);
  };
};
...
var CTATImageButton = function(a, b, f, e, d) {
  CTATImageButtonComponent.call(this, "CTATImageButton", "__undefined__", a, b, f, e, d);
...
var CTATJumble = function(a, b, f, e, d) {
  ...
  this.init = function() {
    ...
    a ? (n.innerHTML = a, $(n).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      this.addEventListener("dragstart", t, !1);
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var c = a.length, g = 0;g < c;g++) {
        ...
        e.addEventListener("dragstart", t, !1);
        e.addEventListener("dragenter", w, !1);
        e.addEventListener("dragover", u, !1);
        e.addEventListener("dragleave", x, !1);
        e.addEventListener("drop", r, !1);
        e.addEventListener("dragend", C, !1);
        b.appendChild(e);
        B.push(e);
      }
      n.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = n.children, b = [], g = 0;g < a.length;g++) {
      var e = a[g];
      e.draggable && (e.id ? b.push(e.id) : console.log("ERROR: The CTATJumble " + p.getName() + " has a child with no id attribute: " + e + "!!!"));
    }
    return c = b.join(";");
  };
  this.updateSAI = function() {
...
var CTATGraphicsTools = function(a, b, f, e, d, c) {
  ...
  var g = b || 1, h = f || "#000000", k = e || "#EEEEEE", l = d || !1, p = "Arial", n = a || null;
  a = c || !1;
  var m = 0, t = this;
  if (null == n) {
    return t.ctatdebug("--- Error: Must pass a canvas context. ---"), -1;
  }
  0 == a && (m = .5);
  ...
  this.drawLine = function(a, b, c, g, e, d) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawLine");
    a += m;
    c += m;
    b += m;
    g += m;
  ...
  this.drawCircle = function(a, b, c) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawCircle");
    a += m;
    b += m;
    n.strokeStyle = h;
    n.lineWidth = g;
  ...
  this.drawCircleFilled = function(a, b, c) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawCircleFilled");
    a += m;
    b += m;
    n.fillStyle = k;
    n.beginPath();
  ...
  this.drawRectangle = function(a, b, c, e) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangle");
    a += m;
    b += m;
    n.lineWidth = g;
    1 == l ? (n.fillStyle = k, n.fillRect(a, b, c, e)) : (n.strokeStyle = h, n.beginPath(), n.rect(a, b, c, e), n.stroke());
  };
  this.drawRectangleFilled = function(a, b, c, g) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangleFilled");
    a += m;
    b += m;
    n.fillStyle = k;
    n.fillRect(a, b, c, g);
  ...
  this.drawRoundedRect = function(a, b, c, e, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = g, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + e - d), n.quadraticCurveTo(a, b + e, a + d, b + e), n.lineTo(a + c - d, b + e), n.quadraticCurveTo(a + c, b + e, a + c, b + e - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, c, e, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = g, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + e - d), n.quadraticCurveTo(a, b + e, a + d, b + e), n.lineTo(a + c - d, b + e), n.quadraticCurveTo(a + c, b + e, a + c, b + e - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke(), n.fillStyle = k, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + e - d), n.quadraticCurveTo(a, b + e, a + d, b + e), n.lineTo(a + 
    c - d, b + e), n.quadraticCurveTo(a + c, b + e, a + c, b + e - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.fill());
  };
  ...
  this.drawTextFormatted = function(a, b, c, g, e, d, f, h, k, l) {
    if (null != n) {
      a += m;
      b += m;
      g = "";
  ...
  this.drawTriangle = function(a, b, c, e, d, f) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangle");
    a += m;
    c += m;
    d += m;
    b += m;
  ...
  this.drawTriangleFilled = function(a, b, c, e, d, f) {
    null == n && t.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangleFilled");
    a += m;
    c += m;
    d += m;
    b += m;
...
var CTATShape = function(a, b, f, e, d, c) {
  ...
  var h = [], k = [], l = d, p = c, n = b, m = void 0, t = "black", u = "black", w = "Arial", x = 12, r = [], B = 1, C = 5, G = document.createElement("canvas");
  G.id = n;
  G.width = l;
  G.height = p;
  var D = new CTATCSS;
  D.addCSSAttribute("position", "absolute");
  D.addCSSAttribute("left", f + "px");
  D.addCSSAttribute("top", e + "px");
  ...
  this.drawLine = function() {
    z.drawLine(h[0] + B, k[0] + B, h[1], k[1], t, B);
  };
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == g && (g = !1, getSafeElementById(ctatcontainer).removeChild(t)) : 1 == warnScrim && (g = !0), w.scrimUp(a));
  }
  function f(a, b) {
  ...
  var e = "", d = !1, c = !1, g = !1, h = null, k = null, l = new CTATCanvasComponent("CTAT Scrim"), p = [], n = null, m = null, t = null, u = null, w = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (w.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), w.ctatdebug("Message: " + b), 1 == scrimIsUp ? (e = 1 == waitScrim ? b : e + (" \n " + b), l.removeComponent()) : (e = b, scrimIsUp = !0), w.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        w.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + e + "<br><br></div></div></div>"), !0 === g && (t = f(a, "close"), $(t).appendTo("#scrimpanel")), !0 === d && (n = f(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (m = f(k, "no"), $(m).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
  ...
  this.setInAuthorTime = function(a) {
    ...
    inAuthorTime = a;
    if (!a) {
      warnScrim = errorScrim = !1, g && null.removeChild(t);
    } else {
...
var CTATWSConnection = function(a) {
  ...
  var b = "", f = !1, e = this, d = null, c = [], g = !1, h = 0, k = 0, l = null, p = null;
  e.setSocketType("ws");
  this.setConsumed = function(a) {
    f = a;
  ...
  this.init = function() {
    ...
    null == d && (d = new WebSocket(e.getURL()), d.addEventListener("open", function(a) {
      ...
      k = (new Date).getTime();
      e.ctatdebug("STATUS: message after " + (k - h) + " ms");
      e.ctatdebug("Received: " + a.data);
      l ? l(a.data) : e.ctatdebug("Error: no processing function provided");
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var f = authenticityToken = "", e = 0, d = [], c = a ? a : null, g = null == b ? !0 : b, h = !0, k = null, l = this, p = "http";
  ...
  this.getURL = function() {
    l.ctatdebug("getURL ()");
    if ("" != f) {
      return l.ctatdebug("Returning fixedURL: " + f), f;
    }
  ...
  this.processReply = function(a) {
    ...
    for (var f = 0, f = 0;f < d.length;f++) {
      var h = d[f], p = h.getHTTPObject();
      l.ctatdebug("Testing connection entry " + f + ", readyState: " + p.readyState + ", testConnection.consumed: " + h.getConsumed());
      4 == p.readyState && 0 == h.getConsumed() ? (l.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), e = !1, 0 === p.status && (e = !0, l.ctatdebug("Received message (status 0): " + p.responseText)), 408 == p.status && (e = !0, l.ctatdebug("Received message (status 408): " + p.responseText), g && CTATScrim.scrim.scrimDown()), 502 == p.status && (e = !0, l.ctatdebug("Received message (status 502): " + p.responseText), g && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == p.status ? (e = !0, l.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != k && k.processIncoming(p.responseText)) : l.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (e = !0, l.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, p.responseText)), !1 === e && l.ctatdebug("Error: status not handled for: " + p.status), l.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : 
    ...
    for (b = 0;b < a.length;b++) {
      e = a[b], -1 != e.indexOf("status=success") ? l.ctatdebug("Info: logging success message received, not propagating to message handler") : (l.ctatdebug("Processing incoming message: " + e), c.processMessage(e));
    }
  };
  ...
  this.retrieveXMLFile = function(a, b, c) {
    ...
    g.onreadystatechange = function() {
      ...
      if (4 == g.readyState && 200 == g.status) {
        var e = null;
        g.responseXML ? (l.ctatdebug("parsing brd xml using something else"), e = g.responseXML.documentElement) : (l.ctatdebug("parsing brd xml using node"), e = (b = new CTATXML).parseXML(g.responseText));
        null == e ? (e = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), l.ctatdebug("Error parsing xmlFile " + a + ": " + e), CTAT.ToolTutor.sendToInterface(e, !0)) : c.processXML(e);
      }
    };
    g.onerror = function() {
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createInterfaceDescriptionMessage = function(a, b, f) {
    ...
    a += "<serialized>";
    a += '<NotCommShell name="nothing" x="0" y="0" width="' + b + '" height="' + f + '"></NotCommShell>';
    a += "</serialized>";
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    f += "<CommShellVersion>" + a + "</CommShellVersion>";
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    if (null != b && null != f) {
      ...
      for (var d = "<dataset>" + ("<name>" + c.dataset_name + "</name>"), k = 0;k < b.length;k++) {
        a.ctatdebug("Adding ..."), d += '<level type="' + b[k] + '">', d += "<name>" + f[k] + "</name>";
      }
      d += "<problem ";
    ...
    if (0 < b.length) {
      for (k = 0;k < b.length;k++) {
        c += "<condition><name>" + b[k] + "</name>", c += "" == d[k] ? "" : "<type>" + d[k] + "</type>", c += "" == f[k] ? "" : "<desc>" + f[k] + "</desc>", c += "</condition>";
      }
    }
  ...
  this.createSemanticEventToolMessage = function(e, d, c, g, h) {
    ...
    g = "<event_descriptor>";
    e = e.toXMLString(!0);
    g = g + e + "</event_descriptor>";
    l += g;
    l += this.createCustomFields(b, f);
    l += "</tool_message>";
  ...
  this.createUIEventToolMessage = function(e, d, c, g) {
    ...
    k += this.createCustomFields(b, f);
    k += "</tool_message>";
    a.ctatdebug("messageString = " + k);
    return k;
  };
  this.createTutorMessage = function(e, d, c, g, h, k, l, p) {
  ...
  this.translateFromCTAT = function(f, e) {
    ...
    if (-1 != d.indexOf(".r")) {
      ...
      if (0 >= c.length) {
        ...
        return g = c[1], c = c[0].substr(1), b.ctatdebug("Original row (1st format): " + c + " original col: " + g), g = !0 === e ? colName(g, !1) + c : h[0] + "." + colName(g, !1) + c, b.ctatdebug("Translated: " + g), g;
      }
    } else {
      if (0 === d.indexOf("r")) {
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, f = !0, e = !1, d = !1, c = [], g = "undefined", h = "undefined", k = "undefined", l = "undefined", p = "undefined", n = "undefined", m = "undefined", t = "undefined", u = "UnassignedDataset", w = "UnassignedLevelName", x = "UnassignedLevelType", t = (new CTATGuid).guid();
  ...
  this.logSemanticEvent = function(a, c, g, e, d, f) {
    b.ctatdebug("logSemanticEvent ()");
    b.initCheck();
    var h = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(d, f);
    commLogMessageBuilder.addCustomField("tool_event_time", commLogMessageBuilder.formatTimeStamp(h) + " UTC");
    a = commLogMessageBuilder.createSemanticEventToolMessage(c, a, g, e, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, c, g, e, d, f, h, k, p) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var l = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(k, p);
    ...
    a = commLogMessageBuilder.createTutorMessage(c, a, g, d, k, e, h, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATMessageHandler = function() {
  ...
  this.processSingleMessage = function(c) {
    ...
    for (var k = 0;k < c.length;k++) {
      ...
      if ("properties" == e.getElementName(l)) {
        ...
        for (var p = e.getElementChildren(l), n = 0;n < p.length;n++) {
          var m = p[n];
          if ("MessageType" == e.getElementName(m)) {
            ...
            "CorrectAction" == m && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? f.push(h) : a.processCorrectAction(h), commShell.propagateShellEvent("CorrectAction", h));
            "InCorrectAction" == m && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? f.push(h) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(h)), commShell.propagateShellEvent("InCorrectAction", h));
            ...
            if ("AssociatedRules" == m) {
              ...
              for (var t = "", u = "", w = 0;w < p.length;w++) {
                var x = p[w];
                "TutorAdvice" == e.getElementName(x) && (t = e.getNodeTextValue(x));
                "Actor" == e.getElementName(x) && e.getNodeTextValue(x);
                "Indicator" == e.getElementName(x) && (u = e.getNodeTextValue(x));
                "StepID" == e.getElementName(x) && e.getNodeTextValue(x);
                "LogAsResult" == e.getElementName(x) && e.getNodeTextValue(x);
                "tool_selection" == e.getElementName(x) && e.getNodeTextValue(x);
                "Skills" == e.getElementName(x) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(x));
              }
              a.processAssociatedRules(h, u, t);
            ...
            "InterfaceAction" == m && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), f.push(h)) : a.processInterfaceAction(h), commShell.propagateShellEvent("InterfaceAction", h));
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (w = 0;w < p.length;w++) {
                if (x = p[w], "HintsMessage" == e.getElementName(x)) {
                  for (var x = e.getElementChildren(x), r = 0;r < x.length;r++) {
                    var B = x[r];
                    "value" == e.getElementName(B) && (u.push(e.getNodeTextValue(B)), t = !0);
                  }
                }
              }
              !0 === t ? a.processHintResponse(h, u) : b.ctatdebug("Error: incomplete hint message received");
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", d = "Unknown", f = null, p = 0;p < a.length;p++) {
      var n = a[p];
      ...
      "CommName" == e.getElementName(n) && (b.ctatdebug("Instance name: " + e.getNodeTextValue(n)), d = e.getNodeTextValue(n));
  ...
  this.deserializeComponent = function(a, c, d) {
    ...
    if (1 == ignoreInterfaceDescriptions) {
      ...
      if (null === e.getElementAttr(d, "x")) {
        ...
        var f = e.getElementAttr(d, "x"), p = e.getElementAttr(d, "y"), n = e.getElementAttr(d, "width"), m = e.getElementAttr(d, "height"), t = e.getElementAttr(d, "tabIndex"), u = e.getElementAttr(d, "zIndex");
        null === t && (t = -1);
        null === u && (u = 0);
        ...
        for (f = 0;f < d.length;f++) {
          p = d[f];
          e.getElementName(p);
          if ("Parameters" == e.getElementName(p)) {
            for (this.ctatdebug("Processing component parameters ..."), n = e.getElementChildren(p)[0], n = e.getElementChildren(n), m = 0;m < n.length;m++) {
              var x = n[m];
              if ("CTATComponentParameter" == e.getElementName(x)) {
                this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
                for (var u = t = void 0, x = e.getElementChildren(x), r = 0;r < x.length;r++) {
                  var B = x[r];
                  "name" == e.getElementName(B) && (this.ctatdebug("Found parameter name: " + e.getNodeTextValue(B)), t = e.getNodeTextValue(B));
                  "value" == e.getElementName(B) && (this.ctatdebug("Found parameter value: " + e.getNodeTextValue(B)), u = e.getNodeTextValue(B).trim());
                }
                this.ctatdebug("Parameter name: " + t + ", value: " + u);
                void 0 !== t && (w.params[t] = u, "group" == t && (w.groupName = u));
              }
            }
          }
          if ("Styles" == e.getElementName(p)) {
            for (this.ctatdebug("Processing component styles ..."), p = e.getElementChildren(p)[0], p = e.getElementChildren(p), n = 0;n < p.length;n++) {
              if (u = p[n], "CTATStyleProperty" == e.getElementName(u)) {
                this.ctatdebug("Processing style property (CTATStyleProperty) ...");
                t = m = "";
                u = e.getElementChildren(u);
                for (x = 0;x < u.length;x++) {
                  r = u[x], "name" == e.getElementName(r) && (m = e.getNodeTextValue(r)), "value" == e.getElementName(r) && (t = e.getNodeTextValue(r).trim());
                }
...
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, f, e) {
  ...
  f += "<transaction_id>" + e + "</transaction_id>";
  return f += "</properties></message>";
};
CTATTutorMessageBuilder.prototype.createErrorMessage = function(a, b) {
  var f;
  f = "<message><verb>SendNoteProperty</verb><properties><MessageType>TutoringServiceError</MessageType><ErrorType>" + (a ? a : "Unknown Error") + "</ErrorType><Details>";
  f += b ? b : "";
  return f += "</Details></properties></message>";
};
CTATTutorMessageBuilder.prototype.createSuccessMessage = function(a, b) {
  var f;
  f = "<message><verb>SendNoteProperty</verb><properties><MessageType>SuccessMessage</MessageType>" + ("<SuccessMsg><![CDATA[" + b + "]]\x3e</SuccessMsg>") + ("<transaction_id>" + a + "</transaction_id>");
  f += "<end_of_transaction>true</end_of_transaction>";
  return f += "</properties></message>";
};
CTATTutorMessageBuilder.prototype.createBuggyMessage = function(a, b) {
  var f;
  f = "<message><verb>SendNoteProperty</verb><properties><MessageType>BuggyMessage</MessageType>" + ("<BuggyMsg><![CDATA[" + b + "]]\x3e</BuggyMsg>") + ("<transaction_id>" + a + "</transaction_id>");
  f += "<end_of_transaction>true</end_of_transaction>";
  return f += "</properties></message>";
};
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, f, e) {
  a = "<message><verb>SendNoteProperty</verb><properties><MessageType>HighlightMsg</MessageType>" + ("<HighlightMsgText>" + f + "</HighlightMsgText>") + ("<Selection><value>" + a + "</value></Selection>");
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, f = null, e = null, d = {}, c = null, g = null, h = null, k = null, l = [], e = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.processComponentAction = function(a, c, g, d) {
    ...
    var e = "", e = !1 !== c ? d.createInterfaceActionMessage(g, a) : d.createUntutoredActionMessage(g, a);
  ...
  this.processAssociatedRules = function(a, c, g) {
    ...
    console.log("processAssociatedRules(" + a + ")");
    if (0 == commMessageHandler.getInStartState()) {
      logHintSAI = a.getSAI();
      var d = "", e = new CTATActionEvaluationData("");
      b.ctatdebug("Found tutor advice: " + g);
      "Hint" == c || "HintWindow" == c ? (ctatdebug("Preparing log message to indicate a hint response", "commShell"), e.setCurrentHintNumber(hintIndex + 1), e.setTotalHintsAvailable(hints.length), e.setEvaluation("HINT"), d = "HINT_MSG", hints[hintIndex] && (g = hints[hintIndex])) : ("Correct" == a.getIndicator() ? e.setEvaluation("CORRECT") : e.setEvaluation("INCORRECT"), d = "RESULT");
      ...
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, d, "", e, g, h, c, f) : this.ctatdebug("Info: no logging library available!");
  ...
  this.updateSkillWindow = function(a) {
    ...
    console.log("updateSkillWindow", a);
...
CTAT.Component.Base.UnitDisplay = function(a, b, f, e, d, c, g) {
  ...
  var k = "#FF00FF", l = 1, p = "#FF00FF", n = .2, m = "black", t = 1;
  ...
  this.clickHandler = function(a) {
    !0 === w.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), r(this, !a), w.setActionInput("SetPieces", w.updateValue()), w.processAction());
  };
  this.updateSAI = function() {
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(m, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = e.x, g.cy.baseVal.value = e.y, g.r.baseVal.value = d, this.addPieceElem(g, b, b.selected), f.appendChild(g);
        } else {
          ...
          b.reduce();
          var p = e.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + l)), t = e.clone();
          if (0 < c && c < d) {
            ...
            k = CTAT.Geom.Point.circle_intersection(t, k, e, d).reduce(u.bind(this, k));
            p = p.add(l);
            p = CTAT.Geom.Point.circle_intersection(t, p, e, d).reduce(u.bind(this, p));
          }
          l = CTAT.Geom.Point.to2DString;
          t = "M " + l(t);
          u = new DOMPoint(d, d);
          t += " L " + l(k);
          t += " A " + l(u) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(p);
          g.setAttributeNS(null, "d", t + " Z");
...
var CTATSkillWindow = function(a, b, f, e, d) {
  ...
  this.updateSkillSet = function(a) {
    if (skillSet) {
      ...
      console.log("updateSkillSet (" + a.getSkillSet().length + ")");
      a = a.getSkillSet();
      for (var b = 0;b < a.length;b++) {
        var g = a[b];
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), g = 0;g < a.length;g++) {
            ...
            var f = document.createElement("div"), u = d.getLevel();
            ...
            e.textContent = d.getDisplayName() || "no-name";
...
;var CTATMovieClip = function(a, b, f, e, d) {
  ...
  this.wrapComponent = function(a) {
    ...
    p.setAttribute("style", "border: 0px; position: absolute; left:" + b + "px; top:" + f + "px; z-index:" + h + ";");
    a.appendChild(p);
    return p;
  };
...
var CTATTable = function(a, b, f, e, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATTable", "__undefined__", a, b, f, e, d);
  var c = this;
  c.isTabIndexable = !1;
  var g = null, h = !1;
...
var CTATHintWindow = function(a, b, f, e, d) {
  ...
  this.init = function() {
    ...
    l.appendChild(a);
    if (t) {
      h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), h.innerHTML = t;
    } else {
      if (u) {
        ...
        h.appendChild(b);
        n && (b = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), b.setAttributeNS(null, "pointer-events", "none"), b.textContent = n, b.setAttributeNS(null, "text-anchor", "middle"), b.setAttributeNS(null, "x", "50px"), b.setAttributeNS(null, "dominant-baseline", "middle"), b.setAttributeNS(null, "y", "50%"), h.appendChild(b));
      } else {
        h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), b = document.createElement("span"), b.style.fontWeight = "bold", b.style.marginLeft = "6px", b.style.marginRight = "4px", b.textContent = "\u25c0", h.appendChild(b), n && (b.style.cssFloat = "left", h.appendChild(document.createTextNode(n)));
      }
    }
    h.addEventListener("click", function(a) {
    ...
    a.appendChild(h);
    m ? (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), k.innerHTML = m) : u ? (k = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), k.classList.add("CTAT-hint-window--next"), k.setAttributeNS(null, "viewBox", "0 0 82 20"), b = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), b.style.fill = "none", b.style.strokeWidth = "3px", b.style.strokeLinecap = "round", b.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), b.setAttributeNS(null, 
    "pointer-events", "none"), k.appendChild(b), p && (b = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), b.setAttributeNS(null, "pointer-events", "none"), b.textContent = p, b.setAttributeNS(null, "text-anchor", "middle"), b.setAttributeNS(null, "x", "34px"), b.setAttributeNS(null, "dominant-baseline", "middle"), b.setAttributeNS(null, "y", "50%"), k.appendChild(b))) : (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), b = document.createElement("span"), 
    b.style.fontWeight = "bold", b.style.marginRight = "6px", b.textContent = "\u25b6", p && (b.style.cssFloat = "right", k.appendChild(document.createTextNode(p))), k.appendChild(b));
...
var CTATControllerButton = function(a, b, f, e, d) {
  CTATImageButton.call(this, a, b, f, e, d);
...
var CTATDragNDrop = function() {
  ...
  this.Add = function(a) {
    ...
    $(a).hasClass("CTAT-DragNDrop--item") || ($(a).addClass("CTAT-DragNDrop--item").attr({unselectable:"on", draggable:!0}), a.addEventListener("dragstart", b, !1), a.addEventListener("dragend", f, !1));
  };
...
var CTATNumberLine = function(a, b, f, e, d) {
  ...
  this.setParameterHandler("DenominatorTickmarkStep", function(a) {
    l.setStep((new c(a)).reciprocal());
  });
  this.data_ctat_handlers.denominator = function(a) {
    a = new c(a);
    l.setStep(a.reciprocal());
  };
  ...
  var t = function() {
    if (null !== this.X_Axis && null !== this.X_Axis.svg_group) {
      var a = this.getBoundingBox(), b = window.getComputedStyle(this._axis_line_group), b = parseInt(b.getPropertyValue("stroke-width")), a = CTAT.Geom.Rectangle.inflate(a, -b, -b), c = new DOMPoint(a.width / 2, a.height / 2), d = c.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, this.theta)), e = Math.sin(this.theta), f = -Math.cos(this.theta), m = e * c.x + f * c.y, p = -a.height * f, t = -e * a.width, b = new DOMPoint(a.left, c.y), c = new DOMPoint(a.right, c.y);
      if (0 < Math.abs(CTAT.Math.round(p))) {
        var p = new DOMPoint(a.left, (m - e * a.left) / f), u = new DOMPoint(a.right, (m - e * a.right) / f);
        if (a.contains(p) || a.contains(u)) {
          d.distance(p) < d.distance(u) ? (b = u, c = p) : (b = p, c = u);
        }
      }
      0 < Math.abs(CTAT.Math.round(t)) && (t = new DOMPoint((m - f * a.top) / e, a.top), e = new DOMPoint((m - f * a.bottom) / e, a.bottom), a.contains(t) || a.contains(e)) && (d.distance(t) < d.distance(e) ? (b = e, c = t) : (b = t, c = e));
  ...
  }.bind(this), u = 0, w = null, x = new DOMPoint(-30, -30), r = !1, B = function(a) {
    x.x = a.clientX;
    x.y = a.clientY;
  }, C = function(a) {
    ...
    if (!0 === this.getEnabled() && 0 < p) {
      this.setHintHighlight(!1);
      var b;
      m ? (a = q(a.clientX, a.clientY), b = a.location, a = a.data) : (a = z(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && 0 < p && (r = !0, w.style.visibility = null, u = requestAnimationFrame(F));
    });
    this.component.addEventListener("click", G);
    this.component.addEventListener("focus", this.processFocus);
  };
  var D = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"), z = function(a, b) {
    ...
    if (D) {
      var d = $(this.component), g = parseInt(d.css("borderLeftWidth")) + parseInt(d.css("paddingLeft")) + parseInt(d.css("marginLeft")), d = parseInt(d.css("borderTopWidth")) + parseInt(d.css("paddingTop")) + parseInt(d.css("marginTop"));
      c.x -= g;
      c.y -= d;
    }
    return c;
  }.bind(this), y = function(a, b) {
    return this.getProjectedPoint(z(a, b));
  }.bind(this.X_Axis), q = function(a, b) {
    for (var c = y(a, b), d = null, g = Number.POSITIVE_INFINITY, e, f, h = 0;h < this._tickmarks.length;h++) {
      e = this._tickmarks[h], f = c.distance(e.location), f < g && (d = e, g = f);
    }
    return d;
    ...
    if (r && !0 === this.getEnabled()) {
      if (m) {
        ...
        w.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(y(x.x, x.y), !0));
      }
  ...
  this.set_small_step = a.bind(this, k);
  this.set_denominator = function(a) {
    0 === parseInt(a) ? l.setStep(0) : l.setStep((new c(a)).reciprocal());
    this.render();
  };
  a = function(a, b) {
    0 !== (new c(b)).valueOf() && (a.setStep(a.step.add(b)), this.render());
  };
  this.change_large_step = a.bind(this, h);
  this.change_small_step = a.bind(this, k);
  this.change_denominator = function(a) {
    a = new c(a);
    0 !== a.valueOf() && (a = a.add(l.step.denominator), l.setStep(a.reciprocal()));
  };
  ...
  var E = function(a, b, c) {
    ...
    var a = $(this.getDivWrap()), a = A.bind(null, a), b = {};
    a("data-ctat-ctrl-max").forEach(function(a) {
      b[a] = E.bind(this, this.change_maximum, this.set_maximum);
    });
    a("data-ctat-ctrl-min").forEach(function(a) {
      b[a] = E.bind(this, this.change_minimum, this.set_minimum);
    });
    a("data-ctat-ctrl-large-tick").forEach(function(a) {
      b[a] = E.bind(this, this.change_large_step, this.set_large_step);
    });
    a("data-ctat-ctrl-small-tick").forEach(function(a) {
      b[a] = E.bind(this, this.change_small_step, this.set_small_step);
    });
    a("data-ctat-ctrl-denominator").forEach(function(a) {
      b[a] = E.bind(this, this.change_denominator, this.set_denominator);
    });
    return b;
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, d = document.createDocumentFragment(), e = 0;e < a.length;e++) {
        var f = a[e], n = 100 * f, m = document.createElementNS(c, "rect");
        ...
        this.addPieceElem(m, f, f.selected);
        b += n;
        d.appendChild(m);
      }
      this.baseGroup.innerHTML = "";
      this.baseGroup.appendChild(d);
      var t = this.baseGroup.getBBox().width - 1;
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? d -= c / 2 : (g += c / 2, d = b.x + b.width >= t ? d - c / 2 : d - c);
...
CTATTutor.createStaticInterface = function(a, b, f) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), e.appendChild(l));
    ...
    g + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), e.appendChild(l));
    "statictext" == this.parser.getElementName(d) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), g = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), k = this.parser.getElementAttr(d, "width"), l = this.parser.getElementAttr(d, "height"), g = new CTATMovieClip(c, g, h, k, l), h = g.wrapComponent(e), ctatdebug("Created movieclip: " + c + " at: " + g.x + "," + g.y + "," + g.width + "," + g.height), movieclips.push(g), d = this.parser.getElementChildren(d), 
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    var b = null;
    if (flashVars) {
      var b = flashVars.getRawFlashVars(), f = "550", e = "450", f = a.offsetWidth, e = a.offsetHeight;
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    var a = [], c, g, e = -1, k = arguments.length;
    if (!k) {
      return "";
    }
    for (var l = "";++e < k;) {
...
(function(a) {
  ...
  var e = /[^s]/, d = /[def]/, c = /^[^\x25]+/, g = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, k = /^([a-z_][a-z_\d]*)/i, l = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, n = /^[\+\-]/;
    ...
    for (m = 0;m < h;m++) {
      if (k = f(a[m]), "string" === k) {
        ...
        if ("array" === k) {
          ...
          "function" == f(k) && (k = k());
          if (e.test(D[8]) && "number" != f(k) && isNaN(k)) {
            throw new TypeError(b("[sprintf] expecting number but found %s", f(k)));
          }
          d.test(D[8]) && (y = 0 <= k);
          switch(D[8]) {
            case "b":
        ...
        if (null !== (b = g.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var e = e | 1, f = [], m = b[2], n = [];
              if (null !== (n = k.exec(m))) {
                for (f[f.length] = n[1];"" !== (m = m.substring(n[0].length));) {
                  if (null !== (n = l.exec(m))) {
                    f[f.length] = n[1];
                  } else {
                    if (null !== (n = p.exec(m))) {
    ...
    if ("string" != typeof e) {
      ...
      if (e.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof e && (e = e.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + e.length + ", msgsArr[1].length " + (e[1] ? e[1].length : -1)), !(2 > e.length))) {
          ...
          for (var c = 0, g = !1, f = 1;f < e.length;++f) {
            var k = "<message>" + e[f], l = CTATMsgType.getMessageType(k);
            ...
            b.ctatdebug("problemStateArr[" + f + "] " + (g ? "omit " : "keep ") + l + " omitted " + c + " kept " + d.length);
          }
        }
...
var CTATProblemSummary = function(a, b, f) {
  ...
  var e = Number.MAX_VALUE, d = b, c = f, g = 0, h = new Date, k = {}, l = 0, p = 0, n = 0, m = 0, t = 0, u = 0, w = 0, x = CTATMsgType.CompletionValue[0], r = this;
  ...
  this.toXML = function(b) {
    ...
    c += ' Correct="' + l + '"';
    c += ' UniqueCorrect="' + r.getUniqueCorrect() + '"';
    c += ' UniqueCorrectUnassisted="' + u + '"';
    c += ' Hints="' + p + '"';
    c += ' UniqueHints="' + m + '"';
    c += ' HintsOnly="' + r.getHintsOnly() + '"';
    c += ' Errors="' + n + '"';
    c += ' UniqueErrors="' + r.getUniqueErrors() + '"';
    c += ' ErrorsOnly="' + r.getErrorsOnly() + '"';
    c += ' UniqueSteps="' + r.getUniqueSteps() + '"';
    c += ' RequiredSteps="' + r.getRequiredSteps() + '"';
    c += ' TimeElapsed="' + g + '"';
    var d = r.getSkills() ? r.getSkills().toXML(b) : "";
  ...
  this.addHint = function(a) {
    ...
    r.ctatdebug("exiting addHint() hint count " + p + ", trial " + b);
  };
  this.addError = function(a) {
    r.ctatdebug("addError(" + a + ")");
    var b = k[a];
    ...
    r.ctatdebug("exiting addError() error count " + n + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = k[a];
    r.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++t, 1 > b.getNFirstHints() && u++), b.incrementNCorrect()) : (r.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), k[a] = b, t++, u++);
    l++;
    b.setLastResult(CTATStep.StepResult[3]);
    r.ctatdebug("exiting addCorrect() correct count " + l + ", trial " + b);
  };
  this.setCompletionStatus = function(a, b) {
    r.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
  ...
  a = function(a) {
    ...
    d.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        ...
        })) ? d[1] += (null != (e = p[1]) ? e.evaluate() : void 0) || 1 : a.push([p[0], (null != (f = p[1]) ? f.evaluate() : void 0) || 1]);
      });
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, f = [1, 6], e = [1, 7], d = [1, 10], c = [1, 11], g = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], m = [1, 24], t = [1, 26], u = [1, 27], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], x = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(p, [2, 11], {22:9, 19:25, 16:n, 18:m, 20:t, 21:u, 24:d, 25:c, 27:g, 28:h}), b(w, [2, 17]), {13:f, 15:e, 17:28, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {13:f, 15:e, 17:29, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(w, [2, 20]), b(w, [2, 23], {23:[1, 30]}), {13:f, 15:e, 17:31, 19:8, 22:9, 24:d, 25:c, 27:g, 
  28:h}, {6:32, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, b(x, [2, 25]), b(x, [2, 26]), {1:[2, 1]}, {6:33, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:34, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:35, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:36, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:37, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 24:d, 25:c, 27:g, 28:h}, {6:38, 13:f, 14:4, 15:e, 17:5, 19:8, 22:9, 
  ...
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(p, [2, 9], {22:9, 19:25, 16:n, 18:m, 20:t, 21:u, 24:d, 25:c, 27:g, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:n, 18:m, 20:t, 21:u, 24:d, 25:c, 27:g, 28:h}), b(w, [2, 12]), b(w, [2, 13]), b(w, [2, 15]), b(w, [2, 16]), b(w, [2, 21]), b(x, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, h = 0, k = 0, m = d.slice.call(arguments, 1), l = Object.create(this.lexer), p = {}, t;
    for (t in this.yy) {
      Object.prototype.hasOwnProperty.call(this.yy, t) && (p[t] = this.yy[t]);
    }
    l.setInput(a, p);
    p.lexer = l;
    p.parser = this;
    ...
    for (var n, w, x, K, N = {}, P, L;;) {
      x = b[b.length - 1];
      if (this.defaultActions[x]) {
        K = this.defaultActions[x];
      } else {
        if (null === n || "undefined" == typeof n) {
          n = void 0, n = l.lex() || 1, "number" !== typeof n && (n = this.symbols_[n] || n);
        }
        K = e[x] && e[x][n];
      }
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        Q = l.showPosition ? "Parse error on line " + (g + 1) + ":\n" + l.showPosition() + "\nExpecting " + L.join(", ") + ", got '" + (this.terminals_[n] || n) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == n ? "end of input" : "'" + (this.terminals_[n] || n) + "'");
        this.parseError(Q, {text:l.match, token:this.terminals_[n] || n, line:l.yylineno, loc:t, expected:L});
      }
      if (K[0] instanceof Array && 1 < K.length) {
        throw Error("Parse Error: multiple actions possible at state: " + x + ", token: " + n);
      }
      switch(K[0]) {
        case 1:
          b.push(n);
          ...
          b.push(K[1]);
          n = null;
          w ? (n = w, w = null) : (h = l.yyleng, f = l.yytext, g = l.yylineno, t = l.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          u && (N._$.range = [d[d.length - (L || 1)].range[0], d[d.length - 1].range[1]]);
          x = this.performAction.apply(N, [f, h, g, p, K[1], c, d].concat(m));
...
(function() {
  var a, b, f, e, d, c, g, h, k, l, p, n = [].slice;
  d = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  e = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.matchWithoutPrecision = function(a, c) {
      var d, e;
      return (d = String(a).match(l)) && (e = String(c).match(l)) && (a = p(d) > p(e) ? (+a).toFixed(f(e)) : String(a)) && b(a, c, function(a, b) {
        return a === b;
      });
    };
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, c, k, l) {
      ...
      try {
        ...
        for (t = x.length;n < t;n++) {
          m = x[n], 0 > d.call(f, m) && CTATFormulaFunctions.assign(m, void 0);
        }
        ...
        }).apply(u, [c, k, l].concat(e.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (m in u) {
          null != m && 0 > d.call(p, m) && (r[m] = u[m], delete u[m]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      var e, f, m, t, u;
      t = a.split(this.interpolateSplitPattern);
      u = [];
      a = f = 0;
      for (m = t.length;f < m;a = ++f) {
        e = t[a], u.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return u.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, e) {
    ...
    f.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + d + ", " + k + ", " + l + ", " + a + ")");
    try {
      e = b.evaluate(d, k, l, a);
    } catch (p) {
      f.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + d + ") " + p.name + ": " + p.message), e = null;
    }
...
var CTATExpressionMatcher = function(a, b) {
  function f(a, b, d, f, g) {
    h.ctatdebug("CTATExpressionMatcher.testVector[" + f + "](" + a + ", " + b + ", " + d + ", " + g + ") to call evaluate");
    var t = CTATVariableTable.standardizeType(d);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof d + "; inputConv " + t + ", typeof " + typeof t);
    d = h.evaluate(a, b, t, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + t + ", " + g + ") returned " + d + ", type " + typeof d);
    g = null;
    switch(f) {
    ...
    try {
      switch(e) {
        ...
        case CTATExpressionMatcher.EQ_RELATION:
          ...
          return h.compareNumberOrString(g, d, e);
        case CTATExpressionMatcher.NOT_EQ_RELATION:
          return null == g ? null != d : null == d ? !0 : h.compareNumberOrString(g, d, e);
...
var CTATVectorMatcher = function(a, b, f, e) {
  function d(a, b, d, e, f) {
    ...
    for (var x = 0;3 > x;x++) {
      var r = k[x][0], B = r instanceof CTATExpressionMatcher ? r.matchConcatenation(a, b, d, e) : r.matchConcatenation(w[x]);
      l.ctatdebug("CTATVectorMatcher --\x3e in _match[" + x + "] after " + r + ".concat returns: " + B);
      if (f) {
        f.push(B);
      } else {
        if (!1 === B) {
  ...
  var c = a instanceof Array ? a : [], g = b instanceof Array ? b : [], h = f instanceof Array ? f : [], k = [];
...
var CTATExampleTracerLink = function(a, b, f) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, d = null, c = "undefined" === typeof b || null === b ? null : b, g = "undefined" === typeof f || null === f ? null : f, h = null, k = 1, l = 1, p = "CORRECT_ACTION", n = [], m = !1, t = null, u = "", w = null, x = null, r = this;
  ...
  this.addSkillName = function(a) {
    r.ctatdebug("ETLink[" + e + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === x || "undefined" === typeof x) {
        x = [];
      }
      -1 < x.indexOf(a) || (x.push(a), r.ctatdebug("ETLink.addSkillName() return with skillNames " + x));
    }
  };
...
var CTATExampleTracerSkill = function(a, b, f, e, d, c, g) {
  ...
  var h = null == a || "" == a.trim() ? b : b + " " + a, k = Number(f);
  Number.isNaN(k) && (k = CTATExampleTracerSkill.DEFAULT_P_GUESS);
  var l = Number(e);
  Number.isNaN(l) && (l = CTATExampleTracerSkill.DEFAULT_P_KNOWN);
  var p = Number(c);
  Number.isNaN(p) && (p = CTATExampleTracerSkill.DEFAULT_P_LEARN);
  var n = Number(d);
  Number.isNaN(n) && (n = CTATExampleTracerSkill.DEFAULT_P_SLIP);
  var m = /^0*[xX]([0-9a-fA-F]+)$/.test(g) ? parseInt(g, 16) : /^(\-|\+)?[0-9]+$/.test(g) ? parseInt(g, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, t = 0, u = 0, w = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, x = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, r = null, B = null, C = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.updatePKnown = function(a) {
    return l = CTATExampleTracerSkill.updatePKnownStatic(a, k, l, n, p);
  };
  this.updateHistory = function(a) {
    return m = CTATExampleTracerSkill.updateHistoryStatic(a, m);
  };
  ...
  this.getSkillBarString = function(a) {
    var b = this.getSkillName(), b = b + this.getSkillBarDelimiter() + l, b = b + this.getSkillBarDelimiter() + (this.hasReachedMastery() ? "1" : "0");
  ...
  this.toXML = function(a) {
    ...
    b += ' pKnown="' + Number(l).toFixed(2) + '"';
    b += ' pLearn="' + Number(p).toFixed(2) + '"';
    b += ' pGuess="' + Number(k).toFixed(2) + '"';
  ...
  this.hasReachedMastery = function() {
    return null === l || "undefined" === typeof l ? !1 : l >= x;
  };
  this.getLabel = function() {
    return !r || 1 > r.length ? CTATExampleTracerSkill.getName(h) : r;
  };
  this.getDescription = function() {
    return !B || 1 > B.length ? h : B;
  };
...
var CTATWildcardMatcher = function(a, b) {
  function f(a) {
    ...
    var b = (new String(a)).replace(RegExp("\\?", "g"), "."), f = b.replace(RegExp("\\*", "g"), ".*"), h = f.replace(RegExp("\\[\\!", "g"), "[^");
    e.ctatdebug("CTATWildcardMatcher.convertToFullRegex(" + a + ") after qm: " + b + "; after aster: " + f + "; after negate: " + h + ";");
    return h;
  }
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.breakByLowerLinkID = function(b, f) {
    ...
    var e = b.getSortedLinks(), d = f.getSortedLinks(), c = null, g = null, h = 0, k = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), k >= e.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : k >= d.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), c = e[k], g = d[k]), k++;
...
var CTATExampleTracerPath = function(a) {
  ...
  var f = null, e = null, d = null, c = null, g = null, h = null, k = this;
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  this.updateVariableTable = function(a, b, c) {
    ...
    e.put(b, f);
    e.put(CTATVariableTable.nameAsString(f), CTATVariableTable.valueAsString(f));
...
var CTATExampleTracerEvent = function(a, b, f) {
  ...
  var e = "", d = !1, c = CTATExampleTracerLink.NO_MODEL, g = !1, h = null, k = null, l = "student", p = null, n = null, m = "", t = null, u = null, w = null, x = null, r = null, B = [], C = !1, G = null, D = null, z = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.isOutOfOrder = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + t);
    return t;
  };
  ...
  this.getSuccessOrBuggyMsg = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + r);
    return r;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, c, d, e, g) {
    ...
    a.getHintRequest() || (b = d.getTutorSAI(a.getInterpolatedSAI(), e.getVariableTable()), q.ctatdebug("In evaluate -- TUTORSAI: " + b + ", studentSAI was " + a.getStudentSAI()), a.setTutorSAI(b));
    ...
    a.getHintRequest() && (e = d.interpolateHints(e.getVariableTable()), a.setInterpolatedHints(e), q.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(e) && 0 < e.length ? a.setReportableHints(e) : a.setReportableHints(d.getHints()), q.ctatdebug("In evaluate --\x3e after setReportableHints"));
  ...
  function d(a, b, c, d) {
    ...
    if (!b && G.hideButRequireSteps()) {
      ...
      for (var f;!(f = b.next()).done;) {
        if (G.pathToLinkIsSubset(f.value, y)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, q.getBestInterpretation(), q.getInterpretationsInternal()) : e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, p(d), d);
        }
      }
    }
  ...
  function c(a, b, c) {
    ...
    D = a;
    var f = new Set, m = a.getPreloadedLinkMatches();
    q.ctatdebug("interps # : " + r.length);
    q.ctatdebug("interps: " + r);
    r.forEach(function(d) {
      ...
      if ("undefined" === typeof m || null === m) {
        ...
        for (var e = 0;e < m.length;++e) {
          g(a.getStudentSAI(), !0, m[e], m[e].getActor(), d.getVariableTable());
        }
      }
      ...
      m.forEach(function(b) {
        ...
        var e = d.clone();
        q.ctatdebug("In evaluate size of getPaths " + e.getPaths().size);
        e.getPaths().forEach(function(c) {
          q.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: " + c);
          !1 === k(b, e, c, !1, a) && (q.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), e.getPaths()["delete"](c), q.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
        q.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size " + e.getPaths().size);
        if (0 < e.getPaths().size) {
          ...
          if (!0 === c) {
            ...
            q.ctatdebug("In evaluate -- done updatingVariable table: " + e.getVariableTable());
          }
          f.add(e);
    ...
    q.ctatdebug("In evaluate -- number of interpretations " + f.size + " set");
    var n = d(a, b, c, f);
    if (null !== n) {
      return n;
    }
    ...
    var u = null;
    !0 === a.isSolverResult() ? (q.ctatdebug("In evaluate -- in if branch of isSolverResult"), u = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (q.ctatdebug("In evaluate -- in else branch of isSolverResult"), u = n.getLastMatchedLink().getType());
    return e(a, c, u, null, n, f);
  }
  ...
  function h(a, b, c, d, e) {
    ...
    G.getLinks().forEach(function(h) {
      if (!1 === c) {
        ...
        !0 === l && f.push(h);
        G.hideButRequireSteps() && g(a, l, h, b, d);
      } else {
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== l && (!1 === G.observesOrderingConstraints(h, a, f, e) || !1 === t(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), l = !1) : h.push(a));
      });
      if (!1 === l) {
  ...
  var r = null, B = null, C = null, G = a, D = null;
  ...
  this.resetTracer = function() {
    ...
    null === r || "undefined" === typeof r ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), r = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), r.length = 0);
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = u(!1, [a])) ? a.getPrevNode() : G ? G.getStartNode() : null;
  };
};
...
var CTATDefaultLinkGroup = function(a, b, f, e) {
  ...
  n.ctatdebug("CTATDefaultLinkGroup constructor group isReenterable: " + f);
...
var CTATDefaultGroupModel = function() {
  ...
  function f(a, b) {
    ...
    k.getGroupSubgroups(b).forEach(function(b) {
      !0 !== d && !0 === k.isLinkInGroup(b, a) && (c = f(a, b), e = null !== c && "undefined" !== typeof c ? c : b, d = !0);
    });
    return !0 === d ? e : null;
  }
  function e(a, b) {
    ...
    b.forEach(function(f) {
      if (!0 !== c) {
        ...
        k.getGroupSubgroups(a).forEach(function(g) {
          !0 !== c && !0 === k.isLinkInGroup(g, f) && (k.getGroupLinkCount(g) >= b.size ? (d = e(g, b), c = !0) : k.getGroupLinks(g).forEach(function(c) {
            if (!1 === b.has(c)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
...
var CTATExampleTracerGraph = function(a, b, f) {
  ...
  var x = null, r = null, B = null, C = null, G = null, D = null, z = new Set, y = new Set, q = null, F = null, E = CTATMsgType.SHOW_ALL_FEEDBACK, A = this;
  ...
  this.observesOrderingConstraints = function(a, b, c, f) {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints");
    null !== f && "undefined" !== typeof f && (A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints initializing out of order false"), f.setOutOfOrder(!1));
    ...
    null !== f && "undefined" !== typeof f && (A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order true"), f.setOutOfOrder(!0));
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = A.getSmallestContainingGroup(b), !0 === F.isLinkInGroup(b, g) && !1 === F.isGroupOrdered(b) && !0 === l(b, c, d))) {
      return !1;
    }
  ...
  (function(a, b) {
    ...
    x = new CTATExampleTracerTracer(A, f);
...
var CTATGraphParser = function() {
  ...
  function b(a, b) {
    ...
    for (var c = g.getElementChildren(a), d = [], f = 0;f < c.length;f++) {
      if ("matcher" === g.getElementName(c[f])) {
        for (var h = null, k = g.getElementAttr(c[f], "replacementFormula"), l = g.getElementChildren(c[f]), m = 0;m < l.length;m++) {
          if ("matcherType" === g.getElementName(l[m])) {
            switch(h = g.getNodeTextValue(l[m]), e.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + m + "] = " + h), h) {
              case "ExactMatcher":
  ...
  function f(a, b) {
    ...
    for (var k = function(a) {
      ...
      "group" === g.getElementName(m[n]) && (ctatdebug("encountered a subgroup"), f(m[n], b).forEach(k));
    }
    l.addGroup(d, e, c);
  ...
  var e = this, d, c, g = new CTATXML, h = null, k = [];
  new XMLSerializer;
  var l, p = !0, n = !0, m = [];
  ...
  this.parseGraph = function(b, e) {
    ...
    e.setFeedbackSuppressed(B);
    B = g.getElementAttr(b, "highlightRightSelection");
    e.setHighlightRightSelection("false" != B);
    ...
    for (var D = null, z = 0;z < C.length;z++) {
      switch(g.getElementName(C[z])) {
        ...
        case "productionRule":
          ...
          for (var q = y = "", E = F = null, A = g.getElementChildren(A), H = 0;H < A.length;H++) {
            var J = g.getElementName(A[H]);
            "ruleName" == J && (y = g.getNodeTextValue(A[H]), ctatdebug("ruleName=" + y));
            "productionSet" == J && (q = g.getNodeTextValue(A[H]), ctatdebug("productionSet=" + q));
            "label" == J && (F = g.getNodeTextValue(A[H]), ctatdebug("label=" + F));
            "description" == J && (E = g.getNodeTextValue(A[H]), ctatdebug("description=" + E));
          }
          y && (A = new CTATExampleTracerSkill(q, y, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN, CTATExampleTracerSkill.DEFAULT_HISTORY), null != F ? A.setLabel(F) : A.setLabel(y), null != E ? A.setDescription(E) : A.setDescription(y + (q ? " " + q : "")), m.push(A));
      }
    }
    if (D) {
    ...
    if (!w || 1 > w.length) {
      ctatdebug("No existing skills. Add skills from BRD."), e.addGraphSkills(m), w = e.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, r, n, e.isFeedbackSuppressed(), B, G, w);
    c.redoLinkDepths();
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (g && !(1 > g.length)) {
      ...
      for (r = 0;r < x.length;++r) {
        B = x[r], n.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + B.timeout + ", .msgTuples.length " + B.msgTuples.length), setTimeout(d, B.timeout, c, B.msgTuples);
      }
...
var CTATSkills = function(a) {
  ...
  this.updateSkill = function(a, b, h) {
    ...
    null !== l && "undefined" !== typeof l && (l.setTransactionNumber(f), b = h + " " + b, e.has(b) || (e.add(b), l.updatePKnown(a), l.updateHistory(a), l.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && e["delete"](b), k = l);
    return k;
  };
  ...
  this.getSkillBarVector = function(a, d) {
    var e = [], k;
    for (k in b) {
      !0 === b.hasOwnProperty(k) && (!0 !== d && b[k].getTransactionNumber() !== f || e.push(b[k].getSkillBarString(a)));
    }
    return e;
  };
...
var CTATExampleTracer = function() {
  ...
  function f(a, b) {
    ...
    var f = m.lastMessageAsXML = (new CTATXML).parseXML(a), g = m.lastMessage = new CTATMessage(f), h = g.getMessageType();
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && m.sendBundle([a]), d(a, g, r, f), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && m.sendBundle([a]), c(a, g, r, f), !0;
          ...
          case "skills":
            ...
            for (var e = r.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = r.getElementAttr(e[f], "label"), k = r.getElementAttr(e[f], "pSlip"), l = r.getElementAttr(e[f], "description"), n = r.getElementAttr(e[f], "pKnown"), p = r.getElementAttr(e[f], "category"), u = r.getElementAttr(e[f], "pLearn"), w = r.getElementAttr(e[f], "pGuess"), x = r.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(p, h, w, n, k, u, x);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
  ...
  function l(a, b, c, d, e, f) {
    ...
    f = k.getStudentSAI();
    var l = k.getTutorSAI(), n = k.getTransactionID(), r = new CTATTutorMessageBuilder, t = "", w = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        t = w ? "" + w.getUniqueID() : "", k.setStepID(t), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, r.createCorrectActionMessage(n, l), k, l), null !== w && "undefined" !== typeof w && m.updateSkills(CTATExampleTracerSkill.CORRECT, w.getSkillNames(), w.getUniqueID()), t = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), 
        l, p(c), f, m.getSkillBarVector(!0, c), w.getUniqueID(), n, t), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + t), t && m.messageTank.addToMessageTank("SuccessMessage", r.createSuccessMessage(n, t), k, null), B = null, d && (x = h(w ? w.getNextNode() : null, u.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x);
      } else {
        m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, r.createInCorrectActionMessage(n, k.getInterpolatedSAI()), k, null);
        ...
        x || (x = u.getBestNextLink(!1, y), m.ctatdebug("getBestNextLink result: " + y + "; hintLink " + x));
        l = null;
        x && ((l = y.getTutorSAI()) && l.getSelection() && k.setTutorSAI(l), t = "" + x.getUniqueID(), k.setStepID(t));
        y = g(k, y, r);
        m.ctatdebug("createBuggyMessage() tutorAdvice: " + y.tutorAdvice + ";\n  msg " + y.msg);
        m.updateSkills(CTATExampleTracerSkill.INCORRECT, x ? x.getSkillNames() : [], t);
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : f, p(c), f, m.getSkillBarVector(!0, c), t, n, y.tutorAdvice), k, null);
        y.msg && m.messageTank.addToMessageTank(y.msgType, y.msg, k);
        B = f;
        d && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() ? (x = h(w ? w.getNextNode() : null, u.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x) : k.isDoneStepFailed() && m.messageTank.flushDelayedFeedback();
      }
    }
    m.lastResult = k;
  ...
  var m = this, t = null, u, w, x, r = new CTATXML;
  new XMLSerializer;
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      ...
      a: {
        ...
        if (null !== a && null !== c && a.getNodeID() != c.getNodeID()) {
          b = x.getBestSubpath(a, c);
          m.ctatdebug("advanceToStudentStartsHere() path " + b);
          if (!b) {
            break a;
          }
          b = b.getSortedLinks();
          b = m.traceLinks(b);
          m.ctatdebug("advanceToStudentStartsHere() results " + b);
        }
        c = a = null;
